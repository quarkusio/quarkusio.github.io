...
[NOTE]
====
Currently, Hibernate ORM supports only one persistence unit which uses the default datasource.
If you want to use multiple datasources, you will need to manipulate them directly.
...
the `quarkus-smallrye-metrics` extension is not in use.

...
See the xref:grpc-generation-reference.adoc#protobuf-maven-plugin[Generating Java files from proto with the protobuf-maven-plugin] section for more information.

...
Alerts is modelled around the Bootstrap alerts. See <a href="https://getbootstrap.com/docs/4.0/components/alerts/">https://getbootstrap.com/docs/4.0/components/alerts/</a> for more info.

...
:topics: data,schema-migration,liquibase
:extensions: io.quarkus:quarkus-liquibase
...
The solution is located in the `liquibase-quickstart` link:{quickstarts-tree-url}/liquibase-quickstart[directory].

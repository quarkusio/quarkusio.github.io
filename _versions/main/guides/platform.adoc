...
* includes the xref:platform-descriptor[platform JSON descriptor] artifact
* possibly includes the xref:platform-properties[platform configuration properties] artifacts

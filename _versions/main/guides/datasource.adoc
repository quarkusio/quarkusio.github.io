...
[WARNING]
====
OpenTracing has been deprecated in favor of OpenTelemetry. For tracing information, please check the related section about xref:datasource-tracing[Datasource tracing], bellow.
====

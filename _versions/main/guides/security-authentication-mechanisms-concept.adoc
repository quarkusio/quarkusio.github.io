...
|Username and password |xref:security-basic-authentication-concept.adoc[Basic], xref:form-auth[Form-based authentication]
...
|Single sign-on (SSO) |xref:security-oidc-code-flow-authentication-concept.adoc[OIDC Code Flow], xref:form-auth[Form-based authentication]

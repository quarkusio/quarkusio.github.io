...
* xref:declaring-a-logger-field[Declaring a logger field]
...
JBoss Logging is built into Quarkus and provides link:https://quarkus.io/developer-joy/[unified configuration] for all xref:logging-apis[supported logging APIs].

...
See example in the xref:category-named-handlers-example[Named handlers attached to a category] output.
...
See the example in xref:category-example[File TRACE Logging Configuration].
====

...
written weeks, months or years earlier, and have A, C and I properties can be hugely beneficial.
...
STM-aware classes must implement an interface. Add the `org.jboss.stm.annotations.Transactional` annotation to the

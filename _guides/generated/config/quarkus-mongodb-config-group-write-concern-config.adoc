...
h|[[quarkus-mongodb-config-group-write-concern-config_quarkus.mongodb.-mongo-client-configs-.write-concern]]link:#quarkus-mongodb-config-group-write-concern-config_quarkus.mongodb.-mongo-client-configs-.write-concern[Write concern]

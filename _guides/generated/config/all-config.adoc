...
[.description]
--
The OAuth2 server certificate file. *Warning*: this is not supported in native mode where the certificate must be included in the truststore used during the native image generation, see link:native-and-ssl-guide.html[Using SSL With Native Executables].
--|string 
|
...
a|icon:archive[title=Fixed at build time] [[quarkus-jaeger_quarkus.security.security-providers]]`link:#quarkus-jaeger_quarkus.security.security-providers[quarkus.security.security-providers]`
...
a|icon:archive[title=Fixed at build time] [[quarkus-jaeger_quarkus.security.deny-unannotated-members]]`link:#quarkus-jaeger_quarkus.security.deny-unannotated-members[quarkus.security.deny-unannotated-members]`
...
a|icon:archive[title=Fixed at build time] [[quarkus-keycloak-authorization_quarkus.keycloak.policy-enforcer.paths.-paths-.claim-information-point.-complex-config]]`link:#quarkus-keycloak-authorization_quarkus.keycloak.policy-enforcer.paths.-paths-.claim-information-point.-complex-config[quarkus.keycloak.policy-enforcer.paths."paths".claim-information-point."complex-config"]`
...
a|icon:archive[title=Fixed at build time] [[quarkus-keycloak-authorization_quarkus.keycloak.policy-enforcer.paths.-paths-.claim-information-point.-simple-config]]`link:#quarkus-keycloak-authorization_quarkus.keycloak.policy-enforcer.paths.-paths-.claim-information-point.-simple-config[quarkus.keycloak.policy-enforcer.paths."paths".claim-information-point."simple-config"]`

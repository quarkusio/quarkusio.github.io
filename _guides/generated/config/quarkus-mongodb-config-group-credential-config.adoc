...
h|[[quarkus-mongodb-config-group-credential-config_quarkus.mongodb.-mongo-client-configs-.credentials]]link:#quarkus-mongodb-config-group-credential-config_quarkus.mongodb.-mongo-client-configs-.credentials[Credentials and authentication mechanism]

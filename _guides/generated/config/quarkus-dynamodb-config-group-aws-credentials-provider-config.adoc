...
a| [[quarkus-dynamodb-config-group-aws-credentials-provider-config_quarkus.dynamodb.aws.credentials.type]]`link:#quarkus-dynamodb-config-group-aws-credentials-provider-config_quarkus.dynamodb.aws.credentials.type[quarkus.dynamodb.aws.credentials.type]`

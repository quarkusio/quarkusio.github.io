...
a|icon:archive[title=Fixed at build time] [[quarkus-kafka-streams-kafka-streams-build-time-config_quarkus.kafka-streams.health.enabled]]`link:#quarkus-kafka-streams-kafka-streams-build-time-config_quarkus.kafka-streams.health.enabled[quarkus.kafka-streams.health.enabled]`

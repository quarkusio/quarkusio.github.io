...
a|icon:archive[title=Fixed at build time] [[quarkus-lambda-lambda-build-time-config_quarkus.lambda.enable-polling-jvm-mode]]`link:#quarkus-lambda-lambda-build-time-config_quarkus.lambda.enable-polling-jvm-mode[quarkus.lambda.enable-polling-jvm-mode]`

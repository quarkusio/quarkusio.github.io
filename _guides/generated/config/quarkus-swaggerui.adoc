...
a|icon:archive[title=Fixed at build time] [[quarkus-swaggerui_quarkus.swagger-ui.enable]]`link:#quarkus-swaggerui_quarkus.swagger-ui.enable[quarkus.swagger-ui.enable]`

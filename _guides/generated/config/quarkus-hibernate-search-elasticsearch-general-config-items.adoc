...
a|icon:cogs[title=Overridable at runtime] [[quarkus-hibernate-search-elasticsearch-general-config-items_quarkus.hibernate-search.elasticsearch.protocol]]`link:#quarkus-hibernate-search-elasticsearch-general-config-items_quarkus.hibernate-search.elasticsearch.protocol[quarkus.hibernate-search.elasticsearch.protocol]`

...
`quarkus.rt.all-values.string-map."<string-map>"` icon:cogs[title=Overridable at runtime]::
+
--
A map of properties
...
`quarkus.rt.all-values.string-list-map."<string-list-map>"` icon:cogs[title=Overridable at runtime]::
+
--
A map of property lists
...
`quarkus.btrt.all-values.string-map."<string-map>"` icon:archive[title=Fixed at build time]::
+
--
A map of properties
...
`quarkus.btrt.all-values.string-list-map."<string-list-map>"` icon:archive[title=Fixed at build time]::
+
--
A map of property lists
...
`quarkus.bt.all-values.string-map."<string-map>"` icon:archive[title=Fixed at build time]::
+
--
A map of properties
...
`quarkus.bt.all-values.string-list-map."<string-list-map>"` icon:archive[title=Fixed at build time]::
+
--
A map of property lists

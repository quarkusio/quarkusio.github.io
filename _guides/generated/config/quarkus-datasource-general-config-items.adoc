...
a| [[quarkus-datasource-general-config-items_quarkus.datasource.credentials-provider-type]]`link:#quarkus-datasource-general-config-items_quarkus.datasource.credentials-provider-type[quarkus.datasource.credentials-provider-type]`
...
a| [[quarkus-datasource-general-config-items_quarkus.datasource.-datasource-name-.credentials-provider-type]]`link:#quarkus-datasource-general-config-items_quarkus.datasource.-datasource-name-.credentials-provider-type[quarkus.datasource."datasource-name".credentials-provider-type]`

...
a|icon:archive[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.redirect-after-login]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.redirect-after-login[quarkus.http.auth.form.redirect-after-login]`

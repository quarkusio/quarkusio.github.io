...
* DB2 (container) (requires xref:license_acceptance[license acceptance])
* Derby (in-process)
* H2 (in-process)
* MariaDB (container)
* Microsoft SQL Server (container) (requires xref:license_acceptance[license acceptance])
* MySQL (container)
...
See xref:configuration-reference[Configuration Reference] for more information.
====

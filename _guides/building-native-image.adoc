...
Save this file in your application root folder as `Dockerfile.multistage` as it is not included in the getting started quickstart.
...
If you are using Gradle in your project, you can use this sample Dockerfile.  Save it in your application root folder as `Dockerfile.multistage`.

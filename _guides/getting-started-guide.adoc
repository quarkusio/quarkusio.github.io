...
The easiest way to create a new {project-name} project is to open a browser and open quarkus.io/starter and feed the formular.

Another way to create a new {project-name} project is to open a terminal and run the following command:

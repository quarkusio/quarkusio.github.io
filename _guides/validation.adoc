...
include::includes/create-app.adoc[]
...
include::includes/extension-add.adoc[]
...
.Gradle
****
This will add the following in the `dependencies` section of your `build.gradle`:

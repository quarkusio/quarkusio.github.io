...
Remember, you need to configure Maven as indicated in the link:maven-tooling.html[Maven configuration page].
...
[NOTE]
====
If you are not using private GitHub repository then you don't need the `Deploy Key` created and added to the Build Service Account
====

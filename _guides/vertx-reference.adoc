...
IMPORTANT: This will only work on platforms that support xref:native-transport[Native Transport].

Enable the appropriate xref:native-transport[Native Transport] and set the following environment property:
...
See xref:native-transport[Native Transport] for details.

...
////
= Quarkus - Using Kogito to add prediction capabilities to an application
...
Let's start by adding a simple PMML file `LogisticRegressionIrisData.pmml`. As you can see from the source code below it contains a _Regression_ model named `LogisticRegressionIrisData`:

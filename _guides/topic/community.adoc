...
We have a lot of documentation for getting started with {project-name}, be sure to link:{quarkus-site-getting-started}[check it out]!

=== Frequent question?

Check out our link:/faq[FAQ] section.

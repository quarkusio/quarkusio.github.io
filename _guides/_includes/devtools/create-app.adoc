...
----
ifdef::create-app-extensions,create-app-stream,create-app-platform-version[]
quarkus create app {create-app-group-id}:{create-app-artifact-id} \
endif::[]
ifndef::create-app-extensions,create-app-stream,create-app-platform-version[]
...
ifdef::create-app-platform-version[]
ifdef::create-app-extensions,create-app-stream[]
    --platform-bom={create-app-platform-version} \
endif::[]
...
ifdef::create-app-platform-version[]
    -DplatformVersion={create-app-platform-version} \
endif::[]
ifdef::create-app-stream[]

...
image::demo_flow_diagram.webp[Demo Flow Diagram,align="center"]
...
image::devui_oidc_card.webp[Keycloak Admin,align="center"]
...
image::quarkus_mcp_server_client_scope.webp[Keycloak quarkus-mcp-server client scope,align="center"]

The `quarkus-mcp-server` scope has an audience mapping:

image::quarkus_mcp_server_audience.webp[Keycloak quarkus-mcp-server audience mapping,align="center"]
...
image::quarkus_mcp_server_dev_mode.webp[MCP server dev mode,align="center"]
...
image::mcp_inspector_connect_view.webp[MCP Inspector Connect,align="center"]
...
image::mcp_inspector_oauth2_settings.webp[MCP Inspector OAuth2 Settings,align="center"]
...
image::mcp_inspector_oauth2_flow_progress.webp[MCP Inspector OAuth2 Settings Progress,align="center"] 
...
image::oauth2_metadata_discovered.webp[OAuth2 Metadata Discovered,align="center"] 
...
image::oauth2_client_registration_request.webp[OAuth2 Client Registration Request,align="center"]
...
image::oauth2_reg_client_response.webp[OAuth2 Client Registration Response,align="center"]
...
image::keycloak_reg_client_dashboard.webp[Keycloak Registered Client,align="center"]

Click on its `Client Scopes` tab, and add `profile` and `quarkus-mcp-server` scopes as `Default` scopes:

image::add_scopes_to_registered_client.webp[Add Scopes Registered Client,align="center"]
...
image::oauth2_prepare_authorization.webp[OAuth2 Prepare Authorization,align="center"]
...
image::keycloak_realm_login.webp[Keycloak Realm Login,align="center"]
...
image::keycloak_consent_screen.webp[Keycloak Consent Screen,align="center"]
...
image::copy_authorization_code.webp[Copy Authorization Code,align="center"]

Copy and paste this code into the `Prepare Authorization` field in the `Guided OAuth Flow` view:

image::oauth2_request_authorization.webp[OAuth2 Prepare Authorization,align="center"]

Press `Continue`. https://github.com/modelcontextprotocol/inspector[MCP Inspector] now successfully acquires the tokens:

image::token_request_response.webp[OAuth2 Get Tokens,align="center"]
...
image::access_token_claims.webp[OAuth2 Access Token Claims,align="center"]
...
image::username_provider_call.webp[User Name Provider Call,align="center"]

Now press `Disconnect` first, and then `Clear OAuth State`:

image::disconnect_clear_oauth2_state.webp[Disconnect and clear OAuth2 state,align="center"]
...
image::token_request_response_without_idtoken.webp[Token response without the ID token,align="center"]
...
image::oauth2_encrypted_access_token.webp[Encrypted access token,align="center"]

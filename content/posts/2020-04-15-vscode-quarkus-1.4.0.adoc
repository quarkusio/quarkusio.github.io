...
image::faulttolerance_properties.webp[alt="MicroProfile Fault Tolerance properties support"]
...
image::health_java_diagnostics.webp[alt="MicroProfile Health Java diagnostics support"]
...
image::lra_properties.webp[alt="MicroProfile LRA properties support"]
...
image::metrics_properties.webp[alt="MicroProfile Metrics properties support"]

In Java files, you benefit from snippets to quickly generate part of the Metrics annotations:

image::metrics_java_snippets.webp[alt="MicroProfile Metrics Java snippets support"]
...
image::openapi_properties.webp[alt="MicroProfile Open API properties support"]

In Java files, you benefit from snippets to quickly generate part of the Open API annotations:

image::openapi_java_snippets.webp[alt="MicroProfile Open API Java snippets support"]
...
image::openapi_java_codeaction.webp[alt="MicroProfile Open API Java code action support"]
...
image::opentracing_properties.webp[alt="MicroProfile Open Tracing properties support"]
...
image::restclient_java_diagnostics.webp[alt="MicroProfile Rest Client Java diagnostics support"] 

CodeLens for Rest Client are now available:

image::restclient_java_codelens.webp[alt="MicroProfile Rest Client Java Code Lens support"]

...
In a previous link:/blog/eclipse-got-quarkused[post], we announced the
...
image::quarkus20.webp[]

Enter `kubernetes` prefix:

image::quarkus21.webp[]

Enter `openshift` prefix:

image::quarkus22.webp[]

Enter `s2i` prefix:

image::quarkus23.webp[]
...
image::quarkus28.webp[]
image::quarkus29.webp[]

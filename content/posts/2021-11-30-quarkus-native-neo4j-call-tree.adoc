...
image::persist-query-big-nodes.webp[]
...
image::entitymanager-persist-query.webp[]
...
image::entitymanager-persist-depth-1-query.webp[]
...
image::entitymanager-persist-depth-2-query.webp[]

image::subclass.webp[]

image::reflection-access-holder.webp[]
...
image::entitymanager-persist-depth-3-query.webp[]

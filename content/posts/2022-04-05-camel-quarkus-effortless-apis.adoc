...
image::camel-quarkus.webp[alt=Camel Quarkus, align=left, width=80%]
...
image::openapi.webp[alt=Putting together APIs, align=center, width=50%]
...
image::dev-contract-first.webp[alt=Contract-first approach, align=center, width=70%]
...
.Code-first approach
image::dev-code-first.webp[alt=Code-first approach, align=center, width=85%]
...
image::camel-basics-dsl.webp[alt=Camel DSLs chained to process incoming requests, align=center, width=80%]
...
image::camel-easy-ride.webp[alt=Automated REST DSL, hand coded Main DSL, align=center, width=85%]
...
image::maven-automation.webp[alt=Source is clean. Essential artefacts are generated and injected, align=center]
...
image::service-version-1.webp[alt=First version of the service to implement, align=center]
...
image::service-e2e.webp[alt=End to end processing flow, align=center]
...
image::map-json-xml.webp[alt=AtlasMap combines 2 actions in 1: structural and format transformations, align=center, width=80%]
...
image::openapi-camel-link.webp[alt=Camel uses the operationId as a link to invoke the Camel route, align=center, width=90%]
...
image::vscode-codelens.webp[alt=VSCode prepends an action link to open the visual mapping editor, align=left, , width=45%]
...
image::atlasmap-mapping-request.webp[alt=Mapping definition for the request flow, align=center]
...
image::camel-backend-call.webp[alt=Call from Camel to the backend, align=center]

The response data mapping definition would be defined in AtlasMap as shown below:

image::atlasmap-mapping-response.webp[alt=Mapping definition for the response flow, align=center]
...
image::service-version-2.webp[alt=Second version of the service with a new operation, align=center]
...
image::atlasmap-mapping-response-anonymous.webp[alt=Mapping definition anonymised for the response flow, align=center]
...
image::swagger-op1.webp[alt=First operation in Swagger client, align=left, width=60%]
...
image::swagger-op2.webp[alt=Second operation in Swagger client, align=left, width=60%]

...
image::02_last_used_option.webp[alt="The 'last used' option"]
...
image::05_debug_term.webp[alt="Message when terminating debug"]
...
image::06_tree_view.webp[alt="Tree view"]
...
image::07_hovering.webp[alt="Hover over property key"]
...
image::12_validation.webp[alt="Validation"]

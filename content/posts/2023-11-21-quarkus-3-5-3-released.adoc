---
layout: post
title: 'Quarkus 3.5.3 released - Maintenance release'
date: 2023-11-21
tags: release
synopsis: 'We released Quarkus 3.5.3, our third maintenance release for the 3.5 release train.'
author: gsmet
---

Today, we released Quarkus 3.5.3, our third maintenance release for the 3.5 release train.
...
To update to Quarkus 3.5.3, we recommend updating to the latest version of the Quarkus CLI and run:
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.5.3[the full changelog of 3.5.3 on GitHub].

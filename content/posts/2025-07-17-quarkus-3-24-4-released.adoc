---
layout: post
title: 'Quarkus 3.24.4 - Maintenance release'
date: 2025-07-17
tags: release
synopsis: 'We released Quarkus 3.24.4, a maintenance release for our 3.24 release train.'
author: gsmet
---

We released Quarkus 3.24.4, the third (we skipped 3.24.0) maintenance release for our 3.24 release train.
...
You can get the full changelog of https://github.com/quarkusio/quarkus/releases/tag/3.24.4[3.24.4] on GitHub.

...
author: mmaler
thumbnailimage: /assets/images/posts/mmaler-blog-posts/optimizing-java-with-quarkus-cloud.webp
---
...
image::optimizing-java-with-quarkus-cloud.webp[scaledwidth=100%]

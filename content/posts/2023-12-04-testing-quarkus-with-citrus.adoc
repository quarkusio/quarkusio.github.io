...
image::citrus-quarkus.webp[Citrus & Quarkus,align="center"]
...
image::food-market-demo-application.webp[Food Market App,align="center"]
...
image::citrus-demo-test-setup.webp[Citrus test setup,align="center"]

---
layout: post
title: 'Quarkus 3.12.1 released - Maintenance release'
date: 2024-07-03
tags: release
synopsis: 'We released Quarkus 3.12.1, our first maintenance release for the 3.12 release train.'
author: gsmet
---

Today, we released Quarkus 3.12.1, our first maintenance release for the 3.12 release train.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.12.1[the full changelog of 3.12.1 on GitHub].

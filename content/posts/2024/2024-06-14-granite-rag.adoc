...
image::chatbot-architecture.webp[Architecture of the application,float="right",align="center"]
...
image::traditional-rag-pattern.webp[The traditional RAG pattern,float="right",align="center"]
...
image::mona-screenshot.webp[The Mon chatbot,float="right",align="center"]

---
layout: post
title: 'Quarkus 3.7.4 released - Maintenance release'
date: 2024-02-21
tags: release
synopsis: 'We released Quarkus 3.7.4, our third maintenance release for the 3.7 release train.'
author: gsmet
---

Today, we released Quarkus 3.7.4, our third (we skipped 3.7.0) maintenance release for the 3.7 release train.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.7.4[the full changelog of 3.7.4 on GitHub].

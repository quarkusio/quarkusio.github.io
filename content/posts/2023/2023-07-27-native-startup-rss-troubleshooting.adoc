...
image::rss-before-slowPathNew.webp[slow path new allocations for Quarkus 2.7.6.Final]
...
image::rss-after-slowPathNew.webp[slow path new allocations for Quarkus 2.13.4.Final]
...
image::jmc-new-tlab-event-from-doStart.webp[new tlab events from ApplicationImpl.doStart() method Quarkus 3.2.1.Final]

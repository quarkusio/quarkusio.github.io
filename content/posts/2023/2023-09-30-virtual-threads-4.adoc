...
image::virtual-thread-messaging.webp[Threading model of the messaging application,400,float="right",align="center"]
...
image::fraud-detection-screenshot.webp[The application reached 1024 as top concurrency,800,float="right",align="center"]

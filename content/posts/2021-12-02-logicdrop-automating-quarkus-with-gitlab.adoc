...
author: kjq
thumbnailimage: /assets/images/posts/quarkus-user-stories/logicdrop/logicdrop.webp
---
...
image::logicdrop.webp[Logicdrop logo,align="center"]
...
image::gitlab/layers.webp[Cluster-Templates-Services,align="center"]
...
image::gitlab/merge-request.webp[Merge Request,align="center"]
...
image::gitlab/develop-pipeline.webp[Review Pipeline,align="center"]
...
image::gitlab/develop-downstream.webp[Service Downstream Service,align="center"]
...
image::gitlab/develop-dag.webp[Review DAG,align="center"]
...
image::gitlab/promotion.webp[Promoting a Release,align="center"]
...
image::gitlab/release-pipeline.webp[Deploy to Staging,align="center"]

Once the changed services are finished building the deployment begins automatically.

image::gitlab/deployment.webp[Single Deployment,align="center"]
...
image::gitlab/cluster-downstream.webp[Cluster Downstream Service,align="center"]
...
image::gitlab/transition.webp[Transitions of Pipelines,align="center"]
...
image::gitlab/swagger.webp[Swagger API,align="center"]
...
image::gitlab/view-sentry.webp[Sentry Errors,align="center"]
...
image::gitlab/coverage.webp[Coverage Report,align="center"]
...
image::gitlab/view-jaeger1.webp[Jaeger Query,align="center"]
image::gitlab/view-jaeger2.webp[Jaeger Details,align="center"]
...
image::gitlab/dependabot.webp[Dependabot,align="center"]
...
image::gitlab/view-pods.webp[Pod Health,align="center"]
...
image::gitlab/view-logs.webp[Cluster Logs,align="center"]

=== Prometheus Metrics
Prometheus metrics are exposed using GitLab's monitoring and metrics. 

image::gitlab/prom.webp[Prometheus Metrics,align="center"]
...
image::gitlab/valuestream.webp[Value Stream Analytics,align="center"]

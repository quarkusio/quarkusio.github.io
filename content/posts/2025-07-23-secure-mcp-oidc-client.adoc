...
image::demo-architecture.webp[Command Line Poem Service Architecture,align="center"]
...
image::quarkus-realm.webp[Quarkus Realm,align="center"]
...
image::quarkus-mcp-client.webp[Quarkus MCP Client,align="center"]

and enable `Client authentication` and `Service accounts roles` capabilities:

image::quarkus-mcp-client-service-account.webp[Quarkus MCP Client Service Account,align="center"]
...
image::quarkus-mcp-server-scope.webp[Quarkus MCP Server Scope,align="center"]
...
image::quarkus-mcp-server-scope-aud.webp[Quarkus MCP Server Scope Audience,align="center"]

Name this mapper as `quarkus-mcp-server-as-audience` and choose `quarkus-mcp-server` as an `Included Client Audience`:

image::quarkus-mcp-server-scope-aud-details.webp[Quarkus MCP Server Scope Audience Details,align="center"]

Once the `quarkus-mcp-server-scope` is created, add it as an `Optional` scope to the `quarkus-mcp-client`:

image::add-quarkus-mcp-server-scope-to-quarkus-mcp-client.webp[Add Scope to Client,align="center"]
...
image::token-with-quarkus-mcp-server-aud.webp[Token with quarkus-mcp-server audience,align="center"]
...
image::token-with-quarkus-mcp-service-aud.webp[Token with quarkus-mcp-service audience,align="center"]

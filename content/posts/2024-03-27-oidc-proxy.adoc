...
image::security-bearer-token-spa.webp[SPA and Quarkus Service,align="center"]
...
image::strava-application-registration.webp[Strava Application Registration,align="center"]
...
image::create-custom-gpt.webp[Create custom GPT,align="center"]

Name it as `Quarkus Fitness Adviser` and provide its description:

image::custom-gpt-description.webp[Custom GPT description,align="center"]

Next, choose an `OAuth` authentication option:

image::custom-gpt-select-oauth.webp[Custom GPT OAuth option,align="center"]
...
image::custom-gpt-configure-oauth.webp[custom GPT OAuth configuration,align="center"]
...
image::custom-gpt-import-openapi.webp[Custom GPT Import OpenAPI,align="center"]
...
image::custom-gpt-callback.webp[Custom GPT callback,align="center"]
...
image::custom-gpt-is-ready.webp[Custom GPT is ready,align="center"]
...
image::custom-gpt-sign-in.webp[Custom GPT Sign In,align="center"]
...
image::oidc-proxy-strava-login.webp[Strava Login,align="center"]
...
image::strava-application-authorization.webp[Strava Authorization,align="center"]
...
image::custom-gpt-allow-action.webp[Custom GPT Approve Action,align="center"]

Approve it and `Quarkus Fitness Adviser` will provide the first answer:

image::custom-gpt-profile-overview.webp[Custom GPT Profile Overview,align="center"]
...
image::custom-gpt-latest-activity.webp[Custom GPT Latest Activity,align="center"]

Ask it to be more specific about the latest activity and provide some advice. Quarkus Fitness Adviser responds:

image::custom-gpt-activity-recommendation.webp[Custom GPT Activity Recommendation,align="center"]
...
image::custom-gpt-profile-recommendations.webp[Custom GPT More Profile Recommendations,align="center"]

and the end of it:

image::custom-gpt-enjoy-the-ride.webp[Custom GPT Enjoy the Ride,align="center"]

We will return to this advice later in this post.

Let's finish by saying `Thank you`:

image::custom-gpt-final-message.webp[Custom GPT Final Message,align="center"]

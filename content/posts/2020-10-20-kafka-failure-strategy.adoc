...
image:/assets/images/posts/kafka-failure-strategy/messages.webp[]
...
image:/assets/images/posts/kafka-failure-strategy/ack-chain.webp[Acknowledgement chain]
...
image:/assets/images/posts/kafka-failure-strategy/nack-chain.webp[Negative acknowledgment chain]
...
image:/assets/images/posts/kafka-failure-strategy/fail-fast.webp[Fail-Fast]
...
image:/assets/images/posts/kafka-failure-strategy/ignore.webp[Ignore strategy]
...
image:/assets/images/posts/kafka-failure-strategy/dead-letter-topic.webp[Dead-letter topic]

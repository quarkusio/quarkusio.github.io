...
author: iyanev
thumbnailimage: /assets/images/posts/quarkus-user-stories/shipcars/sc_logo.webp

---

:imagesdir: /assets/images/posts/quarkus-user-stories/shipcars

image::sc_logo.webp[alt=Ship.Cars logo,align="center"]
...
image::memory.webp[Memory usage,title="Memory usage of a Quarkus native image"]
...
image::difficulty_cost_line.webp[Difficulty Cost Line,title="Comparison of Difficulty/Cost and Ease of Ease-of-Use/Returns Over Time in Adopting Quarkus Features"]

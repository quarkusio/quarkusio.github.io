...
author: mmaler
thumbnailimage: /assets/images/posts/mmaler-blog-posts/quarkus-unpacked-foojay-podcast.webp
---

= Quarkus Unpacked: Insights from the Foojay Podcast

image::/assets/images/posts/mmaler-blog-posts/quarkus-unpacked-foojay-podcast.webp[alt="Quarkus Unpacked: Insights from the Foojay Podcast", width=100%]

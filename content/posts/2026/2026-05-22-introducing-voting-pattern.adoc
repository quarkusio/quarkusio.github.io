...
image::voting-topology.webp[width=80%, align="center", alt="The topology of the voting-based story evaluation system"]
...
image::voting-execution.webp[width=100%, align="center", alt="A sample execution of the voting-based story evaluation system"]

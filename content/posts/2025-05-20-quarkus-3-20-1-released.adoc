---
layout: post
title: 'Quarkus 3.20.1 released - LTS maintenance release'
date: 2025-05-20
tags: release
synopsis: 'We released Quarkus 3.20.1, the first maintenance release for the 3.20 LTS stream.'
author: jmartisk
---

Today, we released Quarkus 3.20.1, our first maintenance release for the 3.20 LTS stream.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.20.1[the full changelog of 3.20.1 on GitHub].

---
layout: post
title: 'Quarkus 3.2.5.Final released - Maintenance release'
date: 2023-08-28
tags: release
synopsis: 'Quarkus 3.2.5.Final is the fifth maintenance release of our 3.2 LTS release train.'
author: gsmet
---

Today, we released Quarkus 3.2.5.Final, the fifth maintenance release of our 3.2 release train.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.2.5.Final[the full changelog of 3.2.5.Final on GitHub].

...
image:/assets/images/posts/mutiny-vertx/architecture.webp[width=50%]
...
image:/assets/images/posts/mutiny-vertx/generation.webp[]
...
image:/assets/images/posts/mutiny-vertx/mutiny.webp[]

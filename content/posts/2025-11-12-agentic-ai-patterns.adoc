...
image::planner.webp[width=50%, align="center", alt="The planner and execution layers of the LangChain4j agentic architecture"]
...
image::goap.webp[width=50%, align="center", alt="The GOAP-determined sequence of agents invocation to generate an horoscope-based writeup"]

...
image::use-api-keys-to-access-llm.webp[Use API keys to access LLM,align="center"]
...
image::use-access-tokens-to-access-llm.webp[Use access tokens to access LLM,align="center"]
...
image::chatbot-architecture.webp[Gemini Personal Assistant,align="center"]
...
image::entry-demo-screen.webp[Main demo screen,align="center"]

After you login with Google, you will be greeted and offered an option to work with Gemini Personal Assistant:

image::welcome-demo-screen.webp[Welcome demo screen,align="center"]
...
image::check-schedule-question.webp[Check schedule question,align="center"]
...
image::check-schedule-primary-calendar.webp[Check schedule primary calendar,align="center"]
...
image::check-schedule-answer.webp[Check schedule answer,align="center"]
...
image::event-update-request.webp[Event update request,align="center"]
...
image::arsenal-tickets-question.webp[Arsenal tickets question,align="center"]

Personal Assistant is learning so it may need a bit of help to find the right calendar:

image::arsenal-calendar-confirmation.webp[Arsenal calendar confirmation,align="center"]

and now it is happy to give an update:

image::arsenal-tickets-answer.webp[Arsenal tickets answer,align="center"]
...
image::event-conflict-concern.webp[Event conflict concern,align="center"]

Gemini Personal Assistant assures me that no, there is no conflict:

image::no-conflicts-confirmation.webp[No conflicts confirmation,align="center"]

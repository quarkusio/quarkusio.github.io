...
image::wrokflowVsAgents.webp[align="center", alt="AI Workflow Vs. Pure Agentic AI"]
...
image::routing-workflow-trace.webp[align=center, alt="Tracing routing workflow pattern execution"]
...
image::routing-agentic-trace.webp[align=center, alt="Tracing agentic routing execution"]

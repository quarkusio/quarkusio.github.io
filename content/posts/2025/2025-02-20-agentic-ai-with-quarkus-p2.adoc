...
image::agent.webp[width=50%, align="center", alt="Agents can invoke tools"]
...
image::weather-agent.webp[width=80%, align="center", alt="Weather agent architecture"]
...
image::weather-trace.webp[align=center,alt="Tracing sequential execution of the prompt chaining pattern"]
...
image::ai-agent.webp[width=80%, align="center", alt="An agent using an external web search tool"]
...
image::restaurant-agent.webp[width=80%, align="center", alt="The restaurant chatbot agent"]
...
image::restaurant.webp[width=80%, align="center", alt="An example of interaction with the restaurant chatbot agent"]

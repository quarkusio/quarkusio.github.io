...
image::throughput.webp[Throughput as a function of concurrent users]
{sp}  
...
image::meanLatency.webp[Mean Response Time as a function of concurrent users]
{sp}  

.Maximum Response Time (ms) as a function of concurrent users
image::maxLatency.webp[Mean Response Time as a function of concurrent users]
{sp}  

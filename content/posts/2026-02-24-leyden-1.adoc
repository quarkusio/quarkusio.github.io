...
image::flamegraph-compatibility-layer.webp[Netty trying to determine whether virtual threads are available]
...
image::flamegraph-marker-annotation.webp[Netty trying to determine if a ChannelHandler is sharable]
...
image::flamegraph-hibernate-annotations.webp[Hibernate ORM collecting metadata about its own annotations]
...
image::flamegraph-packageinfo.webp[Hibernate ORM trying to load non-existing package-info]
...
image::flamegraph-non-existing-class.webp[JBoss Logging loading a non-existing class]
...
image::flamegraph-serviceloader-storm.webp[A ServiceLoader storm]
...
image::flamegraph-uuid.webp[Generating a UUID for the first time]
...
image::flamegraph-bigdecimal.webp[Initialization of BigDecimal]
...
image::flamegraph-timezone.webp[Loading the time zone database]
...
image::flamegraph-zoneid.webp[Loading the zone rules]

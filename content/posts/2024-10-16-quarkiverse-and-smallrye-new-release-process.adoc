...
image::original-release-process.webp[The release process used by Quarkiverse and SmallRye,float="center",align="center"]
...
image::flaw.webp[The flaw in the release process,float="center",align="center"]
...
image::new-release-process.webp[The new release process,float="center",align="center"]

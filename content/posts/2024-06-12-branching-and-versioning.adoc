...
image::3.11.0.CR1-HEAD.webp[3.11.0.CR1-HEAD,float="right",align="center"]

After the release process is completed, the branch looks like this:

image::3.11.0.CR1-release.webp[3.11.0.CR1-release,float="right",align="center"]
...
image::3.11.0-release.webp[3.11.0-release,float="right",align="center"]

Compare this with the image for `3.11.0.CR1` and you'll see that only safe changes are included.

Same for `3.11.1`:

image::3.11.1-release.webp[3.11.1-release,float="right",align="center"]

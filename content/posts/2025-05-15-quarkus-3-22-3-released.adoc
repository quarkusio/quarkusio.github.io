---
layout: post
title: 'Quarkus 3.22.3 - Maintenance release'
date: 2025-05-15
tags: release
synopsis: 'We released Quarkus 3.22.3, a maintenance release for our 3.22 release train.'
author: gsmet
---

We released Quarkus 3.22.3, the second (we skipped 3.22.0) maintenance release for our 3.22 release train.
...
You can get the full changelog of https://github.com/quarkusio/quarkus/releases/tag/3.22.3[3.22.3] on GitHub.

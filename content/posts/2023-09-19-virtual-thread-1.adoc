...
image::imperative-model.webp[Threads involved with the imperative model,400,float="right",align="center"]
...
image::reactive-model.webp[Thread involved with the reactive model,400,float="right",align="center"]
...
image::virtual-thread-model-2.webp[Threads involved with virtual threads,400,float="right",align="center"]
...
image::pinning.webp[Pinning of the carrier thread,400,float="right",align="center"]
...
image::monopolization.webp[Monopolization of the carrier thread,400,float="right",align="center"]

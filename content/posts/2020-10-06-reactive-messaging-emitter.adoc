...
image:/assets/images/posts/reactive-messaging-emitter/architecture.webp[width=70%]
...
image:/assets/images/posts/reactive-messaging-emitter/buffer.webp[width=90%]

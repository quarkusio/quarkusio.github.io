...
thumbnailimage: /assets/images/posts/quarkus-user-stories/payair/payair_logo_rgb.webp
---
...
[.customer-logo]
image:payair_logo_rgb.webp[Payair Logo]
...
image::perf_black.webp[Performance Chart]

...
thumbnailimage: /assets/images/posts/quarkus-user-stories/gran/gran-logo.webp
---
:imagesdir: /assets/images/posts/quarkus-user-stories/gran

[.customer-logo]
image::gran-logo.webp[GRAN logo,200]
...
image::frustrated-developer.webp[alt="Frustrated Developer",align="center",width=640]
...
image::db-migrations.webp[alt="Database Migrations",align="center",width=640]
...
image::k8s-config.webp[alt="Kubernetes configuration",align="center",width=640]
...
image::qute-templates.webp[alt="Qute Templates",align="center",width=640]

...
image::01-project-to-migrate.webp[alt=Application to migrate, align=left, width=60%]
...
.Skill invocation
image::03-skill-invocation.webp[alt="skill invocation",align=left, width=80%]
...
image::04-analysis-overview.webp[alt="analysis overview",align=left, width=80%]
...
image::05-skill-load-modules.webp[alt="skill load modules",align=left, width=80%]
...
.Gate JDK check
image::06-gate-check.webp[alt="Gate JDK check",align=left, width=70%]
...
.Module Build System
image::08-module-build-executed.webp[alt="Module Build system",align=left, width=85%]
...
.Module Code
image::07-module-code-executed.webp[alt="Module code executed",align=left, width=95%]
...
.Verification checks
image::09-verification-checks.webp[alt="Verification checks",align=left, width=95%]
...
image::10-migration-report-1.webp[alt="migration report",align=left, width=95%]
...
- https://bob.ibm.com/docs/ide/getting-started/install[IBM Bob] -- the AI SDLC partner for working with real codebases.
...
thumbnailimage: /assets/images/posts/quarkus-user-stories/vodafonegreece/New_VF_Logo_Horiz_RGB_RED.webp
---
...
[.customer-logo]
image::New_VF_Logo_Horiz_RGB_RED.webp[Vodafone Greece logo,300]

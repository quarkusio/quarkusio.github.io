---
layout: post
title: 'Quarkus 3.9.3 released - Maintenance release'
date: 2024-04-10
tags: release
synopsis: 'We released Quarkus 3.9.3, our second maintenance release for the 3.9 release train.'
author: gsmet
---

Today, we released Quarkus 3.9.3, our second (we skipped 3.9.0) maintenance release for the 3.9 release train.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.9.3[the full changelog of 3.9.3 on GitHub].

...
image::duke_superhero.webp[alt=Duke Superhero, align=left, width=50%]
...
image::fight_screen.webp[alt=Super Heroes UI]
...
.Fight Statistics
image::event_stats.webp[alt=Event Statistics UI]
...
image::application_architecture.webp[alt=Overall architecture]

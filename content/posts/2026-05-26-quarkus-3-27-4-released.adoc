...
date: 2026-05-26
tags: release
synopsis: 'We released Quarkus 3.27.4, the next maintenance release for the 3.27 LTS stream.'
author: jmartisk
---

Today, we released Quarkus 3.27.4, our next maintenance release for the 3.27 LTS stream.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.27.4[the full changelog of 3.27.4 on GitHub].

...
The following examples use _hello_ as the client name.
...
`GrpcClientUtils` works with all flavors of clients.
...
include::{generated-dir}/config/quarkus-grpc_quarkus.grpc.dev-mode.adoc[opts=optional, leveloffset=+1]

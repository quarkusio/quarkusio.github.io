...
:categories: security
:categories-path: security.security-authentication
:topics: security,jwt
...
The SmallRye JWT Build API simplifies securing JWT claims by supporting all these options. It uses the link:https://bitbucket.org/b_c/jose4j/src/master/[Jose4J] library internally to provide this functionality.
...
* link:https://bitbucket.org/b_c/jose4j/src/master/[Jose4J]

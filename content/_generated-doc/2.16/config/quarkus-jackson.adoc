...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus.jackson.write-durations-as-timestamps]]`link:#quarkus-jackson_quarkus.jackson.write-durations-as-timestamps[quarkus.jackson.write-durations-as-timestamps]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus.jackson.property-naming-strategy]]`link:#quarkus-jackson_quarkus.jackson.property-naming-strategy[quarkus.jackson.property-naming-strategy]`

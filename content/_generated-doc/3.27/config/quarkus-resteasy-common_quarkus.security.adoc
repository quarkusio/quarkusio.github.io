...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-common_quarkus-security-jaxrs-deny-unannotated-endpoints]] [.property-path]##link:#quarkus-resteasy-common_quarkus-security-jaxrs-deny-unannotated-endpoints[`quarkus.security.jaxrs.deny-unannotated-endpoints`]##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-common_quarkus-security-jaxrs-default-roles-allowed]] [.property-path]##link:#quarkus-resteasy-common_quarkus-security-jaxrs-default-roles-allowed[`quarkus.security.jaxrs.default-roles-allowed`]##
ifdef::add-copy-button-to-config-props[]

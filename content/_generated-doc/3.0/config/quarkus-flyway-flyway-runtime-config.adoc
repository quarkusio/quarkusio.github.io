...
a| [[quarkus-flyway-flyway-runtime-config_quarkus.flyway.run-and-exit]]`link:#quarkus-flyway-flyway-runtime-config_quarkus.flyway.run-and-exit[quarkus.flyway.run-and-exit]`
...
a| [[quarkus-flyway-flyway-runtime-config_quarkus.flyway.-named-data-sources-.run-and-exit]]`link:#quarkus-flyway-flyway-runtime-config_quarkus.flyway.-named-data-sources-.run-and-exit[quarkus.flyway."named-data-sources".run-and-exit]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.externalize-init]]`link:#quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.externalize-init[quarkus.kubernetes.externalize-init]`

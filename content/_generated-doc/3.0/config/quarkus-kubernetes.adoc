...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KNATIVE_HOST+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus.kubernetes.externalize-init]]`link:#quarkus-kubernetes_quarkus.kubernetes.externalize-init[quarkus.kubernetes.externalize-init]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus.openshift.externalize-init]]`link:#quarkus-kubernetes_quarkus.openshift.externalize-init[quarkus.openshift.externalize-init]`

...
a| [[quarkus-flyway-config-group-flyway-data-source-runtime-config_quarkus.flyway.run-and-exit]]`link:#quarkus-flyway-config-group-flyway-data-source-runtime-config_quarkus.flyway.run-and-exit[quarkus.flyway.run-and-exit]`

[.description]
--
true to quit exit right after the operation. The option is not meant be used directly by users.

ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_FLYWAY_RUN_AND_EXIT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_FLYWAY_RUN_AND_EXIT+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`false`
...
a| [[quarkus-flyway-config-group-flyway-data-source-runtime-config_quarkus.flyway.-named-data-sources-.run-and-exit]]`link:#quarkus-flyway-config-group-flyway-data-source-runtime-config_quarkus.flyway.-named-data-sources-.run-and-exit[quarkus.flyway."named-data-sources".run-and-exit]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_FLYWAY__NAMED_DATA_SOURCES__RUN_AND_EXIT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_FLYWAY__NAMED_DATA_SOURCES__RUN_AND_EXIT+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`false`

...
a| [[quarkus-stork-stork-stork-configuration_quarkus.stork.-service-name-.service-registrar-parameters]]`link:#quarkus-stork-stork-stork-configuration_quarkus.stork.-service-name-.service-registrar-parameters[quarkus.stork."service-name".service-registrar]`

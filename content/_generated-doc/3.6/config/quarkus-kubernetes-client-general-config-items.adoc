...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-client-general-config-items_quarkus.kubernetes-client.devservices.container-env-container-env]]`link:#quarkus-kubernetes-client-general-config-items_quarkus.kubernetes-client.devservices.container-env-container-env[quarkus.kubernetes-client.devservices.container-env]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-general-config-items_quarkus.redis.devservices.container-env-container-env]]`link:#quarkus-redis-general-config-items_quarkus.redis.devservices.container-env-container-env[quarkus.redis.devservices.container-env]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-general-config-items_quarkus.redis.-additional-redis-clients-.devservices.container-env-container-env]]`link:#quarkus-redis-general-config-items_quarkus.redis.-additional-redis-clients-.devservices.container-env-container-env[quarkus.redis."additional-redis-clients".devservices.container-env]`

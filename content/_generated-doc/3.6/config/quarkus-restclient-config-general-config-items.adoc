...
a| [[quarkus-restclient-config-general-config-items_quarkus.rest-client.multipart.max-chunk-size]]`link:#quarkus-restclient-config-general-config-items_quarkus.rest-client.multipart.max-chunk-size[quarkus.rest-client.multipart.max-chunk-size]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client_quarkus-infinispan-client-transport-factory]] [.property-path]##link:#quarkus-infinispan-client_quarkus-infinispan-client-transport-factory[`+++quarkus.infinispan-client.transport-factory+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.infinispan-client.transport-factory+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INFINISPAN_CLIENT_TRANSPORT_FACTORY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INFINISPAN_CLIENT_TRANSPORT_FACTORY+++`
endif::add-copy-button-to-env-var[]
--
|string
...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client_quarkus-infinispan-client-client-name-transport-factory]] [.property-path]##link:#quarkus-infinispan-client_quarkus-infinispan-client-client-name-transport-factory[`+++quarkus.infinispan-client."client-name".transport-factory+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.infinispan-client."client-name".transport-factory+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INFINISPAN_CLIENT__CLIENT_NAME__TRANSPORT_FACTORY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INFINISPAN_CLIENT__CLIENT_NAME__TRANSPORT_FACTORY+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++io.quarkus.infinispan.client.runtime.QuarkusTransportFactory+++`

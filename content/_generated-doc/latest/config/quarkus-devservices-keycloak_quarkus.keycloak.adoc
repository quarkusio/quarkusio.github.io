...
a|icon:lock[title=Fixed at build time] [[quarkus-devservices-keycloak_quarkus-keycloak-devservices-disable-https]] [.property-path]##link:#quarkus-devservices-keycloak_quarkus-keycloak-devservices-disable-https[`+++quarkus.keycloak.devservices.disable-https+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.keycloak.devservices.disable-https+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KEYCLOAK_DEVSERVICES_DISABLE_HTTPS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-devservices-keycloak_quarkus-keycloak-devservices-host-accessible-ports]] [.property-path]##link:#quarkus-devservices-keycloak_quarkus-keycloak-devservices-host-accessible-ports[`+++quarkus.keycloak.devservices.host-accessible-ports+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.keycloak.devservices.host-accessible-ports+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The host ports to expose to the Keycloak container. When this list is non-empty, the host is made accessible from the container using the `host.testcontainers.internal` hostname, and only the listed ports are exposed. This may be necessary when Keycloak needs to make HTTP callbacks to the application running on the host.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KEYCLOAK_DEVSERVICES_HOST_ACCESSIBLE_PORTS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KEYCLOAK_DEVSERVICES_HOST_ACCESSIBLE_PORTS+++`
endif::add-copy-button-to-env-var[]
--
|list of int
|

a|icon:lock[title=Fixed at build time] [[quarkus-devservices-keycloak_quarkus-keycloak-devservices-access-token-lifespan]] [.property-path]##link:#quarkus-devservices-keycloak_quarkus-keycloak-devservices-access-token-lifespan[`+++quarkus.keycloak.devservices.access-token-lifespan+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.keycloak.devservices.access-token-lifespan+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The access token lifespan in the default realm.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KEYCLOAK_DEVSERVICES_ACCESS_TOKEN_LIFESPAN+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KEYCLOAK_DEVSERVICES_ACCESS_TOKEN_LIFESPAN+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-devservices-keycloak_quarkus-keycloak[icon:question-circle[title=More information about the Duration format]]
|`+++10M+++`

a|icon:lock[title=Fixed at build time] [[quarkus-devservices-keycloak_quarkus-keycloak-devservices-sso-session-max-lifespan]] [.property-path]##link:#quarkus-devservices-keycloak_quarkus-keycloak-devservices-sso-session-max-lifespan[`+++quarkus.keycloak.devservices.sso-session-max-lifespan+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.keycloak.devservices.sso-session-max-lifespan+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The SSO session max lifespan in the default realm.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KEYCLOAK_DEVSERVICES_SSO_SESSION_MAX_LIFESPAN+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KEYCLOAK_DEVSERVICES_SSO_SESSION_MAX_LIFESPAN+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-devservices-keycloak_quarkus-keycloak[icon:question-circle[title=More information about the Duration format]]
|`+++10M+++`

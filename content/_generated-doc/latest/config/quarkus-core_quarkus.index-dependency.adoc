...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-index-dependency-dependency-name-type]] [.property-path]##link:#quarkus-core_quarkus-index-dependency-dependency-name-type[`+++quarkus.index-dependency."dependency-name".type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.index-dependency."dependency-name".type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INDEX_DEPENDENCY__DEPENDENCY_NAME__TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INDEX_DEPENDENCY__DEPENDENCY_NAME__TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++jar+++`

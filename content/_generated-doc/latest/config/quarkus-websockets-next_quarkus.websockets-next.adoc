...
a| [[quarkus-websockets-next_quarkus-websockets-next-client-max-pending-messages]] [.property-path]##link:#quarkus-websockets-next_quarkus-websockets-next-client-max-pending-messages[`+++quarkus.websockets-next.client.max-pending-messages+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.websockets-next.client.max-pending-messages+++[]
endif::add-copy-button-to-config-props[]
...
When set to a positive value, the connection applies back-pressure so that no more than this number of messages are received but not yet fully processed, bounding the memory a connection can retain. Set to `0` or a negative value to disable back-pressure completely.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_WEBSOCKETS_NEXT_CLIENT_MAX_PENDING_MESSAGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_WEBSOCKETS_NEXT_CLIENT_MAX_PENDING_MESSAGES+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++256+++`
...
a| [[quarkus-websockets-next_quarkus-websockets-next-server-max-pending-messages]] [.property-path]##link:#quarkus-websockets-next_quarkus-websockets-next-server-max-pending-messages[`+++quarkus.websockets-next.server.max-pending-messages+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.websockets-next.server.max-pending-messages+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_WEBSOCKETS_NEXT_SERVER_MAX_PENDING_MESSAGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_WEBSOCKETS_NEXT_SERVER_MAX_PENDING_MESSAGES+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++256+++`

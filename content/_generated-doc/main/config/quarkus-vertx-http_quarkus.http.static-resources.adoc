...
a| [[quarkus-vertx-http_quarkus-http-static-resources_quarkus-http-static-resources-directory-listing]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-static-resources_quarkus-http-static-resources-directory-listing[`+++quarkus.http.static-resources.directory-listing+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.static-resources.directory-listing+++[]
endif::add-copy-button-to-config-props[]
...
When enabled, if a request is made to a path that maps to a directory, the server returns an HTML page listing the directory contents.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_STATIC_RESOURCES_DIRECTORY_LISTING+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HTTP_STATIC_RESOURCES_DIRECTORY_LISTING+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a| [[quarkus-vertx-http_quarkus-http-static-resources_quarkus-http-static-resources-send-vary-header]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-static-resources_quarkus-http-static-resources-send-vary-header[`+++quarkus.http.static-resources.send-vary-header+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.static-resources.send-vary-header+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Set whether the `Vary` header should be sent in responses.

The `Vary` header indicates to caches that the response may vary based on the value of the specified request headers (e.g. `Accept-Encoding`).


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_STATIC_RESOURCES_SEND_VARY_HEADER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HTTP_STATIC_RESOURCES_SEND_VARY_HEADER+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

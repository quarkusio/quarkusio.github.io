...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc_quarkus-oidc-allowed-routes]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-allowed-routes[`+++quarkus.oidc.allowed-routes+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.allowed-routes+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Supported HTTP routes for OIDC tenant features. To avoid unnecessary overhead, remove routes that are not required by any of the OIDC tenants.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_ALLOWED_ROUTES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_ALLOWED_ROUTES+++`
endif::add-copy-button-to-env-var[]
--
a|list of `backchannel-logout`, `resource-metadata`, `client-id-metadata`
|`+++backchannel-logout+++`, `+++resource-metadata+++`, `+++client-id-metadata+++`
...
a| [[quarkus-oidc_quarkus-oidc-priority]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-priority[`+++quarkus.oidc.priority+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.priority+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_PRIORITY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_PRIORITY+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++1001+++`
...
a| [[quarkus-oidc_quarkus-oidc-discovery-path]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-discovery-path[`+++quarkus.oidc.discovery-path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.discovery-path+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".discovery-path+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".discovery-path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_DISCOVERY_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_DISCOVERY_PATH+++`
endif::add-copy-button-to-env-var[]
--
|string
...
If this property is set to an HTTPS URL, the link:https://datatracker.ietf.org/doc/html/draft-ietf-oauth-client-id-metadata-document[OAuth Client ID Metadata Document] registration is activated. In this mode, Quarkus serves a metadata document at the URL path derived from the client id, allowing the authorization server to discover the client configuration without prior registration. The `client-name()` property must also be set in this case. This option is only supported by the OIDC extension.
...
[.description]
--
JWT token source: token is generated by the OIDC provider client or is an existing JWT bearer or SPIFFE SVID token.
...
--
a|tooltip:client[JWT token is generated by the OIDC provider client to support `client_secret_jwt` and `private_key_jwt` authentication methods.], tooltip:bearer[JWT bearer token is used as a client assertion\: https\://www.rfc-editor.org/rfc/rfc7523++#++section-2.2.], tooltip:spiffe-jwt[SPIFFE SVID token is used as a client assertion\: urn\:ietf\:params\:oauth\:client-assertion-type\:jwt-spiffe]
...
a| [[quarkus-oidc_quarkus-oidc-credentials-jwt-public-key]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-credentials-jwt-public-key[`+++quarkus.oidc.credentials.jwt.public-key+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.credentials.jwt.public-key+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".credentials.jwt.public-key+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".credentials.jwt.public-key+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
String representation of a public key in PEM format. Ignored unless the `OidcClientCommonConfig++#++clientId() client-id` is an HTTPS URL activating the link:https://datatracker.ietf.org/doc/html/draft-ietf-oauth-client-id-metadata-document[Client ID Metadata Document] registration, and a private key (`key`, `key-file`, or `key-store-file`) is also configured. The public key is published in the metadata document `jwks` property and `token_endpoint_auth_method` is set to `private_key_jwt`. This option is only supported by the OIDC extension.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CREDENTIALS_JWT_PUBLIC_KEY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CREDENTIALS_JWT_PUBLIC_KEY+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-oidc_quarkus-oidc-credentials-jwt-public-key-file]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-credentials-jwt-public-key-file[`+++quarkus.oidc.credentials.jwt.public-key-file+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.credentials.jwt.public-key-file+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".credentials.jwt.public-key-file+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".credentials.jwt.public-key-file+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
Path to a file containing the public key in PEM format. Both public keys and certificates are accepted. Ignored unless the `OidcClientCommonConfig++#++clientId() client-id` is an HTTPS URL activating the link:https://datatracker.ietf.org/doc/html/draft-ietf-oauth-client-id-metadata-document[Client ID Metadata Document] registration, and a private key (`key`, `key-file`, or `key-store-file`) is also configured. The public key is published in the metadata document `jwks` property and `token_endpoint_auth_method` is set to `private_key_jwt`. This option is only supported by the OIDC extension.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CREDENTIALS_JWT_PUBLIC_KEY_FILE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CREDENTIALS_JWT_PUBLIC_KEY_FILE+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
[.description]
--
The JWT audience (`aud`) claim value. By default, the audience is set to the address of the OpenId Connect Provider's token endpoint. When the JWT `source()` is `Source++#++SPIFFE_JWT`, the audience defaults to the `OidcCommonConfig++#++authServerUrl() auth-server-url` instead. If the OIDC provider's issuer URL differs from the `auth-server-url`, set this property explicitly.
...
a| [[quarkus-oidc_quarkus-oidc-credentials-for-all-endpoints]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-credentials-for-all-endpoints[`+++quarkus.oidc.credentials.for-all-endpoints+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.credentials.for-all-endpoints+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".credentials.for-all-endpoints+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".credentials.for-all-endpoints+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
If true, client credentials are also sent to OIDC discovery and JWKS endpoints, which normally do not require authentication. Enable this when the OIDC provider enforces authenticated access to these endpoints.
 ...
 * JWT bearer (`jwt.source=bearer`) — `Authorization: Bearer` header


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CREDENTIALS_FOR_ALL_ENDPOINTS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CREDENTIALS_FOR_ALL_ENDPOINTS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
h|[[quarkus-oidc_section_quarkus-oidc-client-id-metadata]] [.section-name.section-level0]##link:#quarkus-oidc_section_quarkus-oidc-client-id-metadata[Client ID Metadata Document configuration]##
h|Type
h|Default

a| [[quarkus-oidc_quarkus-oidc-client-id-metadata-force-https-scheme]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-client-id-metadata-force-https-scheme[`+++quarkus.oidc.client-id-metadata.force-https-scheme+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.client-id-metadata.force-https-scheme+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".client-id-metadata.force-https-scheme+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".client-id-metadata.force-https-scheme+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
Force the Client ID Metadata Document URL to use the HTTPS scheme. Setting this to `false` allows HTTP URLs as the client identifier.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_ID_METADATA_FORCE_HTTPS_SCHEME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CLIENT_ID_METADATA_FORCE_HTTPS_SCHEME+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
a| [[quarkus-oidc_quarkus-oidc-token-refresh-token-cache-time-to-live]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-token-refresh-token-cache-time-to-live[`+++quarkus.oidc.token.refresh-token-cache-time-to-live+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.token.refresh-token-cache-time-to-live+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".token.refresh-token-cache-time-to-live+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".token.refresh-token-cache-time-to-live+++[]
endif::add-copy-button-to-config-props[]
...
When multiple concurrent requests carry the same expired session, each independently attempts to refresh the token. If the OIDC provider restricts how many times a refresh token can be used, duplicate refresh attempts may be rejected. Set this property to a short duration (for example, 5 seconds) to ensure only one refresh call is made and subsequent requests reuse the cached result.

Keep the value short (a few seconds) — it only needs to cover the window between concurrent requests arriving at the server. The cached tokens begin aging immediately, so longer values serve increasingly stale tokens without benefit.

The cache is per application instance with up to 10,000 entries.

This property is only effective when `refresh-expired()` is enabled.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_TOKEN_REFRESH_TOKEN_CACHE_TIME_TO_LIVE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_TOKEN_REFRESH_TOKEN_CACHE_TIME_TO_LIVE+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-oidc_quarkus-oidc[icon:question-circle[title=More information about the Duration format]]
|`+++0S+++`
...
a| [[quarkus-oidc_quarkus-oidc-token-decryption-algorithm]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-token-decryption-algorithm[`+++quarkus.oidc.token.decryption-algorithm+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.token.decryption-algorithm+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".token.decryption-algorithm+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".token.decryption-algorithm+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_TOKEN_DECRYPTION_ALGORITHM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_TOKEN_DECRYPTION_ALGORITHM+++`
endif::add-copy-button-to-env-var[]
--
a|`rsa-oaep`, `rsa-oaep-256`, `a256-gcmkw`
|`+++RSA-OAEP if the decryption key is a private key, A256GCMKW if it is a secret key+++`
...
h|[[quarkus-oidc_section_quarkus-oidc-dpop]] [.section-name.section-level0]##link:#quarkus-oidc_section_quarkus-oidc-dpop[Configuration of the Demonstrating Proof of Possession (DPoP) proof verification]##
h|Type
h|Default

a| [[quarkus-oidc_quarkus-oidc-dpop-proof-age]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-dpop-proof-age[`+++quarkus.oidc.dpop.proof-age+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.dpop.proof-age+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".dpop.proof-age+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".dpop.proof-age+++[]
endif::add-copy-button-to-config-props[]
...
Evaluated as the difference between the server's current time and the DPoP proof's `iat` (issued at) claim. Proofs exceeding this age are rejected with an `invalid_dpop_proof` error. Leeway for clock skew can be adjusted using `Token++#++lifespanGrace()`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_DPOP_PROOF_AGE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_DPOP_PROOF_AGE+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-oidc_quarkus-oidc[icon:question-circle[title=More information about the Duration format]]
|`+++2M+++`
...
a| [[quarkus-oidc_quarkus-oidc-authentication-state-cookie-same-site]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-authentication-state-cookie-same-site[`+++quarkus.oidc.authentication.state-cookie-same-site+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.authentication.state-cookie-same-site+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".authentication.state-cookie-same-site+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".authentication.state-cookie-same-site+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_AUTHENTICATION_STATE_COOKIE_SAME_SITE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_AUTHENTICATION_STATE_COOKIE_SAME_SITE+++`
endif::add-copy-button-to-env-var[]
--
a|`strict`, `lax`, `none`
|`+++lax+++`
...
h|[[quarkus-oidc_section_quarkus-oidc-authentication-rar]] [.section-name.section-level1]##link:#quarkus-oidc_section_quarkus-oidc-authentication-rar[Configuration for the rich authorization requests (RAR)]##
h|Type
h|Default

a| [[quarkus-oidc_quarkus-oidc-authentication-rar-simple-field]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-authentication-rar-simple-field[`+++quarkus.oidc.authentication.rar.simple."field"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.authentication.rar.simple."field"+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".authentication.rar.simple."field"+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".authentication.rar.simple."field"+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
Configures the `authorization_details` request parameter string fields of the authorization request. For example, if you configure the `quarkus.oidc.authentication.rar.simple.credential_configuration_id=vc-scope-mapping` property, following `authorization_details` request parameter will be added to the authorization request:
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_AUTHENTICATION_RAR_SIMPLE__FIELD_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_AUTHENTICATION_RAR_SIMPLE__FIELD_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|

a| [[quarkus-oidc_quarkus-oidc-authentication-rar-array-field]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-authentication-rar-array-field[`+++quarkus.oidc.authentication.rar.array."field"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.authentication.rar.array."field"+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".authentication.rar.array."field"+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".authentication.rar.array."field"+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
Configures the `authorization_details` request parameter array fields of the authorization request. For example, if you configure the `quarkus.oidc.authentication.rar.array.locations=https://...` property, following `authorization_details` request parameter will be added to the authorization request:
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_AUTHENTICATION_RAR_ARRAY__FIELD_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_AUTHENTICATION_RAR_ARRAY__FIELD_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,List<String>>
|

a| [[quarkus-oidc_quarkus-oidc-authentication-rar-type]] [.property-path]##link:#quarkus-oidc_quarkus-oidc-authentication-rar-type[`+++quarkus.oidc.authentication.rar.type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc.authentication.rar.type+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc."tenant".authentication.rar.type+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc."tenant".authentication.rar.type+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The `authorization_details` type field. Please see the RFC 9396 link:https://datatracker.ietf.org/doc/html/rfc9396#name-request-parameter-authoriza[Request Parameter `authorization_details`] for more information.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_AUTHENTICATION_RAR_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_AUTHENTICATION_RAR_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string

...
a| [[quarkus-oidc-client_quarkus-oidc-client-discovery-path]] [.property-path]##link:#quarkus-oidc-client_quarkus-oidc-client-discovery-path[`+++quarkus.oidc-client.discovery-path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client.discovery-path+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc-client."id".discovery-path+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client."id".discovery-path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_DISCOVERY_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-oidc-client_quarkus-oidc-client-credentials-jwt-public-key]] [.property-path]##link:#quarkus-oidc-client_quarkus-oidc-client-credentials-jwt-public-key[`+++quarkus.oidc-client.credentials.jwt.public-key+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client.credentials.jwt.public-key+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc-client."id".credentials.jwt.public-key+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client."id".credentials.jwt.public-key+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_PUBLIC_KEY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_PUBLIC_KEY+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-oidc-client_quarkus-oidc-client-credentials-jwt-public-key-file]] [.property-path]##link:#quarkus-oidc-client_quarkus-oidc-client-credentials-jwt-public-key-file[`+++quarkus.oidc-client.credentials.jwt.public-key-file+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client.credentials.jwt.public-key-file+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc-client."id".credentials.jwt.public-key-file+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client."id".credentials.jwt.public-key-file+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_PUBLIC_KEY_FILE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_PUBLIC_KEY_FILE+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a| [[quarkus-oidc-client_quarkus-oidc-client-credentials-for-all-endpoints]] [.property-path]##link:#quarkus-oidc-client_quarkus-oidc-client-credentials-for-all-endpoints[`+++quarkus.oidc-client.credentials.for-all-endpoints+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client.credentials.for-all-endpoints+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.oidc-client."id".credentials.for-all-endpoints+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client."id".credentials.for-all-endpoints+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_CREDENTIALS_FOR_ALL_ENDPOINTS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CLIENT_CREDENTIALS_FOR_ALL_ENDPOINTS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

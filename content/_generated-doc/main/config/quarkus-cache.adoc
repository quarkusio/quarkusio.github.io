...
a| [[quarkus-cache_quarkus-cache-caffeine-per-item-expiration]] [.property-path]##link:#quarkus-cache_quarkus-cache-caffeine-per-item-expiration[`+++quarkus.cache.caffeine.per-item-expiration+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.cache.caffeine.per-item-expiration+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether per-item expiration is enabled for this cache. When enabled, individual cache entries can have custom expiration durations set via the programmatic API (`get(key, valueLoader, expiresAfter)`).

Enabling this option adds a small amount of memory overhead per cache entry and a per-read computation cost, even for entries that do not use a custom expiration. Only enable this if you need per-item expiration control.

Note: regardless of this setting, each Caffeine cache entry carries a small fixed wrapper overhead to support the per-item expiration infrastructure.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_CACHE_CAFFEINE_PER_ITEM_EXPIRATION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_CACHE_CAFFEINE_PER_ITEM_EXPIRATION+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
a| [[quarkus-cache_quarkus-cache-caffeine-cache-name-per-item-expiration]] [.property-path]##link:#quarkus-cache_quarkus-cache-caffeine-cache-name-per-item-expiration[`+++quarkus.cache.caffeine."cache-name".per-item-expiration+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.cache.caffeine."cache-name".per-item-expiration+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_CACHE_CAFFEINE__CACHE_NAME__PER_ITEM_EXPIRATION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_CACHE_CAFFEINE__CACHE_NAME__PER_ITEM_EXPIRATION+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

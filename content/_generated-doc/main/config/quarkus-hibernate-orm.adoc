...
--
a|tooltip:none[Identifiers are not quoted.], tooltip:all[All identifiers are quoted.], tooltip:all-except-column-definitions[All identifiers, except column definitions, are quoted.], tooltip:only-keywords[Only keywords will be quoted.]
|tooltip:none[Identifiers are not quoted.]
...
--
a|list of tooltip:auto[If a Bean Validation provider is present then behaves as if both `ValidationMode#CALLBACK` and `ValidationMode#DDL` modes are configured. Otherwise, same as `ValidationMode#NONE`.], tooltip:callback[Bean Validation will perform the lifecycle event validation.], tooltip:ddl[Bean Validation constraints will be considered for the DDL operations.], tooltip:none[Bean Validation integration will be disabled.]
|`+++auto+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-blocking]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-blocking[[.line-through]#`+++quarkus.hibernate-orm.blocking+++`#]##
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated since `3.39`: Use `quarkus.hibernate-orm.jdbc.enabled` for the default persistence unit, and `quarkus.hibernate-orm."<persistence-unit-name>".jdbc.enabled` for named persistence units, to configure this on a per-persistence-unit basis instead._
...
[.description]
--
_This property is deprecated: Use `quarkus.hibernate-orm.fetch.batch-size` to configure the batch fetch size._
...
[.description]
--
_This property is deprecated: Use `quarkus.hibernate-orm.fetch.max-depth` to configure the maximum fetch depth._
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-metadata-builder-contributor]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-metadata-builder-contributor[[.line-through]#`+++quarkus.hibernate-orm.metadata-builder-contributor+++`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm.metadata-builder-contributor+++[]
endif::add-copy-button-to-config-props[]


[.line-through]#`+++quarkus.hibernate-orm."persistence-unit-name".metadata-builder-contributor+++`#
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated: Use `TypeContributor`, `FunctionContributor`, or `AdditionalMappingContributor` instead._
...
[.description]
--
_This property is deprecated since `3.19`: Use `quarkus.hibernate-orm.validation.mode` instead._
...
[.description]
--
_This property is deprecated: Use `quarkus.hibernate-orm.datasource` to configure the datasource for the persistence unit._
...
--
a|tooltip:native[Stores the timestamp and timezone in a column of type `timestamp with time zone`. Only available on some databases/dialects; if not supported, an exception will be thrown during static initialization.], tooltip:normalize[Does not store the timezone, and loses timezone information upon persisting. Instead, normalizes the value\: * upon persisting to the database, to a timestamp in the JDBC timezone set through `quarkus.hibernate-orm.jdbc.timezone`, or the JVM default timezone if not set. * upon reading back from the database, to the JVM default timezone. Use this to get the legacy behavior of Quarkus 2 / Hibernate ORM 5 or older.], tooltip:normalize-utc[Does not store the timezone, and loses timezone information upon persisting. Instead, normalizes the value to a timestamp in the UTC timezone.], tooltip:column[Stores the timezone in a separate column next to the timestamp column. Use `@TimeZoneColumn` on the relevant entity property to customize the timezone column.], tooltip:auto[Equivalent to `native` if supported, `column` otherwise.], tooltip:default[Equivalent to `native` if supported, `normalize-utc` otherwise.]
|tooltip:default[Equivalent to `native` if supported, `normalize-utc` otherwise.]
...
--
a|tooltip:none[Null precedence not specified.], tooltip:first[Null values occur at the beginning of the ORDER BY clause.], tooltip:last[Null values occur at the end of the ORDER BY clause.]
|tooltip:none[Null precedence not specified.]
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-jdbc-enabled]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-jdbc-enabled[`+++quarkus.hibernate-orm.jdbc.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm.jdbc.enabled+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.hibernate-orm."persistence-unit-name".jdbc.enabled+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm."persistence-unit-name".jdbc.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HIBERNATE_ORM_JDBC_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HIBERNATE_ORM_JDBC_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|
...
h|[[quarkus-hibernate-orm_section_quarkus-hibernate-orm-reactive]] [.section-name.section-level0]##link:#quarkus-hibernate-orm_section_quarkus-hibernate-orm-reactive[Reactive related configuration]##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-reactive-enabled]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-reactive-enabled[`+++quarkus.hibernate-orm.reactive.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm.reactive.enabled+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.hibernate-orm."persistence-unit-name".reactive.enabled+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm."persistence-unit-name".reactive.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HIBERNATE_ORM_REACTIVE_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HIBERNATE_ORM_REACTIVE_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|
...
Mutually exclusive with `maximum-weight`.
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-cache-cache-memory-maximum-weight]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-cache-cache-memory-maximum-weight[`+++quarkus.hibernate-orm.cache."cache".memory.maximum-weight+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm.cache."cache".memory.maximum-weight+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.hibernate-orm."persistence-unit-name".cache."cache".memory.maximum-weight+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm."persistence-unit-name".cache."cache".memory.maximum-weight+++[]
endif::add-copy-button-to-config-props[]
...
When set, eviction is based on the total weight of cached entries rather than their count. This is useful for entities with highly variable sizes (e.g., JSON blobs).

Mutually exclusive with `object-count`. Requires a `weigher-class` to assign weights to entries; without one, each entry has a default weight of 1.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HIBERNATE_ORM_CACHE__CACHE__MEMORY_MAXIMUM_WEIGHT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HIBERNATE_ORM_CACHE__CACHE__MEMORY_MAXIMUM_WEIGHT+++`
endif::add-copy-button-to-env-var[]
--
|long
|

a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus-hibernate-orm-cache-cache-memory-weigher-class]] [.property-path]##link:#quarkus-hibernate-orm_quarkus-hibernate-orm-cache-cache-memory-weigher-class[`+++quarkus.hibernate-orm.cache."cache".memory.weigher-class+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm.cache."cache".memory.weigher-class+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.hibernate-orm."persistence-unit-name".cache."cache".memory.weigher-class+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.hibernate-orm."persistence-unit-name".cache."cache".memory.weigher-class+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The fully qualified class name of a `com.github.benmanes.caffeine.cache.Weigher` implementation used to assign weights to cache entries.

Only used when `maximum-weight` is set. The class must have a public no-arg constructor.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HIBERNATE_ORM_CACHE__CACHE__MEMORY_WEIGHER_CLASS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HIBERNATE_ORM_CACHE__CACHE__MEMORY_WEIGHER_CLASS+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
--
a|tooltip:manual[The `org.hibernate.Session` is only flushed when `org.hibernate.Session#flush()` is called explicitly. This mode is very efficient for read-only transactions.], tooltip:commit[The `org.hibernate.Session` is flushed when `org.hibernate.Transaction#commit()` is called. It is never automatically flushed before query execution.], tooltip:auto[The `org.hibernate.Session` is flushed when `org.hibernate.Transaction#commit()` is called, and is sometimes flushed before query execution in order to ensure that queries never return stale state. This is the default flush mode.], tooltip:always[The `org.hibernate.Session` is flushed when `org.hibernate.Transaction#commit()` is called and before every query. This is usually unnecessary and inefficient.]
|tooltip:auto[The `org.hibernate.Session` is flushed when `org.hibernate.Transaction#commit()` is called, and is sometimes flushed before query execution in order to ensure that queries never return stale state. This is the default flush mode.]

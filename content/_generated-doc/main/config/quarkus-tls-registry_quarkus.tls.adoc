...
a| [[quarkus-tls-registry_quarkus-tls-key-store-other-type]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-type[`+++quarkus.tls.key-store.other.type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.type+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The key store type, passed to `java.security.KeyStore.getInstance(type)`.

This value also serves as the lookup key for a `KeyStoreFactory` CDI bean via `@Identifier`. If a matching factory is found, it takes priority over the standard file-based loading.

Examples: `BCFKS`, `PKCS11`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-provider]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-provider[`+++quarkus.tls.key-store.other.provider+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.provider+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The Java security provider name, passed to `java.security.KeyStore.getInstance(type, provider)`.

Used by the standard fallback loading. If not set, the default provider for the given type is used. A factory may also read this value but is not required to.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_PROVIDER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_PROVIDER+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-path]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-path[`+++quarkus.tls.key-store.other.path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.path+++[]
endif::add-copy-button-to-config-props[]
...
Required when using the standard fallback (no factory). When a factory handles the loading, this value is available to the factory via this config but is not used by the TLS registry itself.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_PATH+++`
endif::add-copy-button-to-env-var[]
--
|path
|

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-password[`+++quarkus.tls.key-store.other.password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.password+++[]
endif::add-copy-button-to-config-props[]
...
Used by the standard fallback to load the store. A factory may also read this value. When not set, the password can be retrieved from the credential provider configured on the parent key store.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-alias]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-alias[`+++quarkus.tls.key-store.other.alias+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.alias+++[]
endif::add-copy-button-to-config-props[]
...
Used by the standard fallback to select and validate a specific entry. A factory may also read this value but is not required to.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_ALIAS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_ALIAS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-alias-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-alias-password[`+++quarkus.tls.key-store.other.alias-password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.alias-password+++[]
endif::add-copy-button-to-config-props[]
...
Used by the standard fallback to verify the private key is recoverable. When not set, the password can be retrieved from the credential provider configured on the parent key store.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_ALIAS_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_ALIAS_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-key-store-other-params-params]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-store-other-params-params[`+++quarkus.tls.key-store.other.params."params"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-store.other.params."params"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Arbitrary parameters available to a `KeyStoreFactory` CDI bean via `config.params()`.

Ignored by the standard fallback. Set via `quarkus.tls.key-store.other.params.<key>=<value>`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_STORE_OTHER_PARAMS__PARAMS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_STORE_OTHER_PARAMS__PARAMS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
...
a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-type]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-type[`+++quarkus.tls.trust-store.other.type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.type+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The trust store type, passed to `java.security.KeyStore.getInstance(type)`.

This value also serves as the lookup key for a `TrustStoreFactory` CDI bean via `@Identifier`. If a matching factory is found, it takes priority over the standard file-based loading.

Examples: `BCFKS`, `PKCS11`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-provider]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-provider[`+++quarkus.tls.trust-store.other.provider+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.provider+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_PROVIDER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_PROVIDER+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-path]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-path[`+++quarkus.tls.trust-store.other.path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_PATH+++`
endif::add-copy-button-to-env-var[]
--
|path
|

a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-password[`+++quarkus.tls.trust-store.other.password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.password+++[]
endif::add-copy-button-to-config-props[]
...
Used by the standard fallback to load the store. A factory may also read this value. When not set, the password can be retrieved from the credential provider configured on the parent trust store.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-alias]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-alias[`+++quarkus.tls.trust-store.other.alias+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.alias+++[]
endif::add-copy-button-to-config-props[]
...
Used by the standard fallback to validate that a specific certificate exists. A factory may also read this value but is not required to.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_ALIAS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_ALIAS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-trust-store-other-params-params]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-trust-store-other-params-params[`+++quarkus.tls.trust-store.other.params."params"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.trust-store.other.params."params"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Arbitrary parameters available to a `TrustStoreFactory` CDI bean via `config.params()`.

Ignored by the standard fallback. Set via `quarkus.tls.trust-store.other.params.<key>=<value>`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_TRUST_STORE_OTHER_PARAMS__PARAMS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_TRUST_STORE_OTHER_PARAMS__PARAMS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
...
a| [[quarkus-tls-registry_quarkus-tls-pqc-enforcement-policy]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-pqc-enforcement-policy[`+++quarkus.tls.pqc-enforcement-policy+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.pqc-enforcement-policy+++[]
endif::add-copy-button-to-config-props[]
...
`STRICT`: a connection will be refused unless both the client and the server support a PQC-capable group (`X25519MLKEM768`, `SecP256r1MLKEM768`, `SecP384r1MLKEM1024`). The server requires PQC-capable clients.

`CLIENT_NEGOTIATED`: the server advertises PQC groups but will not refuse a connection if the client does not support them, allowing fallback to classical key exchange.

`RELAXED`: no PQC enforcement; standard TLS key exchange negotiation applies.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_PQC_ENFORCEMENT_POLICY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_PQC_ENFORCEMENT_POLICY+++`
endif::add-copy-button-to-env-var[]
--
a|tooltip:strict[A connection is refused unless both the client and the server negotiate a PQC key exchange (`X25519MLKEM768`, `SecP256r1MLKEM768`, `SecP384r1MLKEM1024`). Clients that do not advertise PQC support are rejected during the TLS handshake.], tooltip:client-negotiated[The server advertises PQC key exchange groups but does not require the client to support them. If the client does not support PQC, the handshake falls back to classical key exchange.], tooltip:relaxed[No PQC enforcement; standard TLS key exchange negotiation applies. The server neither advertises nor requires PQC groups.]
|tooltip:relaxed[No PQC enforcement; standard TLS key exchange negotiation applies. The server neither advertises nor requires PQC groups.]

a| [[quarkus-tls-registry_quarkus-tls-key-exchange-groups]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-key-exchange-groups[`+++quarkus.tls.key-exchange-groups+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.key-exchange-groups+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Sets the ordered list of enabled TLS key exchange groups (supported groups). If not set, the default groups defined by the `SSLEngineOptions` in use are used.

Example values: `X25519MLKEM768`, `X25519`, `P-256`. When set, these groups take precedence over the engine defaults.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_KEY_EXCHANGE_GROUPS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_KEY_EXCHANGE_GROUPS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|

a| [[quarkus-tls-registry_quarkus-tls-ssl-engine]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-ssl-engine[`+++quarkus.tls.ssl-engine+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls.ssl-engine+++[]
endif::add-copy-button-to-config-props[]
...
When not set, Vert.x selects the engine automatically: if `pqc-enforcement-policy` is `strict` or `client-negotiated`, it prefers the JDK engine (JDK 27{plus}) or falls back to OpenSSL. For `relaxed` policy it uses the JDK engine by default.

Use `OPENSSL` to force netty-tcnative (requires the native library on the classpath). Use `JDKSSL` to force the standard JDK SSL engine.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS_SSL_ENGINE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS_SSL_ENGINE+++`
endif::add-copy-button-to-env-var[]
--
a|tooltip:openssl[Use the OpenSSL engine, requires netty-tcnative.], tooltip:jdkssl[Use the default JDK SSL engine.]
|
...
a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-type]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-type[`+++quarkus.tls."tls-bucket-name".key-store.other.type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-provider]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-provider[`+++quarkus.tls."tls-bucket-name".key-store.other.provider+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.provider+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PROVIDER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PROVIDER+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-path]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-path[`+++quarkus.tls."tls-bucket-name".key-store.other.path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PATH+++`
endif::add-copy-button-to-env-var[]
--
|path
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-password[`+++quarkus.tls."tls-bucket-name".key-store.other.password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.password+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-alias]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-alias[`+++quarkus.tls."tls-bucket-name".key-store.other.alias+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.alias+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_ALIAS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_ALIAS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-alias-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-alias-password[`+++quarkus.tls."tls-bucket-name".key-store.other.alias-password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.alias-password+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_ALIAS_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_ALIAS_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-params-params]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-store-other-params-params[`+++quarkus.tls."tls-bucket-name".key-store.other.params."params"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-store.other.params."params"+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PARAMS__PARAMS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_STORE_OTHER_PARAMS__PARAMS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
...
a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-type]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-type[`+++quarkus.tls."tls-bucket-name".trust-store.other.type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-provider]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-provider[`+++quarkus.tls."tls-bucket-name".trust-store.other.provider+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.provider+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PROVIDER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PROVIDER+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-path]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-path[`+++quarkus.tls."tls-bucket-name".trust-store.other.path+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PATH+++`
endif::add-copy-button-to-env-var[]
--
|path
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-password]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-password[`+++quarkus.tls."tls-bucket-name".trust-store.other.password+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.password+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PASSWORD+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PASSWORD+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-alias]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-alias[`+++quarkus.tls."tls-bucket-name".trust-store.other.alias+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.alias+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_ALIAS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_ALIAS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-params-params]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-trust-store-other-params-params[`+++quarkus.tls."tls-bucket-name".trust-store.other.params."params"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".trust-store.other.params."params"+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PARAMS__PARAMS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__TRUST_STORE_OTHER_PARAMS__PARAMS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
...
a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-pqc-enforcement-policy]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-pqc-enforcement-policy[`+++quarkus.tls."tls-bucket-name".pqc-enforcement-policy+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".pqc-enforcement-policy+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__PQC_ENFORCEMENT_POLICY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__PQC_ENFORCEMENT_POLICY+++`
endif::add-copy-button-to-env-var[]
--
a|tooltip:strict[A connection is refused unless both the client and the server negotiate a PQC key exchange (`X25519MLKEM768`, `SecP256r1MLKEM768`, `SecP384r1MLKEM1024`). Clients that do not advertise PQC support are rejected during the TLS handshake.], tooltip:client-negotiated[The server advertises PQC key exchange groups but does not require the client to support them. If the client does not support PQC, the handshake falls back to classical key exchange.], tooltip:relaxed[No PQC enforcement; standard TLS key exchange negotiation applies. The server neither advertises nor requires PQC groups.]
|tooltip:relaxed[No PQC enforcement; standard TLS key exchange negotiation applies. The server neither advertises nor requires PQC groups.]

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-exchange-groups]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-key-exchange-groups[`+++quarkus.tls."tls-bucket-name".key-exchange-groups+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".key-exchange-groups+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_EXCHANGE_GROUPS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__KEY_EXCHANGE_GROUPS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|

a| [[quarkus-tls-registry_quarkus-tls-tls-bucket-name-ssl-engine]] [.property-path]##link:#quarkus-tls-registry_quarkus-tls-tls-bucket-name-ssl-engine[`+++quarkus.tls."tls-bucket-name".ssl-engine+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.tls."tls-bucket-name".ssl-engine+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TLS__TLS_BUCKET_NAME__SSL_ENGINE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TLS__TLS_BUCKET_NAME__SSL_ENGINE+++`
endif::add-copy-button-to-env-var[]
--
a|tooltip:openssl[Use the OpenSSL engine, requires netty-tcnative.], tooltip:jdkssl[Use the default JDK SSL engine.]
|

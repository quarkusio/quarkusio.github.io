...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-exclude-dependency-dependency-name-type]] [.property-path]##link:#quarkus-arc_quarkus-arc-exclude-dependency-dependency-name-type[`+++quarkus.arc.exclude-dependency."dependency-name".type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.arc.exclude-dependency."dependency-name".type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ARC_EXCLUDE_DEPENDENCY__DEPENDENCY_NAME__TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ARC_EXCLUDE_DEPENDENCY__DEPENDENCY_NAME__TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++jar+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-async-handler-async-type]] [.property-path]##link:#quarkus-arc_quarkus-arc-async-handler-async-type[`+++quarkus.arc.async-handler."async-type"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.arc.async-handler."async-type"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Configuration of `jakarta.enterprise.invoke.AsyncHandler AsyncHandler`s when multiple async handlers for the same async type exist. Can also be used to override a built-in async handler for the built-in async types.

The key is a fully qualified name of the async type, and the value is a fully qualified name of the async handler. For example:
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ARC_ASYNC_HANDLER__ASYNC_TYPE_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ARC_ASYNC_HANDLER__ASYNC_TYPE_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|

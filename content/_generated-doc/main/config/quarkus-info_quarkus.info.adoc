...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-build-quarkus-version]] [.property-path]##link:#quarkus-info_quarkus-info-build-quarkus-version[`+++quarkus.info.build.quarkus-version+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.info.build.quarkus-version+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INFO_BUILD_QUARKUS_VERSION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INFO_BUILD_QUARKUS_VERSION+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

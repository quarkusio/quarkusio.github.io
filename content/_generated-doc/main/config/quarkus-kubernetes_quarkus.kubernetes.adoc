...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-default-mode]] [.property-path]##link:#quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-default-mode[[.line-through]#`+++quarkus.kubernetes.pvc-volumes."pvc-volumes".default-mode+++`#]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-optional]] [.property-path]##link:#quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-optional[[.line-through]#`+++quarkus.kubernetes.pvc-volumes."pvc-volumes".optional+++`#]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-read-only]] [.property-path]##link:#quarkus-kubernetes_quarkus-kubernetes-pvc-volumes-pvc-volumes-read-only[`+++quarkus.kubernetes.pvc-volumes."pvc-volumes".read-only+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.kubernetes.pvc-volumes."pvc-volumes".read-only+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KUBERNETES_PVC_VOLUMES__PVC_VOLUMES__READ_ONLY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KUBERNETES_PVC_VOLUMES__PVC_VOLUMES__READ_ONLY+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-kubernetes-security-context-allow-privilege-escalation]] [.property-path]##link:#quarkus-kubernetes_quarkus-kubernetes-security-context-allow-privilege-escalation[`+++quarkus.kubernetes.security-context.allow-privilege-escalation+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.kubernetes.security-context.allow-privilege-escalation+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KUBERNETES_SECURITY_CONTEXT_ALLOW_PRIVILEGE_ESCALATION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KUBERNETES_SECURITY_CONTEXT_ALLOW_PRIVILEGE_ESCALATION+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-kubernetes-security-context-read-only-root-filesystem]] [.property-path]##link:#quarkus-kubernetes_quarkus-kubernetes-security-context-read-only-root-filesystem[`+++quarkus.kubernetes.security-context.read-only-root-filesystem+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.kubernetes.security-context.read-only-root-filesystem+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KUBERNETES_SECURITY_CONTEXT_READ_ONLY_ROOT_FILESYSTEM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KUBERNETES_SECURITY_CONTEXT_READ_ONLY_ROOT_FILESYSTEM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

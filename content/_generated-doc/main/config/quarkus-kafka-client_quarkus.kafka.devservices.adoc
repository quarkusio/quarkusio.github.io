...
For Upstream Kafka: See https://hub.docker.com/r/apache/kafka and https://hub.docker.com/r/apache/kafka-native
...
--
a|`redpanda`, `strimzi`, `kafka-native`, `upstream-kafka`, `upstream-kafka-native`
|`+++upstream-kafka-native+++`

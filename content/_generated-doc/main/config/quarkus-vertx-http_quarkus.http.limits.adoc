...
a| [[quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-query-parameters]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-query-parameters[`+++quarkus.http.limits.max-query-parameters+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.limits.max-query-parameters+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_LIMITS_MAX_QUERY_PARAMETERS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HTTP_LIMITS_MAX_QUERY_PARAMETERS+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++1024+++`

a| [[quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-multipart-part-header-size]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-multipart-part-header-size[`+++quarkus.http.limits.max-multipart-part-header-size+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.limits.max-multipart-part-header-size+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_LIMITS_MAX_MULTIPART_PART_HEADER_SIZE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HTTP_LIMITS_MAX_MULTIPART_PART_HEADER_SIZE+++`
endif::add-copy-button-to-env-var[]
--
|MemorySize link:#memory-size-note-anchor-quarkus-vertx-http_quarkus-http-limits[icon:question-circle[title=More information about the MemorySize format]]
|`+++32K+++`

a| [[quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-multipart-header-count]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-limits_quarkus-http-limits-max-multipart-header-count[`+++quarkus.http.limits.max-multipart-header-count+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.limits.max-multipart-header-count+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_LIMITS_MAX_MULTIPART_HEADER_COUNT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HTTP_LIMITS_MAX_MULTIPART_HEADER_COUNT+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++40+++`

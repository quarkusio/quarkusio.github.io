...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-db-version-defaults]] [.property-path]##link:#quarkus-datasource_quarkus-datasource-db-version-defaults[`+++quarkus.datasource.db-version-defaults+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.datasource.db-version-defaults+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_DATASOURCE_DB_VERSION_DEFAULTS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]

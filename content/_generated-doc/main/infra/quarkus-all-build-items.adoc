...
This does not include extension `io.smallrye.config.ConfigMapping` classes annotated with
`io.quarkus.runtime.annotations.ConfigRoot`, which are handled separately by the core configuration
processor.
-- a|`ClassInfo configClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ConfigMappingsRegistrarBuildItem.java[`io.quarkus.deployment.builditem.ConfigMappingsRegistrarBuildItem`, window="_blank"]
[.description]
--
The `io.smallrye.config.ConfigMapping` classes that must be registered with
`io.smallrye.config.SmallRyeConfig`.


While `ConfigMappingBuildItem` represents each discovered `io.smallrye.config.ConfigMapping` class,
this build item collects only the config mappings with active injection points (or marked as unremovable),
expanding all prefix overrides for the same config class, since `io.smallrye.config.SmallRyeConfig` requires
...
-- a|`Map<String,Set<String>> configMappings` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ConfigPropertiesRegistrarBuildItem.java[`io.quarkus.deployment.builditem.ConfigPropertiesRegistrarBuildItem`, window="_blank"]
[.description]
--
The `org.eclipse.microprofile.config.inject.ConfigProperties` that must be registered with
`io.smallrye.config.SmallRyeConfig`.


While `ConfigPropertiesBuildItem` represents each discovered
`org.eclipse.microprofile.config.inject.ConfigProperties` class, this build item collects only the config
properties with active injection points (or marked as unremovable), expanding all prefix overrides for the same
config class, since `io.smallrye.config.SmallRyeConfig` requires a separate registration for each class and
prefix combination.
...
-- a|`Map<String,Set<String>> configProperties` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/CuratedApplicationContextBuildItem.java[`io.quarkus.deployment.builditem.CuratedApplicationContextBuildItem`, window="_blank"]
[.description]
--
A build item that provides a per-`io.quarkus.bootstrap.app.CuratedApplication` context map.


Unlike `LiveReloadBuildItem`, whose context is scoped to a single
`AugmentActionImpl` (and thus reset when a new one is created),
this context survives across `AugmentActionImpl` instances for
the lifetime of the `CuratedApplication`.


Use this for state that must persist across continuous testing restarts
but be isolated between different `CuratedApplication` instances.
-- a|`Map<Class<?>,Object> curatedApplicationContext` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/GeneratedConfigClassBuildItem.java[`io.quarkus.deployment.builditem.GeneratedConfigClassBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
-- a|`Class<?> configClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/GeneratedServiceProviderBuildItem.java[`io.quarkus.deployment.builditem.GeneratedServiceProviderBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/nativeimage/LambdaReflectionBuildItem.java[`io.quarkus.deployment.builditem.nativeimage.LambdaReflectionBuildItem`, window="_blank"]
[.description]
--
...
@formatter:off
https://github.com/oracle/graal/issues/13665[Lambda deserialization ergonomics,window=_blank]
https://www.graalvm.org/latest/reference-manual/native-image/metadata/#specifying-metadata-with-json[JSON metadata,window=_blank]
https://github.com/graalvm/graalvm-community-jdk25u/blob/master/docs/reference-manual/native-image/assets/reachability-metadata-schema-v1.2.0.json[reachability-metadata.json schema,window=_blank]
@formatter:on
-- a|`String declaringClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ModuleExportBuildItem.java[`io.quarkus.deployment.builditem.ModuleExportBuildItem`, window="_blank"]
[.description]
--
...
* Use `NativeImageResourcePatternsBuildItem` to select resource paths by globs
...
Globs passed to the `includeGlob*()` methods of the `Builder` are passed directly
to the native image builder. See `NativeConfig.ResourcesConfig#includes` for the supported glob syntax.


The globs are passed to the native image builder using `reachability-metadata.json`
(conforming to `reachability-metadata-schema-v1.2.0.json`).
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/OpenTelemetrySdkBuildItem.java[`io.quarkus.deployment.builditem.OpenTelemetrySdkBuildItem`, window="_blank"]
[.description]
--
...
it as an `Optional` so they still work when the OpenTelemetry extension is not on the
classpath.
...
`quarkus.otel.enabled` flag are `true`.
...
The convenience method `#isOtelSdkEnabled(Optional)` extracts the runtime-enabled
`RuntimeValue` when the build item is present:
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ReproducibilityCheckBuildItem.java[`io.quarkus.deployment.builditem.ReproducibilityCheckBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/RuntimeClassTransformerBuildItem.java[`io.quarkus.deployment.builditem.RuntimeClassTransformerBuildItem`, window="_blank"]
[.description]
--
...
-- a|`ClassTransformer transformer` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/sbom/SbomGeneratedResourceBuildItem.java[`io.quarkus.deployment.sbom.SbomGeneratedResourceBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/aesh/deployment/src/main/java/io/quarkus/aesh/deployment/AeshCommandBuildItem.java[`io.quarkus.aesh.deployment.AeshCommandBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/aesh/deployment/src/main/java/io/quarkus/aesh/deployment/AeshModeBuildItem.java[`io.quarkus.aesh.deployment.AeshModeBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/aesh/deployment/src/main/java/io/quarkus/aesh/deployment/AeshRemoteTransportBuildItem.java[`io.quarkus.aesh.deployment.AeshRemoteTransportBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/agroal/deployment/src/main/java/io/quarkus/agroal/deployment/JdbcDataSourceDefinitionBuildItem.java[`io.quarkus.agroal.deployment.JdbcDataSourceDefinitionBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/amazon-lambda/common-deployment/src/main/java/io/quarkus/amazon/lambda/deployment/EventServerPortOverrideBuildItem.java[`io.quarkus.amazon.lambda.deployment.EventServerPortOverrideBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/arc/deployment/src/main/java/io/quarkus/arc/deployment/SuppressConditionGeneratorBuildItem.java[`io.quarkus.arc.deployment.SuppressConditionGeneratorBuildItem`, window="_blank"]
[.description]
--
...
Suppressed beans cannot be obtained by programmatic lookup via `jakarta.enterprise.inject.Instance` and
`io.quarkus.arc.All`.
...
All generators are executed in sequence to generate the `isSuppressed` method body. If a generator decides that the
bean should be suppressed, it should call `io.quarkus.gizmo2.creator.BlockCreator#returnTrue()`. If no generator
returns `true`, the bean is not suppressed and the `isSuppressed` method returns `false`. It is expected
that a generator only returns from the
`isSuppressed` method when it returns `true`. In such case,
suppress conditions are composed naturally: if one suppress condition is satisfied, the bean is suppressed.
A generator may decide to short-circuit this process and return `false`, but note that there is no ordering between
...
The built-in `io.quarkus.arc.lookup.LookupIfProperty` and `io.quarkus.arc.lookup.LookupUnlessProperty`
...
-- a|`Consumer<BeanGenerator.SuppressConditionGeneration> generator` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/avro/spi/src/main/java/io/quarkus/avro/spi/AvroTrustedClassBuildItem.java[`io.quarkus.avro.spi.AvroTrustedClassBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/cyclonedx/deployment-spi/src/main/java/io/quarkus/cyclonedx/deployment/spi/EmbeddedSbomMetadataBuildItem.java[`io.quarkus.cyclonedx.deployment.spi.EmbeddedSbomMetadataBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/cyclonedx/deployment-spi/src/main/java/io/quarkus/cyclonedx/deployment/spi/EmbeddedSbomRequestBuildItem.java[`io.quarkus.cyclonedx.deployment.spi.EmbeddedSbomRequestBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/DataSourceDbKindResolverBuildItem.java[`io.quarkus.datasource.deployment.spi.DataSourceDbKindResolverBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/DataSourceDefinedBuildItem.java[`io.quarkus.datasource.deployment.spi.DataSourceDefinedBuildItem`, window="_blank"]
[.description]
--
...
Produced from `io.quarkus.datasource.deployment.spi.component.DataSourceDefinitionBuildItem` instances.
-- a|`String name` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/component/DataSourceDefinitionBuildItem.java[`io.quarkus.datasource.deployment.spi.component.DataSourceDefinitionBuildItem`, window="_blank"]
[.description]
--
...
Consumed by `io.quarkus.datasource.deployment.spi.DataSourceDefinedBuildItem DataSourceDefinedBuildItem`,
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/DataSourceFeatureRequirementBuildItem.java[`io.quarkus.datasource.deployment.spi.DataSourceFeatureRequirementBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/component/DataSourceLookupBuildItem.java[`io.quarkus.datasource.deployment.spi.component.DataSourceLookupBuildItem`, window="_blank"]
[.description]
--
Represents a queryable source of information regarding
which datasource can reasonably be `DataSourceRequestBuildItem requested`.


Extensions can consume this build item early on (before `DataSourceRequestBuildItem` is processed)
...
-- a|`ComponentLookup aggregatedLookup` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/component/DataSourceRequestBuildItem.java[`io.quarkus.datasource.deployment.spi.component.DataSourceRequestBuildItem`, window="_blank"]
[.description]
--
...
Acknowledged requests will yield a `DataSourceDefinedBuildItem` later on.
-- a|`String name` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/component/DataSourceRequestHandlerBuildItem.java[`io.quarkus.datasource.deployment.spi.component.DataSourceRequestHandlerBuildItem`, window="_blank"]
[.description]
--
Declares an extension can handle `DataSourceRequestBuildItem`,
and provides in particular a `ComponentLookup` to check for unavailable datasources,
so that other extensions can check what can be requested.


Should not be consumed except by the "common" datasource extension;
other extensions should consume `DataSourceLookupBuildItem`.
-- a|`ProgrammingParadigm paradigm` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/datasource/deployment-spi/src/main/java/io/quarkus/datasource/deployment/spi/DefaultDataSourceDbVersionBuildItem.java[`io.quarkus.datasource.deployment.spi.DefaultDataSourceDbVersionBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devjsonrpc/deployment/src/main/java/io/quarkus/devjsonrpc/deployment/DeploymentMethodBuildItem.java[`io.quarkus.devjsonrpc.deployment.DeploymentMethodBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devjsonrpc/deployment/src/main/java/io/quarkus/devjsonrpc/deployment/JsonRPCRuntimeMethodsBuildItem.java[`io.quarkus.devjsonrpc.deployment.JsonRPCRuntimeMethodsBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devjsonrpc/deployment/src/main/java/io/quarkus/devjsonrpc/deployment/JsonRpcCodecCustomizerBuildItem.java[`io.quarkus.devjsonrpc.deployment.JsonRpcCodecCustomizerBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
-- a|`Consumer<JsonMapper.Builder> customizer` 
...
a|icon:building[title=Non-instantiatable Build Item (can be inherited from)] https://github.com/quarkusio/quarkus/blob/main/extensions/devjsonrpc/deployment-spi/src/main/java/io/quarkus/devjsonrpc/spi/AbstractDevBuildItem.java[`io.quarkus.devjsonrpc.spi.AbstractDevBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devjsonrpc/deployment-spi/src/main/java/io/quarkus/devjsonrpc/spi/JsonRPCProvidersBuildItem.java[`io.quarkus.devjsonrpc.spi.JsonRPCProvidersBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devservices/datasource-common/src/main/java/io/quarkus/devservices/datasource/common/DevServicesDatasourceConfigurationHandlerBuildItem.java[`io.quarkus.devservices.datasource.common.DevServicesDatasourceConfigurationHandlerBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devservices/datasource-common/src/main/java/io/quarkus/devservices/datasource/common/DevServicesDatasourceProviderBuildItem.java[`io.quarkus.devservices.datasource.common.DevServicesDatasourceProviderBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devservices/datasource-common/src/main/java/io/quarkus/devservices/datasource/common/DevServicesDatasourceResultBuildItem.java[`io.quarkus.devservices.datasource.common.DevServicesDatasourceResultBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment/src/main/java/io/quarkus/hibernate/orm/deployment/model/JpaModelIndexBuildItem.java[`io.quarkus.hibernate.orm.deployment.model.JpaModelIndexBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment/src/main/java/io/quarkus/hibernate/orm/deployment/JpaModelPerPersistenceUnitBuildItem.java[`io.quarkus.hibernate.orm.deployment.JpaModelPerPersistenceUnitBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment/src/main/java/io/quarkus/hibernate/orm/deployment/model/JpaModelPersistenceUnitContributionBuildItem.java[`io.quarkus.hibernate.orm.deployment.model.JpaModelPersistenceUnitContributionBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment/src/main/java/io/quarkus/hibernate/orm/deployment/component/PersistenceUnitDefinitionBuildItem.java[`io.quarkus.hibernate.orm.deployment.component.PersistenceUnitDefinitionBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/AdditionalPersistenceUnitBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.AdditionalPersistenceUnitBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/HibernateOrmIntegrationRuntimeConfiguredBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.HibernateOrmIntegrationRuntimeConfiguredBuildItem`, window="_blank"]
[.description]
--
...
`HibernateOrmIntegrationRuntimeInitListener` to contribute runtime properties
and service initiators.


Consumed during the `RUNTIME_INIT` build step that sets up the persistence provider
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/HibernateOrmIntegrationStaticConfiguredBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.HibernateOrmIntegrationStaticConfiguredBuildItem`, window="_blank"]
[.description]
--
...
Each item targets a specific persistence unit and may carry a
`HibernateOrmIntegrationStaticInitListener` to contribute boot properties
and react to metadata initialization.


Consumed during the `STATIC_INIT` build step that builds
`QuarkusPersistenceUnitDefinition`s and records metadata initialization.
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/JpaModelPersistenceUnitMappingBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.JpaModelPersistenceUnitMappingBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/PersistenceUnitDefinedBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.PersistenceUnitDefinedBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/component/PersistenceUnitLookupBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.component.PersistenceUnitLookupBuildItem`, window="_blank"]
[.description]
--
Provides a `ComponentLookup lookup` to determine
if a persistence unit can reasonably be `PersistenceUnitRequestBuildItem requested`.


Extensions can consume this build item early on (before `PersistenceUnitRequestBuildItem` is processed)
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/component/PersistenceUnitRequestBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.component.PersistenceUnitRequestBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/http3/deployment-spi/src/main/java/io/quarkus/http3/deployment/spi/Http3EnabledBuildItem.java[`io.quarkus.http3.deployment.spi.Http3EnabledBuildItem`, window="_blank"]
[.description]
--
...
Consumed optionally by `vertx-http` to configure HTTP/3 on the server.
-- a|None
|===
== Infinispan - Client
[.configuration-reference,cols=2*]
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/packaging/jlink/spi/src/main/java/io/quarkus/jlink/spi/JLinkImageBuildItem.java[`io.quarkus.jlink.spi.JLinkImageBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/smallrye-reactive-messaging/deployment/src/main/java/io/quarkus/smallrye/reactivemessaging/deployment/items/CustomInvokerBuildItem.java[`io.quarkus.smallrye.reactivemessaging.deployment.items.CustomInvokerBuildItem`, window="_blank"]
[.description]
--
...
All override fields are nullable — when `null`, the default configuration from
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/packaging/modular/spi/src/main/java/io/quarkus/modular/spi/items/AddDependencyBuildItem.java[`io.quarkus.modular.spi.items.AddDependencyBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/packaging/modular/spi/src/main/java/io/quarkus/modular/spi/items/ApplicationModuleInfoBuildItem.java[`io.quarkus.modular.spi.items.ApplicationModuleInfoBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/packaging/modular/spi/src/main/java/io/quarkus/modular/spi/items/BootModulePathBuildItem.java[`io.quarkus.modular.spi.items.BootModulePathBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/opentelemetry/deployment/src/main/java/io/quarkus/opentelemetry/deployment/logging/OpenTelemetryLogHandlerBuildItem.java[`io.quarkus.opentelemetry.deployment.logging.OpenTelemetryLogHandlerBuildItem`, window="_blank"]
[.description]
--
...
-- a|`RuntimeValue<Optional<Handler>> handler` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/data/hibernate/deployment/src/main/java/io/quarkus/data/hibernate/deployment/EntityToPersistenceUnitBuildItem.java[`io.quarkus.data.hibernate.deployment.EntityToPersistenceUnitBuildItem`, window="_blank"]
[.description]
--
Used to record that a specific JPA entity is associated with a specific persistence unit
-- a|`String entityClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/data/hibernate/deployment/src/main/java/io/quarkus/data/hibernate/deployment/QuarkusDataEntityClassBuildItem.java[`io.quarkus.data.hibernate.deployment.QuarkusDataEntityClassBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/reactive-datasource/deployment/src/main/java/io/quarkus/reactive/datasource/deployment/ReactiveDataSourceDefinitionBuildItem.java[`io.quarkus.reactive.datasource.deployment.ReactiveDataSourceDefinitionBuildItem`, window="_blank"]
[.description]
--
The first build item created after the decision was taken to define a datasource.
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/reactive-datasource/deployment-spi/src/main/java/io/quarkus/reactive/datasource/spi/ReactiveDataSourceBuildItem.java[`io.quarkus.reactive.datasource.spi.ReactiveDataSourceBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/reactive-datasource/deployment-spi/src/main/java/io/quarkus/reactive/datasource/spi/ReactivePoolBuildItem.java[`io.quarkus.reactive.datasource.spi.ReactivePoolBuildItem`, window="_blank"]
[.description]
--
...
synthetic CDI beans (`Pool`, Mutiny Pool) and health checks.
-- a|`String dataSourceName` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/resteasy-reactive/rest/spi-deployment/src/main/java/io/quarkus/resteasy/reactive/server/spi/KnownServerRestHandlerBuildItem.java[`io.quarkus.resteasy.reactive.server.spi.KnownServerRestHandlerBuildItem`, window="_blank"]
[.description]
--
A build item that allows extensions to register the `org.jboss.resteasy.reactive.server.spi.ServerRestHandler`
classes they add to handler chains (via `GlobalHandlerCustomizerBuildItem`, `MethodScannerBuildItem`
or `PreExceptionMapperHandlerBuildItem`).
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/resteasy-reactive/rest/spi-deployment/src/main/java/io/quarkus/resteasy/reactive/server/spi/ResponseTypeUnwrapperBuildItem.java[`io.quarkus.resteasy.reactive.server.spi.ResponseTypeUnwrapperBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/security/spi/src/main/java/io/quarkus/security/spi/SecuredTopLevelInterfaceBuildItem.java[`io.quarkus.security.spi.SecuredTopLevelInterfaceBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/smallrye-openapi/deployment/src/main/java/io/quarkus/smallrye/openapi/deployment/DocumentFiltersBuildItem.java[`io.quarkus.smallrye.openapi.deployment.DocumentFiltersBuildItem`, window="_blank"]
[.description]
--
Internal build item of the smallrye-openapi extension, providing the resolved filterNames combined with their
`io.quarkus.smallrye.openapi.OpenApiFilter.RunStage` and documentName information.
Only produced by
`SmallRyeOpenApiFiltersProcessor#produceFilters(SmallRyeOpenApiConfig, OpenApiFilteredIndexViewBuildItem)`
-- a|`Map<String,Map<OpenApiFilter.RunStage,List<String>>> filterNames` 
...
-- a|`SmallRyeOpenAPI smallRyeOpenAPI` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vertx-http/deployment-spi/src/main/java/io/quarkus/vertx/http/deployment/spi/HttpServerStartedBuildItem.java[`io.quarkus.vertx.http.deployment.spi.HttpServerStartedBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vertx/deployment-spi/src/main/java/io/quarkus/vertx/deployment/spi/VertxBootstrapConsumerBuildItem.java[`io.quarkus.vertx.deployment.spi.VertxBootstrapConsumerBuildItem`, window="_blank"]
[.description]
--
...
Unlike `VertxOptionsConsumerBuildItem`, there is no runtime alternative. `VertxBootstrap` being an
internal API, only extensions can customize it, and they must do so at build time.
-- a|`Consumer<VertxBootstrap> consumer` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vertx/deployment-spi/src/main/java/io/quarkus/vertx/deployment/spi/VertxOptionsConsumerBuildItem.java[`io.quarkus.vertx.deployment.spi.VertxOptionsConsumerBuildItem`, window="_blank"]
[.description]
--
...
-- a|`Consumer<VertxOptions> consumer` 

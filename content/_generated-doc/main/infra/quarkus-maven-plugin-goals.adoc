...
= quarkus:build-enhanced-artifact

Builds enhanced artifacts from data generated by integration tests. Supports: 
* AOT-enhanced container images (from Leyden AOT training) 
* PGO-optimized native images (from GraalVM PGO profiling)

[.configuration-reference, cols="70,15,15"]
|===

h|[[quarkus-maven-plugin-goal-build-enhanced-artifact-parameter-table]] Parameter
h|Type
h|Default value

a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-appArtifact]] appArtifact
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-bootstrapId]] bootstrapId
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-buildDir]] buildDir
|`File`
|`${project.build.directory}`

a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-quarkusCloseBootstrappedApp]] quarkusCloseBootstrappedApp
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-finalName]] finalName
|`String`
|`${project.build.finalName}`

a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-ignoredEntries]] ignoredEntries
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-manifestEntries]] manifestEntries
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-manifestSections]] manifestSections
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-mojoExecution]] mojoExecution
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-project]] project
|`MavenProject` (required)
|`${project}`

a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-properties]] properties
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-reloadPoms]] reloadPoms
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-repoSession]] repoSession
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-repos]] repos
...
a| [[quarkus-maven-plugin-goal-build-enhanced-artifact-session]] session
|`MavenSession`
|`${session}`
...
a| [[quarkus-maven-plugin-goal-create-noBuildToolWrapper]] noBuildToolWrapper
...
a| [[quarkus-maven-plugin-goal-create-stream]] stream

[.description]
--
A target platform stream, for example: 3.15 or io.quarkus.platform:3.15. When specified, the extension registry client will be used to resolve the platform BOM corresponding to the given stream.
--
|`String`
|
...
a| [[quarkus-maven-plugin-goal-dependency-sbom-quarkus.dependency.sbom.include-quarkus-component-scope]] quarkus.dependency.sbom.include-quarkus-component-scope

[.description]
--
Whether to include the quarkus:component:scope custom property on each component. The default is false.
--
|`boolean`
|`false`
...
a| [[quarkus-maven-plugin-goal-dependency-sbom-quarkus.dependency.sbom.pretty-print]] quarkus.dependency.sbom.pretty-print

[.description]
--
Whether to pretty-print the generated SBOM output. The default is false
--
|`boolean`
|`false`

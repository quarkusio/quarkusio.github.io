...
:categories-path: web.web-rest,serialization.serialization-json
...
The solution is located in the `rest-json-quickstart` link:{quickstarts-tree-url}/rest-json-quickstart[directory].

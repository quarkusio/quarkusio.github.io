...
:categories-path: data.data-orm,execution-model.execution-model-reactive
...
You can then inject `Mutiny.Session` and use it in methods annotated with `@Transactional`:

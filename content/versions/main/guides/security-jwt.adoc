...
This extension generates an asymmetric RSA 2048-bit signing key pair in the dev and test modes if the verification key has not been configured.
...
See xref:security-jwt-build.adoc#sign-claims[signing claims guide] for more details.

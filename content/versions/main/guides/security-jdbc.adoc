...
The solution is located in the `security-jdbc-quickstart` link:{quickstarts-tree-url}/security-jdbc-quickstart[directory].
...
public class AccountService {
    ...
    public void signupUser(String username, char[] password) {

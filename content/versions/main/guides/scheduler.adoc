...
:categories-path: miscellaneous.miscellaneous-scheduling
...
The solution is located in the `scheduler-quickstart` link:{quickstarts-tree-url}/scheduler-quickstart[directory].

...
TIP: If you use a separate HTTP server to serve gRPC requests, <<custom-auth-mechanism>> is your only option.
...
Most of the examples of the supported mechanisms send authentication headers, please refer to the xref:grpc-service-consumption.adoc[gRPC Headers]

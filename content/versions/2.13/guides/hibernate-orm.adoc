...
:categories: data
:summary: Hibernate ORM is the de facto JPA implementation and offers you the full breath of an Object Relational Mapper. It works beautifully in Quarkus.
...
When using xref:microprofile-metrics.adoc[SmallRye Metrics], metrics will be available under the `vendor` scope.

...
a| [[quarkus-cache-redis-general-config-items_quarkus.cache.redis.expire-after-write]]`link:#quarkus-cache-redis-general-config-items_quarkus.cache.redis.expire-after-write[quarkus.cache.redis.expire-after-write]`
...
a| [[quarkus-cache-redis-general-config-items_quarkus.cache.redis.expire-after-access]]`link:#quarkus-cache-redis-general-config-items_quarkus.cache.redis.expire-after-access[quarkus.cache.redis.expire-after-access]`
...
a| [[quarkus-cache-redis-general-config-items_quarkus.cache.redis.-cache-name-.expire-after-write]]`link:#quarkus-cache-redis-general-config-items_quarkus.cache.redis.-cache-name-.expire-after-write[quarkus.cache.redis."cache-name".expire-after-write]`
...
a| [[quarkus-cache-redis-general-config-items_quarkus.cache.redis.-cache-name-.expire-after-access]]`link:#quarkus-cache-redis-general-config-items_quarkus.cache.redis.-cache-name-.expire-after-access[quarkus.cache.redis."cache-name".expire-after-access]`

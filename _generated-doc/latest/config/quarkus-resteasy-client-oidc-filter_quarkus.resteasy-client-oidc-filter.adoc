:summaryTableId: quarkus-resteasy-client-oidc-filter_quarkus-resteasy-client-oidc-filter
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-client-oidc-filter_quarkus-resteasy-client-oidc-filter-register-filter]] [.property-path]##`quarkus.resteasy-client-oidc-filter.register-filter`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-client-oidc-filter_quarkus-resteasy-client-oidc-filter-client-name]] [.property-path]##`quarkus.resteasy-client-oidc-filter.client-name`##

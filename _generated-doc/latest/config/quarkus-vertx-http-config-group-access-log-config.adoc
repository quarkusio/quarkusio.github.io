...
a| [[quarkus-vertx-http-config-group-access-log-config_quarkus-http-access-log-consolidate-rerouted-requests]]`link:#quarkus-vertx-http-config-group-access-log-config_quarkus-http-access-log-consolidate-rerouted-requests[quarkus.http.access-log.consolidate-rerouted-requests]`

:summaryTableId: quarkus-kafka-client_quarkus-kafka-devservices
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-enabled]] [.property-path]##`quarkus.kafka.devservices.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-port]] [.property-path]##`quarkus.kafka.devservices.port`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-provider]] [.property-path]##`quarkus.kafka.devservices.provider`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-image-name]] [.property-path]##`quarkus.kafka.devservices.image-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-shared]] [.property-path]##`quarkus.kafka.devservices.shared`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-service-name]] [.property-path]##`quarkus.kafka.devservices.service-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-topic-partitions-topic-name]] [.property-path]##`quarkus.kafka.devservices.topic-partitions."topic-name"`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-topic-partitions-timeout]] [.property-path]##`quarkus.kafka.devservices.topic-partitions-timeout`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-container-env-environment-variable-name]] [.property-path]##`quarkus.kafka.devservices.container-env."environment-variable-name"`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-redpanda-transaction-enabled]] [.property-path]##`quarkus.kafka.devservices.redpanda.transaction-enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices_quarkus-kafka-devservices-redpanda-proxy-port]] [.property-path]##`quarkus.kafka.devservices.redpanda.proxy-port`##

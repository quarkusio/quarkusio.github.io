...
a|icon:lock[title=Fixed at build time] [[quarkus-debug-debug-config_quarkus.debug.dump-build-metrics]]`link:#quarkus-debug-debug-config_quarkus.debug.dump-build-metrics[quarkus.debug.dump-build-metrics]`

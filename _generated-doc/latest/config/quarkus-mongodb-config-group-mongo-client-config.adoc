...
a| [[quarkus-mongodb-config-group-mongo-client-config_quarkus.mongodb.uuid-representation]]`link:#quarkus-mongodb-config-group-mongo-client-config_quarkus.mongodb.uuid-representation[quarkus.mongodb.uuid-representation]`
...
a| [[quarkus-mongodb-config-group-mongo-client-config_quarkus.mongodb.-mongo-client-configs-.uuid-representation]]`link:#quarkus-mongodb-config-group-mongo-client-config_quarkus.mongodb.-mongo-client-configs-.uuid-representation[quarkus.mongodb."mongo-client-configs".uuid-representation]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda-http_quarkus-lambda-http-enable-security]] [.property-path]##`quarkus.lambda-http.enable-security`##
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-map-cognito-to-roles]] [.property-path]##`quarkus.lambda-http.map-cognito-to-roles`##
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-cognito-role-claim]] [.property-path]##`quarkus.lambda-http.cognito-role-claim`##
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-cognito-claim-matcher]] [.property-path]##`quarkus.lambda-http.cognito-claim-matcher`##

...
h|[[quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.data-sources-datasources]]link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.data-sources-datasources[Datasources]
...
`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc[quarkus.datasource."datasource-name".jdbc]`
...
`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.driver[quarkus.datasource."datasource-name".jdbc.driver]`
...
`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.transactions[quarkus.datasource."datasource-name".jdbc.transactions]`
...
`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.enable-metrics[quarkus.datasource."datasource-name".jdbc.enable-metrics]`
...
`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.tracing[quarkus.datasource."datasource-name".jdbc.tracing]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.telemetry]]`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.telemetry[quarkus.datasource.jdbc.telemetry]`

`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.jdbc.telemetry[quarkus.datasource."datasource-name".jdbc.telemetry]`

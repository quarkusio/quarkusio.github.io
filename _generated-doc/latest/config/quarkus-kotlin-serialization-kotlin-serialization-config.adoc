...
a|icon:lock[title=Fixed at build time] [[quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-decode-enums-case-insensitive]]`link:#quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-decode-enums-case-insensitive[quarkus.kotlin-serialization.json.decode-enums-case-insensitive]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-allow-trailing-comma]]`link:#quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-allow-trailing-comma[quarkus.kotlin-serialization.json.allow-trailing-comma]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-allow-comments]]`link:#quarkus-kotlin-serialization-kotlin-serialization-config_quarkus-kotlin-serialization-json-allow-comments[quarkus.kotlin-serialization.json.allow-comments]`

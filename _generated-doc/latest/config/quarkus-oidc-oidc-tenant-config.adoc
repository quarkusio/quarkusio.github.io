...
-- a|
`apple`, `facebook`, `github`, `google`, `microsoft`, `spotify`, `twitch`, `twitter` 
|


a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.credentials.jwt.claims-claims]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.credentials.jwt.claims-claims[quarkus.oidc.credentials.jwt.claims]`
...
a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.credentials.jwt.claims-claims]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.credentials.jwt.claims-claims[quarkus.oidc."tenant".credentials.jwt.claims]`

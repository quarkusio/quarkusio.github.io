...
a| [[quarkus-restclient-config-rest-client-config_quarkus-rest-client-config-key-override-uri]]`link:#quarkus-restclient-config-rest-client-config_quarkus-rest-client-config-key-override-uri[quarkus.rest-client."config-key".override-uri]`

...
a| [[quarkus-websockets-next-general-config-items_quarkus-websockets-next-server-dev-mode-connection-messages-limit]]`link:#quarkus-websockets-next-general-config-items_quarkus-websockets-next-server-dev-mode-connection-messages-limit[quarkus.websockets-next.server.dev-mode.connection-messages-limit]`

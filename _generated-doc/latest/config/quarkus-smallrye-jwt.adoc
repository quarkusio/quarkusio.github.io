...
a| [[quarkus-smallrye-jwt_quarkus-smallrye-jwt-priority]] [.property-path]##link:#quarkus-smallrye-jwt_quarkus-smallrye-jwt-priority[`quarkus.smallrye-jwt.priority`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.smallrye-jwt.priority+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SMALLRYE_JWT_PRIORITY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]

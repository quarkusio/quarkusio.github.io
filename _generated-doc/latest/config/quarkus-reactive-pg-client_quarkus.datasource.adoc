:summaryTableId: quarkus-reactive-pg-client_quarkus-datasource
...
h|[[quarkus-reactive-pg-client_section_quarkus-datasource]] [.section-name.section-level0]##Datasources##
h|Type
h|Default

a| [[quarkus-reactive-pg-client_quarkus-datasource-reactive-postgresql-pipelining-limit]] [.property-path]##`quarkus.datasource.reactive.postgresql.pipelining-limit`##
...
a| [[quarkus-reactive-pg-client_quarkus-datasource-reactive-postgresql-ssl-mode]] [.property-path]##`quarkus.datasource.reactive.postgresql.ssl-mode`##
...
a| [[quarkus-reactive-pg-client_quarkus-datasource-reactive-postgresql-use-layer7-proxy]] [.property-path]##`quarkus.datasource.reactive.postgresql.use-layer7-proxy`##

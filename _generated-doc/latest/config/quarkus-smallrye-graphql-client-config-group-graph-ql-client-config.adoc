...
a| [[quarkus-smallrye-graphql-client-config-group-graph-ql-client-config_quarkus.smallrye-graphql-client.-clients-.init-payload-init-payload]]`link:#quarkus-smallrye-graphql-client-config-group-graph-ql-client-config_quarkus.smallrye-graphql-client.-clients-.init-payload-init-payload[quarkus.smallrye-graphql-client."clients".init-payload]`

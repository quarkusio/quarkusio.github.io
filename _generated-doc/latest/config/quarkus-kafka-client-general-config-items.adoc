...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client-general-config-items_quarkus-kafka-devservices-redpanda-proxy-port]]`link:#quarkus-kafka-client-general-config-items_quarkus-kafka-devservices-redpanda-proxy-port[quarkus.kafka.devservices.redpanda.proxy-port]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client-general-config-items_quarkus-kafka-devservices-topic-partitions-topic-name]]`link:#quarkus-kafka-client-general-config-items_quarkus-kafka-devservices-topic-partitions-topic-name[quarkus.kafka.devservices.topic-partitions."topic-name"]`

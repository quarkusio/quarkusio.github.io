...
a|icon:lock[title=Fixed at build time] [[quarkus-narayana-lra_quarkus-lra-openapi-included]] [.property-path]##`quarkus.lra.openapi.included`##
...
a| [[quarkus-narayana-lra_quarkus-lra-coordinator-url]] [.property-path]##`quarkus.lra.coordinator-url`##

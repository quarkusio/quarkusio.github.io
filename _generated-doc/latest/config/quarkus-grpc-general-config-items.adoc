...
a| [[quarkus-grpc-general-config-items_quarkus-grpc-clients-client-name-tls-configuration-name]]`link:#quarkus-grpc-general-config-items_quarkus-grpc-clients-client-name-tls-configuration-name[quarkus.grpc.clients."client-name".tls-configuration-name]`

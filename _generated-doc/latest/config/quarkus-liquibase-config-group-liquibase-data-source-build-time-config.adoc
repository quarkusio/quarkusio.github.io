...
a|icon:lock[title=Fixed at build time] [[quarkus-liquibase-config-group-liquibase-data-source-build-time-config_quarkus-liquibase-search-path]]`link:#quarkus-liquibase-config-group-liquibase-data-source-build-time-config_quarkus-liquibase-search-path[quarkus.liquibase.search-path]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-liquibase-config-group-liquibase-data-source-build-time-config_quarkus-liquibase-named-data-sources-search-path]]`link:#quarkus-liquibase-config-group-liquibase-data-source-build-time-config_quarkus-liquibase-named-data-sources-search-path[quarkus.liquibase."named-data-sources".search-path]`

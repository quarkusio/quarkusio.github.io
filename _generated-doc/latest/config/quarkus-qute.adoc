...
a|icon:lock[title=Fixed at build time] [[quarkus-qute_quarkus-qute-test-mode-record-rendered-results]]`link:#quarkus-qute_quarkus-qute-test-mode-record-rendered-results[quarkus.qute.test-mode.record-rendered-results]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-qute_quarkus-qute-content-types-file-suffix]]`link:#quarkus-qute_quarkus-qute-content-types-file-suffix[quarkus.qute.content-types."file-suffix"]`

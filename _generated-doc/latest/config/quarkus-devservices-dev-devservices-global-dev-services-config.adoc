...
a|icon:lock[title=Fixed at build time] [[quarkus-devservices-dev-devservices-global-dev-services-config_quarkus-devservices-launch-on-shared-network]]`link:#quarkus-devservices-dev-devservices-global-dev-services-config_quarkus-devservices-launch-on-shared-network[quarkus.devservices.launch-on-shared-network]`

:summaryTableId: quarkus-elytron-security-oauth2_quarkus-oauth2
...
a|icon:lock[title=Fixed at build time] [[quarkus-elytron-security-oauth2_quarkus-oauth2-enabled]] [.property-path]##`quarkus.oauth2.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-elytron-security-oauth2_quarkus-oauth2-role-claim]] [.property-path]##`quarkus.oauth2.role-claim`##
...
a| [[quarkus-elytron-security-oauth2_quarkus-oauth2-client-id]] [.property-path]##`quarkus.oauth2.client-id`##
...
a| [[quarkus-elytron-security-oauth2_quarkus-oauth2-client-secret]] [.property-path]##`quarkus.oauth2.client-secret`##
...
a| [[quarkus-elytron-security-oauth2_quarkus-oauth2-introspection-url]] [.property-path]##`quarkus.oauth2.introspection-url`##
...
a| [[quarkus-elytron-security-oauth2_quarkus-oauth2-ca-cert-file]] [.property-path]##`quarkus.oauth2.ca-cert-file`##

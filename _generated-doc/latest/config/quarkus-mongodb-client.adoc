...
h|[[quarkus-mongodb-client_section_quarkus-mongodb-tracing]] [.section-name.section-level0]##link:#quarkus-mongodb-client_section_quarkus-mongodb-tracing[Tracing configuration]##
h|Type
h|Default

a| [[quarkus-mongodb-client_quarkus-mongodb-tracing-command-detail-level]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-tracing-command-detail-level[`+++quarkus.mongodb.tracing.command-detail-level+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mongodb.tracing.command-detail-level+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MONGODB_TRACING_COMMAND_DETAIL_LEVEL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MONGODB_TRACING_COMMAND_DETAIL_LEVEL+++`
endif::add-copy-button-to-env-var[]
--
a|tooltip:off[No command details, only operation metadata], tooltip:sanitized[Command structure with type information (e.g., ++{++"email"\: "<string>", "age"\: "<int32>"++}++)], tooltip:full[Full command including all data - may expose sensitive information]
|tooltip:off[No command details, only operation metadata]

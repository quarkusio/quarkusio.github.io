...
a| [[quarkus-mongodb-client_quarkus-mongodb-native-dns-server-host]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-native-dns-server-host[[.line-through]#`quarkus.mongodb.native.dns.server-host`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mongodb.native.dns.server-host+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated: this property has been deprecated in favor of `dns-server`._
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MONGODB_NATIVE_DNS_SERVER_HOST+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MONGODB_NATIVE_DNS_SERVER_HOST+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-mongodb-client_quarkus-mongodb-native-dns-server-port]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-native-dns-server-port[[.line-through]#`quarkus.mongodb.native.dns.server-port`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mongodb.native.dns.server-port+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated: this property has been deprecated in favor of `dns-server-port`._

If `native.dns.use-vertx-dns-resolver` is set to `true`, this property configures the DNS server port.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MONGODB_NATIVE_DNS_SERVER_PORT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MONGODB_NATIVE_DNS_SERVER_PORT+++`
endif::add-copy-button-to-env-var[]
--
|int
|

a| [[quarkus-mongodb-client_quarkus-mongodb-native-dns-lookup-timeout]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-native-dns-lookup-timeout[[.line-through]#`quarkus.mongodb.native.dns.lookup-timeout`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mongodb.native.dns.lookup-timeout+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated: this property has been deprecated in favor of `dns-lookup-timeout`._

If `native.dns.use-vertx-dns-resolver` is set to `true`, this property configures the DNS lookup timeout duration.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MONGODB_NATIVE_DNS_LOOKUP_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MONGODB_NATIVE_DNS_LOOKUP_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-mongodb-client_quarkus-mongodb[icon:question-circle[title=More information about the Duration format]]
|`+++5S+++`

a| [[quarkus-mongodb-client_quarkus-mongodb-native-dns-log-activity]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-native-dns-log-activity[[.line-through]#`quarkus.mongodb.native.dns.log-activity`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mongodb.native.dns.log-activity+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated: this property has been deprecated in favor of `dns-lookup-log-activity`._
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MONGODB_NATIVE_DNS_LOG_ACTIVITY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MONGODB_NATIVE_DNS_LOG_ACTIVITY+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a| [[quarkus-mongodb-client_quarkus-mongodb-mongo-client-configs-tls-insecure]] [.property-path]##link:#quarkus-mongodb-client_quarkus-mongodb-mongo-client-configs-tls-insecure[[.line-through]#`quarkus.mongodb."mongo-client-configs".tls-insecure`#]##
ifdef::add-copy-button-to-config-props[]

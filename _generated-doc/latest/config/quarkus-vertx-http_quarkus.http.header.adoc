:summaryTableId: quarkus-vertx-http_quarkus-http-header
...
a| [[quarkus-vertx-http_quarkus-http-header_quarkus-http-header-header-path]] [.property-path]##`quarkus.http.header."header".path`##
...
a| [[quarkus-vertx-http_quarkus-http-header_quarkus-http-header-header-value]] [.property-path]##`quarkus.http.header."header".value`##
...
a| [[quarkus-vertx-http_quarkus-http-header_quarkus-http-header-header-methods]] [.property-path]##`quarkus.http.header."header".methods`##

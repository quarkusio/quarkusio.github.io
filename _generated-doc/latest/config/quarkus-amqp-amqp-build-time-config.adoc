...
a|icon:lock[title=Fixed at build time] [[quarkus-amqp-amqp-build-time-config_quarkus.amqp.devservices.container-env-container-env]]`link:#quarkus-amqp-amqp-build-time-config_quarkus.amqp.devservices.container-env-container-env[quarkus.amqp.devservices.container-env]`

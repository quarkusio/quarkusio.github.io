...
a| [[quarkus-vertx-http_quarkus-http-cors_quarkus-http-cors-return-exact-origins]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-cors_quarkus-http-cors-return-exact-origins[`+++quarkus.http.cors.return-exact-origins+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.cors.return-exact-origins+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_CORS_RETURN_EXACT_ORIGINS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-vertx-http_quarkus-http-cors_quarkus-http-cors-vary-origin]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-cors_quarkus-http-cors-vary-origin[`+++quarkus.http.cors.vary-origin+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.cors.vary-origin+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HTTP_CORS_VARY_ORIGIN+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]

...
a| [[quarkus-redis-client_quarkus-redis-redis-client-name-cluster-transactions]] [.property-path]##link:#quarkus-redis-client_quarkus-redis-redis-client-name-cluster-transactions[`quarkus.redis."redis-client-name".cluster-transactions`]##
ifdef::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_REDIS__REDIS_CLIENT_NAME__CLUSTER_TRANSACTIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_REDIS__REDIS_CLIENT_NAME__CLUSTER_TRANSACTIONS+++`
endif::add-copy-button-to-env-var[]
--
a|`disabled`, `single-node`
|`+++disabled+++`
...
a| [[quarkus-redis-client_quarkus-redis-redis-client-name-hash-slot-cache-ttl]] [.property-path]##link:#quarkus-redis-client_quarkus-redis-redis-client-name-hash-slot-cache-ttl[[.line-through]#`quarkus.redis."redis-client-name".hash-slot-cache-ttl`#]##
ifdef::add-copy-button-to-config-props[]
...
a| [[quarkus-redis-client_quarkus-redis-redis-client-name-tcp-proxy-configuration-name]] [.property-path]##link:#quarkus-redis-client_quarkus-redis-redis-client-name-tcp-proxy-configuration-name[`quarkus.redis."redis-client-name".tcp.proxy-configuration-name`]##
ifdef::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_REDIS__REDIS_CLIENT_NAME__TCP_PROXY_CONFIGURATION_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_REDIS__REDIS_CLIENT_NAME__TCP_PROXY_CONFIGURATION_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|

...
a| [[quarkus-reactive-datasource-config-group-data-sources-reactive-build-time-config-data-source-reactive-outer-named-build-time-config_quarkus-datasource-datasource-name-reactive-max-lifetime]]`link:#quarkus-reactive-datasource-config-group-data-sources-reactive-build-time-config-data-source-reactive-outer-named-build-time-config_quarkus-datasource-datasource-name-reactive-max-lifetime[quarkus.datasource."datasource-name".reactive.max-lifetime]`
...
a| [[quarkus-reactive-datasource-config-group-data-sources-reactive-build-time-config-data-source-reactive-outer-named-build-time-config_quarkus-datasource-datasource-name-reactive-additional-properties-property-key]]`link:#quarkus-reactive-datasource-config-group-data-sources-reactive-build-time-config-data-source-reactive-outer-named-build-time-config_quarkus-datasource-datasource-name-reactive-additional-properties-property-key[quarkus.datasource."datasource-name".reactive.additional-properties."property-key"]`

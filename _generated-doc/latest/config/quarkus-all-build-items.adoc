...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/webjars-locator/deployment/src/main/java/io/quarkus/webjar/locator/deployment/ImportMapBuildItem.java[`io.quarkus.webjar.locator.deployment.ImportMapBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String importmap` :: +++<i>No Javadoc found</i>+++

a| https://github.com/quarkusio/quarkus/blob/main/extensions/webjars-locator/deployment/src/main/java/io/quarkus/webjar/locator/deployment/devui/WebJarLibrariesBuildItem.java[`io.quarkus.webjar.locator.deployment.devui.WebJarLibrariesBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String provider` :: +++<i>No Javadoc found</i>+++
`List webJarLibraries` :: +++<i>No Javadoc found</i>+++

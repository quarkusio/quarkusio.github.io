...
h|[[quarkus-hibernate-search-orm-coordination-outboxpolling-config-group-hibernate-search-outbox-polling-build-time-config-persistence-unit_quarkus.hibernate-search-orm.persistence-units-configuration-for-persistence-units]]link:#quarkus-hibernate-search-orm-coordination-outboxpolling-config-group-hibernate-search-outbox-polling-build-time-config-persistence-unit_quarkus.hibernate-search-orm.persistence-units-configuration-for-persistence-units[Configuration for persistence units]
...
`link:#quarkus-hibernate-search-orm-coordination-outboxpolling-config-group-hibernate-search-outbox-polling-build-time-config-persistence-unit_quarkus.hibernate-search-orm.coordination.entity-mapping.agent.table[quarkus.hibernate-search-orm."persistence-unit-name".coordination.entity-mapping.agent.table]`

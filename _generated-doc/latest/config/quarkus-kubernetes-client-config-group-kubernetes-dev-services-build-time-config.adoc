...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-client-config-group-kubernetes-dev-services-build-time-config_quarkus.kubernetes-client.devservices.container-env-container-env]]`link:#quarkus-kubernetes-client-config-group-kubernetes-dev-services-build-time-config_quarkus.kubernetes-client.devservices.container-env-container-env[quarkus.kubernetes-client.devservices.container-env]`

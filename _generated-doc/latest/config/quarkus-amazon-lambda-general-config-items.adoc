...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda-general-config-items_quarkus.lambda.mock-event-server.enabled]]`link:#quarkus-amazon-lambda-general-config-items_quarkus.lambda.mock-event-server.enabled[quarkus.lambda.mock-event-server.enabled]`

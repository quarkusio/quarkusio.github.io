:summaryTableId: quarkus-resteasy_quarkus-security
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-security-jaxrs-deny-unannotated-endpoints]] [.property-path]##`quarkus.security.jaxrs.deny-unannotated-endpoints`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-security-jaxrs-default-roles-allowed]] [.property-path]##`quarkus.security.jaxrs.default-roles-allowed`##

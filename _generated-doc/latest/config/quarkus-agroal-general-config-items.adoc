...
h|[[quarkus-agroal-general-config-items_quarkus.datasource.data-sources-datasources]]link:#quarkus-agroal-general-config-items_quarkus.datasource.data-sources-datasources[Datasources]
...
a| [[quarkus-agroal-general-config-items_quarkus.datasource.-datasource-name-.jdbc.telemetry.enabled]]`link:#quarkus-agroal-general-config-items_quarkus.datasource.-datasource-name-.jdbc.telemetry.enabled[quarkus.datasource."datasource-name".jdbc.telemetry.enabled]`

:summaryTableId: quarkus-rest-client-oidc-token-propagation_quarkus-rest-client-oidc-token-propagation
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-oidc-token-propagation_quarkus-rest-client-oidc-token-propagation-enabled]] [.property-path]##`quarkus.rest-client-oidc-token-propagation.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-oidc-token-propagation_quarkus-rest-client-oidc-token-propagation-enabled-during-authentication]] [.property-path]##`quarkus.rest-client-oidc-token-propagation.enabled-during-authentication`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-oidc-token-propagation_quarkus-rest-client-oidc-token-propagation-exchange-token]] [.property-path]##`quarkus.rest-client-oidc-token-propagation.exchange-token`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-oidc-token-propagation_quarkus-rest-client-oidc-token-propagation-client-name]] [.property-path]##`quarkus.rest-client-oidc-token-propagation.client-name`##

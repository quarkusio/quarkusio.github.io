:summaryTableId: quarkus-redis-client_quarkus-redis-devservices
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-enabled]] [.property-path]##`quarkus.redis.devservices.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-image-name]] [.property-path]##`quarkus.redis.devservices.image-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-port]] [.property-path]##`quarkus.redis.devservices.port`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-shared]] [.property-path]##`quarkus.redis.devservices.shared`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-service-name]] [.property-path]##`quarkus.redis.devservices.service-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-client_quarkus-redis-devservices_quarkus-redis-devservices-container-env-environment-variable-name]] [.property-path]##`quarkus.redis.devservices.container-env."environment-variable-name"`##

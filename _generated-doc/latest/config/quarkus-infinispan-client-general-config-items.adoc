...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-devservices-create-default-client]]`link:#quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-devservices-create-default-client[quarkus.infinispan-client.devservices.create-default-client]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-devservices-config-files]]`link:#quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-devservices-config-files[quarkus.infinispan-client.devservices.config-files]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-named-infinispan-clients-devservices-create-default-client]]`link:#quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-named-infinispan-clients-devservices-create-default-client[quarkus.infinispan-client."named-infinispan-clients".devservices.create-default-client]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-named-infinispan-clients-devservices-config-files]]`link:#quarkus-infinispan-client-general-config-items_quarkus-infinispan-client-named-infinispan-clients-devservices-config-files[quarkus.infinispan-client."named-infinispan-clients".devservices.config-files]`

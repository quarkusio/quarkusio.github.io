...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-config-group-init-task-config_quarkus.openshift.init-task-defaults.wait-for-container.image]]`link:#quarkus-kubernetes-config-group-init-task-config_quarkus.openshift.init-task-defaults.wait-for-container.image[quarkus.openshift.init-task-defaults.wait-for-container.image]`

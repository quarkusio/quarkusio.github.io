:summaryTableId: quarkus-vertx-graphql_quarkus-vertx-graphql
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-graphql_quarkus-vertx-graphql-ui-always-include]] [.property-path]##`quarkus.vertx-graphql.ui.always-include`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-graphql_quarkus-vertx-graphql-ui-path]] [.property-path]##`quarkus.vertx-graphql.ui.path`##

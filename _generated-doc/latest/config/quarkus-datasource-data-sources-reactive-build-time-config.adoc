...
a| [[quarkus-datasource-data-sources-reactive-build-time-config_quarkus-datasource-datasource-name-reactive-max-lifetime]]`link:#quarkus-datasource-data-sources-reactive-build-time-config_quarkus-datasource-datasource-name-reactive-max-lifetime[quarkus.datasource."datasource-name".reactive.max-lifetime]`
...
a| [[quarkus-datasource-data-sources-reactive-build-time-config_quarkus-datasource-datasource-name-reactive-additional-properties-property-key]]`link:#quarkus-datasource-data-sources-reactive-build-time-config_quarkus-datasource-datasource-name-reactive-additional-properties-property-key[quarkus.datasource."datasource-name".reactive.additional-properties."property-key"]`

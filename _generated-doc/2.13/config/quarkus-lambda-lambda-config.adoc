...
a|icon:lock[title=Fixed at build time] [[quarkus-lambda-lambda-config_quarkus.lambda.mock-event-server.dev-port]]`link:#quarkus-lambda-lambda-config_quarkus.lambda.mock-event-server.dev-port[quarkus.lambda.mock-event-server.dev-port]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-lambda-lambda-config_quarkus.lambda.mock-event-server.test-port]]`link:#quarkus-lambda-lambda-config_quarkus.lambda.mock-event-server.test-port[quarkus.lambda.mock-event-server.test-port]`

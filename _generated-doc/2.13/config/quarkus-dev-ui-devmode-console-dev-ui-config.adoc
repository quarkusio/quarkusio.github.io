...
a|icon:lock[title=Fixed at build time] [[quarkus-dev-ui-devmode-console-dev-ui-config_quarkus.dev-ui.cors.enabled]]`link:#quarkus-dev-ui-devmode-console-dev-ui-config_quarkus.dev-ui.cors.enabled[quarkus.dev-ui.cors.enabled]`

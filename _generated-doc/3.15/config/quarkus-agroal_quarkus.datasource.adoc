...
a| [[quarkus-agroal_quarkus-datasource-jdbc-tracing-enabled]] [.property-path]##link:#quarkus-agroal_quarkus-datasource-jdbc-tracing-enabled[`quarkus.datasource.jdbc.tracing.enabled`]##
...
a| [[quarkus-agroal_quarkus-datasource-jdbc-tracing-trace-with-active-span-only]] [.property-path]##link:#quarkus-agroal_quarkus-datasource-jdbc-tracing-trace-with-active-span-only[`quarkus.datasource.jdbc.tracing.trace-with-active-span-only`]##
...
a| [[quarkus-agroal_quarkus-datasource-jdbc-tracing-ignore-for-tracing]] [.property-path]##link:#quarkus-agroal_quarkus-datasource-jdbc-tracing-ignore-for-tracing[`quarkus.datasource.jdbc.tracing.ignore-for-tracing`]##

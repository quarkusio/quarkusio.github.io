...
a|icon:lock[title=Fixed at build time] [[quarkus-opentelemetry-config-group-config-build-traces-build-config_quarkus.otel.traces.eusp.enabled]]`link:#quarkus-opentelemetry-config-group-config-build-traces-build-config_quarkus.otel.traces.eusp.enabled[quarkus.otel.traces.eusp.enabled]`

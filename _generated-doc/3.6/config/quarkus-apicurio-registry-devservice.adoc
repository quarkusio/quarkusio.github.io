...
a|icon:lock[title=Fixed at build time] [[quarkus-apicurio-registry-devservice_quarkus.apicurio-registry.devservices.container-env-container-env]]`link:#quarkus-apicurio-registry-devservice_quarkus.apicurio-registry.devservices.container-env-container-env[quarkus.apicurio-registry.devservices.container-env]`

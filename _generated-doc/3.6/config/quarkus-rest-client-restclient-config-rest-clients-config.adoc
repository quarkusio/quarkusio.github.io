...
a| [[quarkus-rest-client-restclient-config-rest-clients-config_quarkus.rest-client.multipart.max-chunk-size]]`link:#quarkus-rest-client-restclient-config-rest-clients-config_quarkus.rest-client.multipart.max-chunk-size[quarkus.rest-client.multipart.max-chunk-size]`

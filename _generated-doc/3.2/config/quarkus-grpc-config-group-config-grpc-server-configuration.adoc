...
a| [[quarkus-grpc-config-group-config-grpc-server-configuration_quarkus.grpc.server.xds.is-enabled]]`link:#quarkus-grpc-config-group-config-grpc-server-configuration_quarkus.grpc.server.xds.is-enabled[quarkus.grpc.server.xds.is-enabled]`
...
a| [[quarkus-grpc-config-group-config-grpc-server-configuration_quarkus.grpc.server.in-process.is-enabled]]`link:#quarkus-grpc-config-group-config-grpc-server-configuration_quarkus.grpc.server.in-process.is-enabled[quarkus.grpc.server.in-process.is-enabled]`

...
a| [[quarkus-datasource-data-sources-build-time-config_quarkus-datasource-active]]`link:#quarkus-datasource-data-sources-build-time-config_quarkus-datasource-active[quarkus.datasource.active]`

`link:#quarkus-datasource-data-sources-build-time-config_quarkus-datasource-active[quarkus.datasource."datasource-name".active]`

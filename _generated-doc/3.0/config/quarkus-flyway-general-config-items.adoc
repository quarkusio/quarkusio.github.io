...
a| [[quarkus-flyway-general-config-items_quarkus.flyway.run-and-exit]]`link:#quarkus-flyway-general-config-items_quarkus.flyway.run-and-exit[quarkus.flyway.run-and-exit]`
...
a| [[quarkus-flyway-general-config-items_quarkus.flyway.-named-data-sources-.run-and-exit]]`link:#quarkus-flyway-general-config-items_quarkus.flyway.-named-data-sources-.run-and-exit[quarkus.flyway."named-data-sources".run-and-exit]`

:summaryTableId: quarkus-spring-di_quarkus-spring-di
...
a|icon:lock[title=Fixed at build time] [[quarkus-spring-di_quarkus-spring-di-enabled]] `quarkus.spring-di.enabled`

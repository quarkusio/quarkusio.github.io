...
a| [[quarkus-oidc_quarkus-oidc-tls-tls-configuration-name]] [.property-path]##`quarkus.oidc.tls.tls-configuration-name`##
...
a| [[quarkus-oidc_quarkus-oidc-tenant-tls-tls-configuration-name]] [.property-path]##`quarkus.oidc."tenant".tls.tls-configuration-name`##

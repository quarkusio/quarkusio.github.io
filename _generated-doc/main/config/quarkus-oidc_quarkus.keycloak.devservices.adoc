...
--
|MemorySize link:#memory-size-note-anchor-quarkus-oidc_quarkus-keycloak-devservices[icon:question-circle[title=More information about the MemorySize format]]
|`750M`

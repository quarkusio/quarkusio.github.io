...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-devservices-enabled]] `quarkus.devservices.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-devservices-launch-on-shared-network]] `quarkus.devservices.launch-on-shared-network`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-devservices-timeout]] `quarkus.devservices.timeout`

:summaryTableId: quarkus-core_quarkus-debug
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-debug-reflection]] `quarkus.debug.reflection`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-debug-generated-classes-dir]] `quarkus.debug.generated-classes-dir`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-debug-transformed-classes-dir]] `quarkus.debug.transformed-classes-dir`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-debug-generated-sources-dir]] `quarkus.debug.generated-sources-dir`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-debug-dump-build-metrics]] `quarkus.debug.dump-build-metrics`
...
a| [[quarkus-core_quarkus-debug-print-startup-times]] `quarkus.debug.print-startup-times`

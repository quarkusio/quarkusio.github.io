...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-container-env-container-env]]`link:#quarkus-kafka-client_quarkus-kafka-devservices-container-env-container-env[quarkus.kafka.devservices.container-env]`

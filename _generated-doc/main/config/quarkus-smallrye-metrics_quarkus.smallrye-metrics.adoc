...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-path]] `quarkus.smallrye-metrics.path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-extensions-enabled]] `quarkus.smallrye-metrics.extensions.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-micrometer-compatibility]] `quarkus.smallrye-metrics.micrometer.compatibility`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-jaxrs-enabled]] `quarkus.smallrye-metrics.jaxrs.enabled`

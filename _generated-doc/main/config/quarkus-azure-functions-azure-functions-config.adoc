...
a|icon:lock[title=Fixed at build time] [[quarkus-azure-functions-azure-functions-config_quarkus-azure-functions-app-settings-setting-name]]`link:#quarkus-azure-functions-azure-functions-config_quarkus-azure-functions-app-settings-setting-name[quarkus.azure-functions.app-settings."setting-name"]`

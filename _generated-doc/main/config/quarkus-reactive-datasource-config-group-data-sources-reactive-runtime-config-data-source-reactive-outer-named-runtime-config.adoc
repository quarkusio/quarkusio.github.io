...
a| [[quarkus-reactive-datasource-config-group-data-sources-reactive-runtime-config-data-source-reactive-outer-named-runtime-config_quarkus-datasource-datasource-name-reactive-max-lifetime]]`link:#quarkus-reactive-datasource-config-group-data-sources-reactive-runtime-config-data-source-reactive-outer-named-runtime-config_quarkus-datasource-datasource-name-reactive-max-lifetime[quarkus.datasource."datasource-name".reactive.max-lifetime]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http_quarkus-dev-ui-history-size]] `quarkus.dev-ui.history-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http_quarkus-dev-ui-show-json-rpc-log]] `quarkus.dev-ui.show-json-rpc-log`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http_quarkus-dev-ui-hosts]] `quarkus.dev-ui.hosts`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http_quarkus-dev-ui-cors-enabled]] `quarkus.dev-ui.cors.enabled`

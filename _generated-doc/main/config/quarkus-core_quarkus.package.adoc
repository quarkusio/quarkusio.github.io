...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-appcds-enabled]] [.property-path]##link:#quarkus-core_quarkus-package-jar-appcds-enabled[[.line-through]#`quarkus.package.jar.appcds.enabled`#]##
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated since `3.32`._
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-appcds-builder-image]] [.property-path]##link:#quarkus-core_quarkus-package-jar-appcds-builder-image[[.line-through]#`quarkus.package.jar.appcds.builder-image`#]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-appcds-use-container]] [.property-path]##link:#quarkus-core_quarkus-package-jar-appcds-use-container[[.line-through]#`quarkus.package.jar.appcds.use-container`#]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-appcds-use-aot]] [.property-path]##link:#quarkus-core_quarkus-package-jar-appcds-use-aot[[.line-through]#`quarkus.package.jar.appcds.use-aot`#]##
ifdef::add-copy-button-to-config-props[]
...
If `AotType++#++AUTO` is used, Quarkus will generate an AOT file for JDK 25{plus}, otherwise it will generate an AppCDS file.

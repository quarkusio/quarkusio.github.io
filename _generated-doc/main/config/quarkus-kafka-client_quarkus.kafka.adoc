...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-health-enabled]] `quarkus.kafka.health.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-snappy-enabled]] `quarkus.kafka.snappy.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-snappy-load-from-shared-classloader]] `quarkus.kafka.snappy.load-from-shared-classloader`
...
h|[[quarkus-kafka-client_section_quarkus-kafka-devservices]] Dev Services
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-enabled]] `quarkus.kafka.devservices.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-port]] `quarkus.kafka.devservices.port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-provider]] `quarkus.kafka.devservices.provider`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-image-name]] `quarkus.kafka.devservices.image-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-shared]] `quarkus.kafka.devservices.shared`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-service-name]] `quarkus.kafka.devservices.service-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-topic-partitions-topic-name]] `quarkus.kafka.devservices.topic-partitions."topic-name"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-topic-partitions-timeout]] `quarkus.kafka.devservices.topic-partitions-timeout`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-container-env-environment-variable-name]] `quarkus.kafka.devservices.container-env."environment-variable-name"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-redpanda-transaction-enabled]] `quarkus.kafka.devservices.redpanda.transaction-enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kafka-client_quarkus-kafka-devservices-redpanda-proxy-port]] `quarkus.kafka.devservices.redpanda.proxy-port`

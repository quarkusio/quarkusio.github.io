...
a| [[quarkus-smallrye-graphql-client-graph-ql-clients-config_quarkus-smallrye-graphql-client-clients-header-header-name]]`link:#quarkus-smallrye-graphql-client-graph-ql-clients-config_quarkus-smallrye-graphql-client-clients-header-header-name[quarkus.smallrye-graphql-client."clients".header."header-name"]`
...
a| [[quarkus-smallrye-graphql-client-graph-ql-clients-config_quarkus-smallrye-graphql-client-clients-init-payload-property-name]]`link:#quarkus-smallrye-graphql-client-graph-ql-clients-config_quarkus-smallrye-graphql-client-clients-init-payload-property-name[quarkus.smallrye-graphql-client."clients".init-payload."property-name"]`

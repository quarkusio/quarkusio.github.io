...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda_quarkus-lambda-mock-event-server-enabled]] `quarkus.lambda.mock-event-server.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda_quarkus-lambda-mock-event-server-dev-port]] `quarkus.lambda.mock-event-server.dev-port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda_quarkus-lambda-mock-event-server-test-port]] `quarkus.lambda.mock-event-server.test-port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda_quarkus-lambda-expected-exceptions]] `quarkus.lambda.expected-exceptions`
...
a| [[quarkus-amazon-lambda_quarkus-lambda-handler]] `quarkus.lambda.handler`

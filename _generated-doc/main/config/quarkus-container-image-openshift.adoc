...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus.openshift.image-push-secret]]`link:#quarkus-container-image-openshift_quarkus.openshift.image-push-secret[quarkus.openshift.image-push-secret]`

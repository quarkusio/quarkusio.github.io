:summaryTableId: quarkus-rest_quarkus-rest
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-path]] `quarkus.rest.path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-input-buffer-size]] `quarkus.rest.input-buffer-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-min-chunk-size]] `quarkus.rest.min-chunk-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-output-buffer-size]] `quarkus.rest.output-buffer-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-single-default-produces]] `quarkus.rest.single-default-produces`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-default-produces]] `quarkus.rest.default-produces`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-build-time-condition-aware]] `quarkus.rest.build-time-condition-aware`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-fail-on-duplicate]] `quarkus.rest.fail-on-duplicate`
...
a|icon:lock[title=Fixed at build time] [[quarkus-rest_quarkus-rest-resume-on404]] `quarkus.rest.resume-on404`
...
a| [[quarkus-rest_quarkus-rest-multipart-input-part-default-charset]] `quarkus.rest.multipart.input-part.default-charset`

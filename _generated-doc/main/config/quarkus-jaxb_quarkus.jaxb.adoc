:summaryTableId: quarkus-jaxb_quarkus-jaxb
...
a|icon:lock[title=Fixed at build time] [[quarkus-jaxb_quarkus-jaxb-validate-jaxb-context]] `quarkus.jaxb.validate-jaxb-context`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jaxb_quarkus-jaxb-exclude-classes]] `quarkus.jaxb.exclude-classes`

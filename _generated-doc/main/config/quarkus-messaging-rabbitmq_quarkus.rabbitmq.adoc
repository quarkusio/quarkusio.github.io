...
h|[[quarkus-messaging-rabbitmq_section_quarkus-rabbitmq-devservices]] Dev Services
h|Type
h|Default
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-rabbitmq_quarkus-rabbitmq-credentials-provider]] `quarkus.rabbitmq.credentials-provider`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-rabbitmq_quarkus-rabbitmq-credentials-provider-name]] `quarkus.rabbitmq.credentials-provider-name`

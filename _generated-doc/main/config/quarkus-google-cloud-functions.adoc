:summaryTableId: quarkus-google-cloud-functions_quarkus-google-cloud-functions
...
a| [[quarkus-google-cloud-functions_quarkus-google-cloud-functions-function]] [.property-path]##`quarkus.google-cloud-functions.function`##

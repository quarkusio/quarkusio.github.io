...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui-swagger-ui-config_quarkus-swagger-ui-urls-name]]`link:#quarkus-swagger-ui-swagger-ui-config_quarkus-swagger-ui-urls-name[quarkus.swagger-ui.urls."name"]`

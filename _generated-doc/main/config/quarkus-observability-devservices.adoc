...
h|[[quarkus-observability-devservices_section_quarkus-observability-lgtm]] Grafana LGTM configuration
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-enabled]] `quarkus.observability.lgtm.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-shared]] `quarkus.observability.lgtm.shared`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-service-name]] `quarkus.observability.lgtm.service-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-username]] `quarkus.observability.lgtm.username`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-password]] `quarkus.observability.lgtm.password`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-grafana-port]] `quarkus.observability.lgtm.grafana-port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-timeout]] `quarkus.observability.lgtm.timeout`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-image-name]] `quarkus.observability.lgtm.image-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-network-aliases]] `quarkus.observability.lgtm.network-aliases`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-label]] `quarkus.observability.lgtm.label`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-lgtm-otlp-port]] `quarkus.observability.lgtm.otlp-port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-enabled]] `quarkus.observability.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-dev-resources]] `quarkus.observability.dev-resources`
...
a|icon:lock[title=Fixed at build time] [[quarkus-observability-devservices_quarkus-observability-parallel]] `quarkus.observability.parallel`

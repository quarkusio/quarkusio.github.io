:summaryTableId: quarkus-virtual-threads_quarkus-virtual-threads
...
a|icon:lock[title=Fixed at build time] [[quarkus-virtual-threads_quarkus-virtual-threads-name-prefix]] `quarkus.virtual-threads.name-prefix`
...
a|icon:lock[title=Fixed at build time] [[quarkus-virtual-threads_quarkus-virtual-threads-shutdown-timeout]] `quarkus.virtual-threads.shutdown-timeout`
...
a|icon:lock[title=Fixed at build time] [[quarkus-virtual-threads_quarkus-virtual-threads-shutdown-check-interval]] `quarkus.virtual-threads.shutdown-check-interval`
...
a|icon:lock[title=Fixed at build time] [[quarkus-virtual-threads_quarkus-virtual-threads-enabled]] `quarkus.virtual-threads.enabled`

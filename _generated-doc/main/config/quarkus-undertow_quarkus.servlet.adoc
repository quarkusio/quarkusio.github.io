...
a|icon:lock[title=Fixed at build time] [[quarkus-undertow_quarkus-servlet-context-path]] `quarkus.servlet.context-path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-undertow_quarkus-servlet-default-charset]] `quarkus.servlet.default-charset`
...
a| [[quarkus-undertow_quarkus-servlet-buffer-size]] `quarkus.servlet.buffer-size`
...
a| [[quarkus-undertow_quarkus-servlet-direct-buffers]] `quarkus.servlet.direct-buffers`
...
a| [[quarkus-undertow_quarkus-servlet-max-parameters]] `quarkus.servlet.max-parameters`

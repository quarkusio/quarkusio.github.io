...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-enabled]] `quarkus.mqtt.devservices.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-port]] `quarkus.mqtt.devservices.port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-image-name]] `quarkus.mqtt.devservices.image-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-shared]] `quarkus.mqtt.devservices.shared`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-service-name]] `quarkus.mqtt.devservices.service-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-mqtt_quarkus-mqtt-devservices-container-env-environment-variable-name]] `quarkus.mqtt.devservices.container-env."environment-variable-name"`

:summaryTableId: quarkus-reactive-mysql-client_quarkus-datasource
...
h|[[quarkus-reactive-mysql-client_section_quarkus-datasource]] Additional named datasources
h|Type
h|Default

a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-charset]] `quarkus.datasource.reactive.mysql.charset`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-collation]] `quarkus.datasource.reactive.mysql.collation`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-ssl-mode]] `quarkus.datasource.reactive.mysql.ssl-mode`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-connection-timeout]] `quarkus.datasource.reactive.mysql.connection-timeout`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-authentication-plugin]] `quarkus.datasource.reactive.mysql.authentication-plugin`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-pipelining-limit]] `quarkus.datasource.reactive.mysql.pipelining-limit`
...
a| [[quarkus-reactive-mysql-client_quarkus-datasource-reactive-mysql-use-affected-rows]] `quarkus.datasource.reactive.mysql.use-affected-rows`

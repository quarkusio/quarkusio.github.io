...
h|[[quarkus-oidc-client-registration_section_quarkus-oidc-client-registration-id-proxy]] [.section-name.section-level1]##link:#quarkus-oidc-client-registration_section_quarkus-oidc-client-registration-id-proxy[HTTP proxy configuration]##
h|Type
h|Default
...
h|[[quarkus-oidc-client-registration_section_quarkus-oidc-client-registration-id-tls]] [.section-name.section-level1]##link:#quarkus-oidc-client-registration_section_quarkus-oidc-client-registration-id-tls[TLS configuration]##
h|Type
h|Default

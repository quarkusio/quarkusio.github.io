...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-pulsar_quarkus-messaging-pulsar-schema-autodetection-enabled]] `quarkus.messaging.pulsar.schema-autodetection.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-pulsar_quarkus-messaging-pulsar-schema-generation-enabled]] `quarkus.messaging.pulsar.schema-generation.enabled`

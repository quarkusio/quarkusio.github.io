:summaryTableId: quarkus-security-jpa_quarkus-security-jpa
...
a|icon:lock[title=Fixed at build time] [[quarkus-security-jpa_quarkus-security-jpa-persistence-unit-name]] `quarkus.security-jpa.persistence-unit-name`

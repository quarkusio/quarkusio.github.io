:summaryTableId: quarkus-resteasy-server_quarkus-resteasy
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-singleton-resources]] [.property-path]##`quarkus.resteasy.singleton-resources`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-path]] [.property-path]##`quarkus.resteasy.path`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-ignore-application-classes]] [.property-path]##`quarkus.resteasy.ignore-application-classes`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-build-time-condition-aware]] [.property-path]##`quarkus.resteasy.build-time-condition-aware`##

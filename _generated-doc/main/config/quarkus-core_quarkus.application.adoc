...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-application-name]] `quarkus.application.name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-application-version]] `quarkus.application.version`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-application-ui-header]] `quarkus.application.ui-header`

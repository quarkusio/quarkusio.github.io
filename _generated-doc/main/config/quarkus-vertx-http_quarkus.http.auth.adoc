...
a| [[quarkus-vertx-http_quarkus-http-auth_quarkus-http-auth-form-redirect-after-login]] [.property-path]##link:#quarkus-vertx-http_quarkus-http-auth_quarkus-http-auth-form-redirect-after-login[[.line-through]#`quarkus.http.auth.form.redirect-after-login`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.http.auth.form.redirect-after-login+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated since `2.16`: redirect to landingPage can be disabled by removing default landing page (via `quarkus.http.auth.form.landing-page=`). Quarkus will ignore this configuration property if there is no landing page._

...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/opentelemetry/deployment/src/main/java/io/quarkus/opentelemetry/deployment/OpenTelemetryDriverJdbcDataSourcesBuildItem.java[`io.quarkus.opentelemetry.deployment.OpenTelemetryDriverJdbcDataSourcesBuildItem`, window="_blank"] :: +++Contains list of all  using OpenTelemetryDriver.+++
a| `List jdbcDataSources` :: +++<i>No Javadoc found</i>+++

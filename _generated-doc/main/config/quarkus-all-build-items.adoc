...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/CracDefaultValueBuildItem.java[`io.quarkus.deployment.builditem.CracDefaultValueBuildItem`, window="_blank"] :: +++Allows extensions to set default value for enabling CRAC+++
a| `boolean defaultValue` :: +++<i>No Javadoc found</i>+++

a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/CracEnabledBuildItem.java[`io.quarkus.deployment.builditem.CracEnabledBuildItem`, window="_blank"] :: +++Marker item to specify that CRAC is enabled+++
a| None

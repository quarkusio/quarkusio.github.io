...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-vertx-response-buffer-size]] `quarkus.resteasy.vertx.response-buffer-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-gzip-enabled]] `quarkus.resteasy.gzip.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-gzip-max-input]] `quarkus.resteasy.gzip.max-input`

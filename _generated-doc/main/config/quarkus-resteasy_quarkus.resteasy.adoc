...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-vertx-response-buffer-size]] [.property-path]##`quarkus.resteasy.vertx.response-buffer-size`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-gzip-enabled]] [.property-path]##`quarkus.resteasy.gzip.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-gzip-max-input]] [.property-path]##`quarkus.resteasy.gzip.max-input`##

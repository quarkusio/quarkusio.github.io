:summaryTableId: quarkus-reactive-mssql-client_quarkus-datasource
...
h|[[quarkus-reactive-mssql-client_section_quarkus-datasource]] Datasources
h|Type
h|Default

a| [[quarkus-reactive-mssql-client_quarkus-datasource-reactive-mssql-packet-size]] `quarkus.datasource.reactive.mssql.packet-size`
...
a| [[quarkus-reactive-mssql-client_quarkus-datasource-reactive-mssql-ssl]] `quarkus.datasource.reactive.mssql.ssl`

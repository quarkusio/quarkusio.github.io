...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer-config-group-config-netty-config-group_quarkus.micrometer.binder.netty.get-enabled]]`link:#quarkus-micrometer-config-group-config-netty-config-group_quarkus.micrometer.binder.netty.get-enabled[quarkus.micrometer.binder.netty.get-enabled]`

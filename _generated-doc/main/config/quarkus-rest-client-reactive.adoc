...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-reactive_quarkus-rest-client-provider-autodiscovery]]`link:#quarkus-rest-client-reactive_quarkus-rest-client-provider-autodiscovery[quarkus.rest-client.provider-autodiscovery]`

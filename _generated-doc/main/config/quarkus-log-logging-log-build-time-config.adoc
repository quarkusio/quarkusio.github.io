...
a|icon:lock[title=Fixed at build time] [[quarkus-log-logging-log-build-time-config_quarkus-log-decorate-stacktraces]]`link:#quarkus-log-logging-log-build-time-config_quarkus-log-decorate-stacktraces[quarkus.log.decorate-stacktraces]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes_quarkus-knative-externalize-init]] [.property-path]##link:#quarkus-kubernetes_quarkus-knative-externalize-init[[.line-through]#`quarkus.knative.externalize-init`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.knative.externalize-init+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KNATIVE_EXTERNALIZE_INIT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KNATIVE_EXTERNALIZE_INIT+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

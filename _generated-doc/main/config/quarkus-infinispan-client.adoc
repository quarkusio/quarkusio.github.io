...
a|icon:lock[title=Fixed at build time] [[quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.near-cache-max-entries]]`link:#quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.near-cache-max-entries[quarkus.infinispan-client."named-infinispan-clients".near-cache-max-entries]`
...
a| [[quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.auth-client-subject]]`link:#quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.auth-client-subject[quarkus.infinispan-client."named-infinispan-clients".auth-client-subject]`
...
a| [[quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.auth-callback-handler]]`link:#quarkus-infinispan-client_quarkus.infinispan-client.-named-infinispan-clients-.auth-callback-handler[quarkus.infinispan-client."named-infinispan-clients".auth-callback-handler]`

:summaryTableId: quarkus-quartz_quarkus-quartz
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-clustered]] [.property-path]##`quarkus.quartz.clustered`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-cluster-checkin-interval]] [.property-path]##`quarkus.quartz.cluster-checkin-interval`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-store-type]] [.property-path]##`quarkus.quartz.store-type`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-datasource]] [.property-path]##`quarkus.quartz.datasource`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-table-prefix]] [.property-path]##`quarkus.quartz.table-prefix`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-select-with-lock-sql]] [.property-path]##`quarkus.quartz.select-with-lock-sql`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-serialize-job-data]] [.property-path]##`quarkus.quartz.serialize-job-data`##
...
a| [[quarkus-quartz_quarkus-quartz-instance-name]] [.property-path]##`quarkus.quartz.instance-name`##
...
a| [[quarkus-quartz_quarkus-quartz-instance-id]] [.property-path]##`quarkus.quartz.instance-id`##
...
a| [[quarkus-quartz_quarkus-quartz-batch-trigger-acquisition-fire-ahead-time-window]] [.property-path]##`quarkus.quartz.batch-trigger-acquisition-fire-ahead-time-window`##
...
a| [[quarkus-quartz_quarkus-quartz-batch-trigger-acquisition-max-count]] [.property-path]##`quarkus.quartz.batch-trigger-acquisition-max-count`##
...
a| [[quarkus-quartz_quarkus-quartz-thread-count]] [.property-path]##`quarkus.quartz.thread-count`##
...
a| [[quarkus-quartz_quarkus-quartz-thread-priority]] [.property-path]##`quarkus.quartz.thread-priority`##
...
a| [[quarkus-quartz_quarkus-quartz-misfire-threshold]] [.property-path]##`quarkus.quartz.misfire-threshold`##
...
a| [[quarkus-quartz_quarkus-quartz-shutdown-wait-time]] [.property-path]##`quarkus.quartz.shutdown-wait-time`##
...
a| [[quarkus-quartz_quarkus-quartz-simple-trigger-misfire-policy]] [.property-path]##`quarkus.quartz.simple-trigger.misfire-policy`##
...
a| [[quarkus-quartz_quarkus-quartz-cron-trigger-misfire-policy]] [.property-path]##`quarkus.quartz.cron-trigger.misfire-policy`##
...
a| [[quarkus-quartz_quarkus-quartz-run-blocking-scheduled-method-on-quartz-thread]] [.property-path]##`quarkus.quartz.run-blocking-scheduled-method-on-quartz-thread`##
...
h|[[quarkus-quartz_section_quarkus-quartz-misfire-policy]] [.section-name.section-level0]##Misfire policy per job configuration##
h|Type
h|Default

a| [[quarkus-quartz_quarkus-quartz-misfire-policy-identity]] [.property-path]##`quarkus.quartz.misfire-policy."identity"`##
...
h|[[quarkus-quartz_section_quarkus-quartz-instance-id-generators]] [.section-name.section-level0]##Instance ID generators##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-instance-id-generators-generator-name-class]] [.property-path]##`quarkus.quartz.instance-id-generators."generator-name".class`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-instance-id-generators-generator-name-properties-property-key]] [.property-path]##`quarkus.quartz.instance-id-generators."generator-name".properties."property-key"`##
...
h|[[quarkus-quartz_section_quarkus-quartz-trigger-listeners]] [.section-name.section-level0]##Trigger listeners##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-trigger-listeners-listener-name-class]] [.property-path]##`quarkus.quartz.trigger-listeners."listener-name".class`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-trigger-listeners-listener-name-properties-property-key]] [.property-path]##`quarkus.quartz.trigger-listeners."listener-name".properties."property-key"`##
...
h|[[quarkus-quartz_section_quarkus-quartz-job-listeners]] [.section-name.section-level0]##Job listeners##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-job-listeners-listener-name-class]] [.property-path]##`quarkus.quartz.job-listeners."listener-name".class`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-job-listeners-listener-name-properties-property-key]] [.property-path]##`quarkus.quartz.job-listeners."listener-name".properties."property-key"`##
...
h|[[quarkus-quartz_section_quarkus-quartz-plugins]] [.section-name.section-level0]##Plugins##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-plugins-plugin-name-class]] [.property-path]##`quarkus.quartz.plugins."plugin-name".class`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-quartz_quarkus-quartz-plugins-plugin-name-properties-property-key]] [.property-path]##`quarkus.quartz.plugins."plugin-name".properties."property-key"`##

:summaryTableId: quarkus-core_quarkus-snapstart
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-enable]] [.property-path]##`quarkus.snapstart.enable`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-preload-classes]] [.property-path]##`quarkus.snapstart.preload-classes`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-initialize-classes]] [.property-path]##`quarkus.snapstart.initialize-classes`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-full-warmup]] [.property-path]##`quarkus.snapstart.full-warmup`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-generate-application-class-list]] [.property-path]##`quarkus.snapstart.generate-application-class-list`##

...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-enable]] `quarkus.snapstart.enable`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-preload-classes]] `quarkus.snapstart.preload-classes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-initialize-classes]] `quarkus.snapstart.initialize-classes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-full-warmup]] `quarkus.snapstart.full-warmup`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-snapstart-generate-application-class-list]] `quarkus.snapstart.generate-application-class-list`

...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc-client-filter_quarkus-resteasy-client-oidc-filter-register-filter]]`link:#quarkus-oidc-client-filter_quarkus-resteasy-client-oidc-filter-register-filter[quarkus.resteasy-client-oidc-filter.register-filter]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc-client-filter_quarkus-resteasy-client-oidc-filter-client-name]]`link:#quarkus-oidc-client-filter_quarkus-resteasy-client-oidc-filter-client-name[quarkus.resteasy-client-oidc-filter.client-name]`

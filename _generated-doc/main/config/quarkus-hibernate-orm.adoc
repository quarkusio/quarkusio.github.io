...
`link:#quarkus-hibernate-orm_quarkus-hibernate-orm-multitenant-schema-datasource[quarkus.hibernate-orm."persistence-unit-name".multitenant-schema-datasource]`

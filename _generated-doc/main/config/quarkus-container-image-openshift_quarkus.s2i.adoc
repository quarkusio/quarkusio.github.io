:summaryTableId: quarkus-container-image-openshift_quarkus-s2i
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-build-strategy]] `quarkus.s2i.build-strategy`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-base-jvm-image]] `quarkus.s2i.base-jvm-image`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-base-native-image]] `quarkus.s2i.base-native-image`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-jvm-arguments]] `quarkus.s2i.jvm-arguments`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-native-arguments]] `quarkus.s2i.native-arguments`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-jar-directory]] `quarkus.s2i.jar-directory`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-jar-file-name]] `quarkus.s2i.jar-file-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-native-binary-directory]] `quarkus.s2i.native-binary-directory`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-native-binary-file-name]] `quarkus.s2i.native-binary-file-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-container-image-openshift_quarkus-s2i-build-timeout]] `quarkus.s2i.build-timeout`

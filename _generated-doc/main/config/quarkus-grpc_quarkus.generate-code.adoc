:summaryTableId: quarkus-grpc_quarkus-generate-code
...
a|icon:lock[title=Fixed at build time] [[quarkus-grpc_quarkus-generate-code-grpc-scan-for-proto]] [.property-path]##`quarkus.generate-code.grpc.scan-for-proto`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-grpc_quarkus-generate-code-grpc-scan-for-imports]] [.property-path]##`quarkus.generate-code.grpc.scan-for-imports`##

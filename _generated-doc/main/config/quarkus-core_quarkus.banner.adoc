:summaryTableId: quarkus-core_quarkus-banner
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-banner-path]] `quarkus.banner.path`
...
a| [[quarkus-core_quarkus-banner-enabled]] `quarkus.banner.enabled`

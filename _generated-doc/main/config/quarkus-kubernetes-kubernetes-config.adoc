...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.init-task-defaults.wait-for-image]]`link:#quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.init-task-defaults.wait-for-image[quarkus.kubernetes.init-task-defaults.wait-for-image]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.init-tasks.-init-tasks-.wait-for-image]]`link:#quarkus-kubernetes-kubernetes-config_quarkus.kubernetes.init-tasks.-init-tasks-.wait-for-image[quarkus.kubernetes.init-tasks."init-tasks".wait-for-image]`

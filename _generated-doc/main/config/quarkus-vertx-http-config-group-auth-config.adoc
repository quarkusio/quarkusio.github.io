...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.cookie-path]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.cookie-path[quarkus.http.auth.form.cookie-path]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.http-only-cookie]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.http-only-cookie[quarkus.http.auth.form.http-only-cookie]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.cookie-same-site]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.form.cookie-same-site[quarkus.http.auth.form.cookie-same-site]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.policy.-role-policy-.permissions-role1]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.policy.-role-policy-.permissions-role1[quarkus.http.auth.policy."role-policy".permissions]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.policy.-role-policy-.permission-class]]`link:#quarkus-vertx-http-config-group-auth-config_quarkus.http.auth.policy.-role-policy-.permission-class[quarkus.http.auth.policy."role-policy".permission-class]`

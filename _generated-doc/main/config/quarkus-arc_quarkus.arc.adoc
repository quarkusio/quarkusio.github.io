:summaryTableId: quarkus-arc_quarkus-arc
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-remove-unused-beans]] `quarkus.arc.remove-unused-beans`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-auto-inject-fields]] `quarkus.arc.auto-inject-fields`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-transform-unproxyable-classes]] `quarkus.arc.transform-unproxyable-classes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-transform-private-injected-fields]] `quarkus.arc.transform-private-injected-fields`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-fail-on-intercepted-private-method]] `quarkus.arc.fail-on-intercepted-private-method`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-selected-alternatives]] `quarkus.arc.selected-alternatives`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-auto-producer-methods]] `quarkus.arc.auto-producer-methods`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-exclude-types]] `quarkus.arc.exclude-types`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-unremovable-types]] `quarkus.arc.unremovable-types`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-exclude-dependency-dependency-name]] `quarkus.arc.exclude-dependency."dependency-name"`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ARC_EXCLUDE_DEPENDENCY__DEPENDENCY_NAME_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-detect-unused-false-positives]] `quarkus.arc.detect-unused-false-positives`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-detect-wrong-annotations]] `quarkus.arc.detect-wrong-annotations`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-strict-compatibility]] `quarkus.arc.strict-compatibility`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-dev-mode-monitoring-enabled]] `quarkus.arc.dev-mode.monitoring-enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-dev-mode-generate-dependency-graphs]] `quarkus.arc.dev-mode.generate-dependency-graphs`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-test-disable-application-lifecycle-observers]] `quarkus.arc.test.disable-application-lifecycle-observers`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-ignored-split-packages]] `quarkus.arc.ignored-split-packages`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc_quarkus-arc-context-propagation-enabled]] `quarkus.arc.context-propagation.enabled`

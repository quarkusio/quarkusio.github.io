:summaryTableId: quarkus-messaging-amqp_quarkus-amqp-devservices
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-enabled]] [.property-path]##`quarkus.amqp.devservices.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-port]] [.property-path]##`quarkus.amqp.devservices.port`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-image-name]] [.property-path]##`quarkus.amqp.devservices.image-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-extra-args]] [.property-path]##`quarkus.amqp.devservices.extra-args`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-shared]] [.property-path]##`quarkus.amqp.devservices.shared`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-service-name]] [.property-path]##`quarkus.amqp.devservices.service-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-messaging-amqp_quarkus-amqp-devservices_quarkus-amqp-devservices-container-env-environment-variable-name]] [.property-path]##`quarkus.amqp.devservices.container-env."environment-variable-name"`##

...
a|icon:lock[title=Fixed at build time] [[quarkus-native-pkg-native-config_quarkus-native-enabled]]`link:#quarkus-native-pkg-native-config_quarkus-native-enabled[quarkus.native.enabled]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-native-pkg-native-config_quarkus-native-sources-only]]`link:#quarkus-native-pkg-native-config_quarkus-native-sources-only[quarkus.native.sources-only]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-native-pkg-native-config_quarkus-native-march]]`link:#quarkus-native-pkg-native-config_quarkus-native-march[quarkus.native.march]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-native-pkg-native-config_quarkus-native-builder-image-pull]]`link:#quarkus-native-pkg-native-config_quarkus-native-builder-image-pull[quarkus.native.builder-image.pull]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-native-pkg-native-config_quarkus-native-agent-configuration-apply]]`link:#quarkus-native-pkg-native-config_quarkus-native-agent-configuration-apply[quarkus.native.agent-configuration-apply]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-http-additional-methods]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-http-additional-methods[`+++quarkus.micrometer.binder.http.additional-methods+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.http.additional-methods+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_HTTP_ADDITIONAL_METHODS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-server-histogram]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-server-histogram[`+++quarkus.micrometer.binder.grpc-server.histogram+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-server.histogram+++[]
endif::add-copy-button-to-config-props[]
...
Disabled by default because histograms increase memory usage and metric cardinality. When enabled, Micrometer's default percentile histogram buckets are published (suitable for `histogram_quantile` in Prometheus). Optional SLO boundaries can be added via `slos()`, and the published bucket range can be clamped via `minimum-expected-value()` / `maximum-expected-value()`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_HISTOGRAM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_HISTOGRAM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-server-slos]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-server-slos[`+++quarkus.micrometer.binder.grpc-server.slos+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-server.slos+++[]
endif::add-copy-button-to-config-props[]
...
Only applied when `histogram()` is `true`. When unset, Micrometer's default percentile histogram buckets are used. When set, these SLO boundaries are added to that histogram.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_SLOS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_SLOS+++`
endif::add-copy-button-to-env-var[]
--
|list of link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration]
|

a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-server-minimum-expected-value]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-server-minimum-expected-value[`+++quarkus.micrometer.binder.grpc-server.minimum-expected-value+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-server.minimum-expected-value+++[]
endif::add-copy-button-to-config-props[]
...
Only applied when `histogram()` is `true`. Sets a lower bound on which Micrometer percentile-histogram buckets are published. When unset, Micrometer's timer default (`1ms`) is used.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_MINIMUM_EXPECTED_VALUE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_MINIMUM_EXPECTED_VALUE+++`
endif::add-copy-button-to-env-var[]
--
...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-server-maximum-expected-value]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-server-maximum-expected-value[`+++quarkus.micrometer.binder.grpc-server.maximum-expected-value+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-server.maximum-expected-value+++[]
endif::add-copy-button-to-config-props[]
...
Only applied when `histogram()` is `true`. Sets an upper bound on which Micrometer percentile-histogram buckets are published. Narrowing this value reduces metric cardinality. When unset, Micrometer's timer default (`30s`) is used.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_MAXIMUM_EXPECTED_VALUE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_SERVER_MAXIMUM_EXPECTED_VALUE+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-micrometer_quarkus-micrometer[icon:question-circle[title=More information about the Duration format]]
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-client-histogram]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-client-histogram[`+++quarkus.micrometer.binder.grpc-client.histogram+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-client.histogram+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_HISTOGRAM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_HISTOGRAM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-client-slos]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-client-slos[`+++quarkus.micrometer.binder.grpc-client.slos+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-client.slos+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_SLOS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_SLOS+++`
endif::add-copy-button-to-env-var[]
--
|list of link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration]
|

a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-client-minimum-expected-value]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-client-minimum-expected-value[`+++quarkus.micrometer.binder.grpc-client.minimum-expected-value+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-client.minimum-expected-value+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_MINIMUM_EXPECTED_VALUE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_MINIMUM_EXPECTED_VALUE+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-micrometer_quarkus-micrometer[icon:question-circle[title=More information about the Duration format]]
|

a|icon:lock[title=Fixed at build time] [[quarkus-micrometer_quarkus-micrometer-binder-grpc-client-maximum-expected-value]] [.property-path]##link:#quarkus-micrometer_quarkus-micrometer-binder-grpc-client-maximum-expected-value[`+++quarkus.micrometer.binder.grpc-client.maximum-expected-value+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.micrometer.binder.grpc-client.maximum-expected-value+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_MAXIMUM_EXPECTED_VALUE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MICROMETER_BINDER_GRPC_CLIENT_MAXIMUM_EXPECTED_VALUE+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-micrometer_quarkus-micrometer[icon:question-circle[title=More information about the Duration format]]
|

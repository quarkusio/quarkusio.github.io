...
a| [[quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-alias]]`link:#quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-alias[quarkus.management.ssl.certificate.key-store-key-alias]`
...
a| [[quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-password]]`link:#quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-password[quarkus.management.ssl.certificate.key-store-key-password]`
...
a| [[quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-password-key]]`link:#quarkus-vertx-http-config-group-certificate-config_quarkus.management.ssl.certificate.key-store-key-password-key[quarkus.management.ssl.certificate.key-store-key-password-key]`

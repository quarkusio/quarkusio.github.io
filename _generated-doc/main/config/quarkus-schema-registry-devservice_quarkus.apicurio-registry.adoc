...
h|[[quarkus-schema-registry-devservice_section_quarkus-apicurio-registry-devservices]] Dev Services

Dev Services allows Quarkus to automatically start Apicurio Registry in dev and test mode
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-enabled]] `quarkus.apicurio-registry.devservices.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-port]] `quarkus.apicurio-registry.devservices.port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-image-name]] `quarkus.apicurio-registry.devservices.image-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-shared]] `quarkus.apicurio-registry.devservices.shared`
...
a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-service-name]] `quarkus.apicurio-registry.devservices.service-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-schema-registry-devservice_quarkus-apicurio-registry-devservices-container-env-environment-variable-name]] `quarkus.apicurio-registry.devservices.container-env."environment-variable-name"`

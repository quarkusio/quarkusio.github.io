:summaryTableId: quarkus-funqy-knative-events_quarkus-funqy
...
a| [[quarkus-funqy-knative-events_quarkus-funqy-knative-events-mapping-mapping-trigger]] `quarkus.funqy.knative-events.mapping."mapping".trigger`
...
a| [[quarkus-funqy-knative-events_quarkus-funqy-knative-events-mapping-mapping-response-type]] `quarkus.funqy.knative-events.mapping."mapping".response-type`
...
a| [[quarkus-funqy-knative-events_quarkus-funqy-knative-events-mapping-mapping-response-source]] `quarkus.funqy.knative-events.mapping."mapping".response-source`

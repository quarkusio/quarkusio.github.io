...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.stork.enabled]]`link:#quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.stork.enabled[quarkus.micrometer.binder.stork.enabled]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.messaging.enabled]]`link:#quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.messaging.enabled[quarkus.micrometer.binder.messaging.enabled]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.netty.enabled]]`link:#quarkus-micrometer-config-group-config-micrometer-config-binder-config_quarkus.micrometer.binder.netty.enabled[quarkus.micrometer.binder.netty.enabled]`

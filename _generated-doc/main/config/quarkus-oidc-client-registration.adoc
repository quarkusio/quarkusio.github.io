...
a| [[quarkus-oidc-client-registration_quarkus-oidc-client-registration-discovery-path]] [.property-path]##link:#quarkus-oidc-client-registration_quarkus-oidc-client-registration-discovery-path[`quarkus.oidc-client-registration.discovery-path`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client-registration.discovery-path+++[]
endif::add-copy-button-to-config-props[]


`quarkus.oidc-client-registration."id".discovery-path`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.oidc-client-registration."id".discovery-path+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OIDC_CLIENT_REGISTRATION_DISCOVERY_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OIDC_CLIENT_REGISTRATION_DISCOVERY_PATH+++`
endif::add-copy-button-to-env-var[]
--
|string

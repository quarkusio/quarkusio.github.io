...
a|icon:lock[title=Fixed at build time] [[quarkus-openshift-openshift-config_quarkus.openshift.init-task-defaults.wait-for-image]]`link:#quarkus-openshift-openshift-config_quarkus.openshift.init-task-defaults.wait-for-image[quarkus.openshift.init-task-defaults.wait-for-image]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-openshift-openshift-config_quarkus.openshift.init-tasks.-init-tasks-.wait-for-image]]`link:#quarkus-openshift-openshift-config_quarkus.openshift.init-tasks.-init-tasks-.wait-for-image[quarkus.openshift.init-tasks."init-tasks".wait-for-image]`

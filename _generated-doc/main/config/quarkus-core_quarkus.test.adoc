...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-continuous-testing]] `quarkus.test.continuous-testing`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-display-test-output]] `quarkus.test.display-test-output`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-include-tags]] `quarkus.test.include-tags`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-exclude-tags]] `quarkus.test.exclude-tags`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-include-pattern]] `quarkus.test.include-pattern`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-exclude-pattern]] `quarkus.test.exclude-pattern`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-include-engines]] `quarkus.test.include-engines`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-exclude-engines]] `quarkus.test.exclude-engines`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-flat-class-path]] `quarkus.test.flat-class-path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-native-image-profile]] `quarkus.test.native-image-profile`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-integration-test-profile]] `quarkus.test.integration-test-profile`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-profile]] `quarkus.test.profile`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-profile-tags]] `quarkus.test.profile.tags`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-container-network]] `quarkus.test.container.network`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-container-additional-exposed-ports-host-port]] `quarkus.test.container.additional-exposed-ports."host-port"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-container-labels-label-name]] `quarkus.test.container.labels."label-name"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-container-volume-mounts-host-path]] `quarkus.test.container.volume-mounts."host-path"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-arg-line]] `quarkus.test.arg-line`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-env-environment-variable-name]] `quarkus.test.env."environment-variable-name"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-wait-time]] `quarkus.test.wait-time`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-hang-detection-timeout]] `quarkus.test.hang-detection-timeout`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-type]] `quarkus.test.type`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-only-test-application-module]] `quarkus.test.only-test-application-module`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-include-module-pattern]] `quarkus.test.include-module-pattern`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-exclude-module-pattern]] `quarkus.test.exclude-module-pattern`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-test-enable-callbacks-for-integration-tests]] `quarkus.test.enable-callbacks-for-integration-tests`

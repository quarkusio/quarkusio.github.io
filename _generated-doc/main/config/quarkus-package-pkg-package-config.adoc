...
a|icon:lock[title=Fixed at build time] [[quarkus-package-pkg-package-config_quarkus-package-decompiler-enabled]]`link:#quarkus-package-pkg-package-config_quarkus-package-decompiler-enabled[quarkus.package.decompiler.enabled]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-package-pkg-package-config_quarkus-package-decompiler-jar-directory]]`link:#quarkus-package-pkg-package-config_quarkus-package-decompiler-jar-directory[quarkus.package.decompiler.jar-directory]`

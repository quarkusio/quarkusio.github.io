:summaryTableId: quarkus-oidc-client-graphql_quarkus-oidc-client-graphql
...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc-client-graphql_quarkus-oidc-client-graphql-client-name]] `quarkus.oidc-client-graphql.client-name`

...
a| [[quarkus-restclient-config-rest-client-config_quarkus.rest-client.-config-key-.multipart.max-chunk-size]]`link:#quarkus-restclient-config-rest-client-config_quarkus.rest-client.-config-key-.multipart.max-chunk-size[quarkus.rest-client."config-key".multipart.max-chunk-size]`

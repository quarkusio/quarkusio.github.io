...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-health_quarkus-smallrye-health-enabled]] `quarkus.smallrye-health.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-health_quarkus-smallrye-health-extensions-enabled]] `quarkus.smallrye-health.extensions.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-health_quarkus-smallrye-health-openapi-included]] `quarkus.smallrye-health.openapi.included`

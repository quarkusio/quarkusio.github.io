...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus.info.build.additional-properties-additional-properties]]`link:#quarkus-info_quarkus.info.build.additional-properties-additional-properties[quarkus.info.build.additional-properties]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-build-property-key]]`link:#quarkus-info_quarkus-info-build-property-key[quarkus.info.build."property-key"]`

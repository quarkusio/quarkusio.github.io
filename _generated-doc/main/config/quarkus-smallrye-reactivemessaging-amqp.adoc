...
:summaryTableId: quarkus-smallrye-reactivemessaging-amqp
...
--|string 
|`quay.io/artemiscloud/activemq-artemis-broker:1.0.22`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-reactivemessaging-amqp_quarkus.amqp.devservices.container-env-container-env]]`link:#quarkus-smallrye-reactivemessaging-amqp_quarkus.amqp.devservices.container-env-container-env[quarkus.amqp.devservices.container-env]`

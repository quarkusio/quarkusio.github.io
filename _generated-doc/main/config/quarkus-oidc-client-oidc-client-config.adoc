...
a| [[quarkus-oidc-client-oidc-client-config_quarkus-oidc-client-credentials-jwt-claims-claims]]`link:#quarkus-oidc-client-oidc-client-config_quarkus-oidc-client-credentials-jwt-claims-claims[quarkus.oidc-client.credentials.jwt.claims]`
...
a| [[quarkus-oidc-client-oidc-client-config_quarkus-oidc-client-id-credentials-jwt-claims-claims]]`link:#quarkus-oidc-client-oidc-client-config_quarkus-oidc-client-id-credentials-jwt-claims-claims[quarkus.oidc-client."id".credentials.jwt.claims]`

:summaryTableId: quarkus-spring-boot-properties_quarkus-spring-boot-properties
...
a|icon:lock[title=Fixed at build time] [[quarkus-spring-boot-properties_quarkus-spring-boot-properties-configuration-properties-naming-strategy]] `quarkus.spring-boot-properties.configuration-properties-naming-strategy`

...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-console-enabled]] `quarkus.console.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-console-disable-input]] `quarkus.console.disable-input`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-console-basic]] `quarkus.console.basic`
...
a| [[quarkus-core_quarkus-console-color]] `quarkus.console.color`

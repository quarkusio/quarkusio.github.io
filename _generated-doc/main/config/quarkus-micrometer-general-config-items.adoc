...
a|icon:lock[title=Fixed at build time] [[quarkus-micrometer-general-config-items_quarkus.micrometer.binder.netty.get-enabled]]`link:#quarkus-micrometer-general-config-items_quarkus.micrometer.binder.netty.get-enabled[quarkus.micrometer.binder.netty.get-enabled]`

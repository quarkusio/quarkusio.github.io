...
a|icon:lock[title=Fixed at build time] [[quarkus-netty_quarkus-netty-allocator-max-order]] [.property-path]##link:#quarkus-netty_quarkus-netty-allocator-max-order[`quarkus.netty.allocator-max-order`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.netty.allocator-max-order+++[]

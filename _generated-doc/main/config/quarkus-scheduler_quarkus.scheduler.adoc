:summaryTableId: quarkus-scheduler_quarkus-scheduler
...
a|icon:lock[title=Fixed at build time] [[quarkus-scheduler_quarkus-scheduler-cron-type]] `quarkus.scheduler.cron-type`
...
a|icon:lock[title=Fixed at build time] [[quarkus-scheduler_quarkus-scheduler-metrics-enabled]] `quarkus.scheduler.metrics.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-scheduler_quarkus-scheduler-tracing-enabled]] `quarkus.scheduler.tracing.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-scheduler_quarkus-scheduler-use-composite-scheduler]] `quarkus.scheduler.use-composite-scheduler`
...
a| [[quarkus-scheduler_quarkus-scheduler-enabled]] `quarkus.scheduler.enabled`
...
a| [[quarkus-scheduler_quarkus-scheduler-overdue-grace-period]] `quarkus.scheduler.overdue-grace-period`
...
a| [[quarkus-scheduler_quarkus-scheduler-start-mode]] `quarkus.scheduler.start-mode`

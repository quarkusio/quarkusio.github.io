:summaryTableId: quarkus-core_quarkus-platform
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-platform-group-id]] `quarkus.platform.group-id`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-platform-artifact-id]] `quarkus.platform.artifact-id`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-platform-version]] `quarkus.platform.version`

:summaryTableId: quarkus-websockets-client_quarkus-websocket
...
a|icon:lock[title=Fixed at build time] [[quarkus-websockets-client_quarkus-websocket-max-frame-size]] `quarkus.websocket.max-frame-size`
...
a|icon:lock[title=Fixed at build time] [[quarkus-websockets-client_quarkus-websocket-dispatch-to-worker]] `quarkus.websocket.dispatch-to-worker`

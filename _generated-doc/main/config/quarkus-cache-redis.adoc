...
a| [[quarkus-cache-redis_quarkus.cache.redis.ttl]]`link:#quarkus-cache-redis_quarkus.cache.redis.ttl[quarkus.cache.redis.ttl]`
...
a| [[quarkus-cache-redis_quarkus.cache.redis.-cache-name-.ttl]]`link:#quarkus-cache-redis_quarkus.cache.redis.-cache-name-.ttl[quarkus.cache.redis."cache-name".ttl]`

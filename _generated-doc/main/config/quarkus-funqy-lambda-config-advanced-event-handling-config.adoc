...
:summaryTableId: quarkus-funqy-lambda-config-advanced-event-handling-config
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference, cols="80,.^10,.^10"]
|===

h|[[quarkus-funqy-lambda-config-advanced-event-handling-config_configuration]]link:#quarkus-funqy-lambda-config-advanced-event-handling-config_configuration[Configuration property]

h|Type
h|Default

a| [[quarkus-funqy-lambda-config-advanced-event-handling-config_quarkus-funqy-amazon-lambda-advanced-event-handling-sqs-report-batch-item-failures]]`link:#quarkus-funqy-lambda-config-advanced-event-handling-config_quarkus-funqy-amazon-lambda-advanced-event-handling-sqs-report-batch-item-failures[quarkus.funqy.amazon-lambda.advanced-event-handling.sqs.report-batch-item-failures]`

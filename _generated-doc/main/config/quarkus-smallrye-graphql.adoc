...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-graphql_quarkus-smallrye-graphql-federation-batch-resolving-enabled]]`link:#quarkus-smallrye-graphql_quarkus-smallrye-graphql-federation-batch-resolving-enabled[quarkus.smallrye-graphql.federation.batch-resolving-enabled]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-graphql_quarkus-smallrye-graphql-extra-scalars]]`link:#quarkus-smallrye-graphql_quarkus-smallrye-graphql-extra-scalars[quarkus.smallrye-graphql.extra-scalars]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-graphql_quarkus-smallrye-graphql-exclude-null-fields-in-responses]]`link:#quarkus-smallrye-graphql_quarkus-smallrye-graphql-exclude-null-fields-in-responses[quarkus.smallrye-graphql.exclude-null-fields-in-responses]`

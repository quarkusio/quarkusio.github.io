...
a|icon:lock[title=Fixed at build time] [[quarkus-azure-functions_quarkus-azure-functions-app-settings-setting-name]]`link:#quarkus-azure-functions_quarkus-azure-functions-app-settings-setting-name[quarkus.azure-functions.app-settings."setting-name"]`

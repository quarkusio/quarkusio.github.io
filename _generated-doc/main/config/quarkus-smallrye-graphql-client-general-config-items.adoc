...
a| [[quarkus-smallrye-graphql-client-general-config-items_quarkus.smallrye-graphql-client.-clients-.init-payload-init-payload]]`link:#quarkus-smallrye-graphql-client-general-config-items_quarkus.smallrye-graphql-client.-clients-.init-payload-init-payload[quarkus.smallrye-graphql-client."clients".init-payload]`

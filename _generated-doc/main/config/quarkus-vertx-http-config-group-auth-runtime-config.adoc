...
a| [[quarkus-vertx-http-config-group-auth-runtime-config_quarkus-http-auth-policy-role-policy-roles-role1]]`link:#quarkus-vertx-http-config-group-auth-runtime-config_quarkus-http-auth-policy-role-policy-roles-role1[quarkus.http.auth.policy."role-policy".roles]`
...
a| [[quarkus-vertx-http-config-group-auth-runtime-config_quarkus-http-auth-roles-mapping-role1]]`link:#quarkus-vertx-http-config-group-auth-runtime-config_quarkus-http-auth-roles-mapping-role1[quarkus.http.auth.roles-mapping]`

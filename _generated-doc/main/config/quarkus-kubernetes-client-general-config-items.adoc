...
h|[[quarkus-kubernetes-client-general-config-items_configuration]]link:#quarkus-kubernetes-client-general-config-items_configuration[Configuration property]

...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-health-enabled]] `quarkus.datasource.health.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-metrics-enabled]] `quarkus.datasource.metrics.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-db-kind]] `quarkus.datasource.db-kind`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-db-version]] `quarkus.datasource.db-version`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-health-exclude]] `quarkus.datasource.health-exclude`
...
a| [[quarkus-datasource_quarkus-datasource-active]] `quarkus.datasource.active`
...
a| [[quarkus-datasource_quarkus-datasource-username]] `quarkus.datasource.username`
...
a| [[quarkus-datasource_quarkus-datasource-password]] `quarkus.datasource.password`
...
a| [[quarkus-datasource_quarkus-datasource-credentials-provider]] `quarkus.datasource.credentials-provider`
...
a| [[quarkus-datasource_quarkus-datasource-credentials-provider-name]] `quarkus.datasource.credentials-provider-name`
...
h|[[quarkus-datasource_section_quarkus-datasource-devservices]] Dev Services
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-enabled]] `quarkus.datasource.devservices.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-image-name]] `quarkus.datasource.devservices.image-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-container-env-environment-variable-name]] `quarkus.datasource.devservices.container-env."environment-variable-name"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-container-properties-property-key]] `quarkus.datasource.devservices.container-properties."property-key"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-properties-property-key]] `quarkus.datasource.devservices.properties."property-key"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-port]] `quarkus.datasource.devservices.port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-command]] `quarkus.datasource.devservices.command`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-db-name]] `quarkus.datasource.devservices.db-name`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-username]] `quarkus.datasource.devservices.username`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-password]] `quarkus.datasource.devservices.password`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-init-script-path]] `quarkus.datasource.devservices.init-script-path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-volumes-host-path]] `quarkus.datasource.devservices.volumes."host-path"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource_quarkus-datasource-devservices-reuse]] `quarkus.datasource.devservices.reuse`

...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-reactive-kotlin-serialization-general-config-items_quarkus-kotlin-serialization-json-allow-comments]]`link:#quarkus-resteasy-reactive-kotlin-serialization-general-config-items_quarkus-kotlin-serialization-json-allow-comments[quarkus.kotlin-serialization.json.allow-comments]`

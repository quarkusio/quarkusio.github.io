...
a|icon:lock[title=Fixed at build time] [[quarkus-rest-client-oidc-filter_quarkus-rest-client-oidc-filter-client-name]] `quarkus.rest-client-oidc-filter.client-name`

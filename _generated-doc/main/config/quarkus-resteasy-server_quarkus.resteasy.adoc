...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-singleton-resources]] `quarkus.resteasy.singleton-resources`
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-path]] `quarkus.resteasy.path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-ignore-application-classes]] `quarkus.resteasy.ignore-application-classes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server_quarkus-resteasy-build-time-condition-aware]] `quarkus.resteasy.build-time-condition-aware`

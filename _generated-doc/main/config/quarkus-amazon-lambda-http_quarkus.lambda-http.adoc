...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-lambda-http_quarkus-lambda-http-enable-security]] `quarkus.lambda-http.enable-security`
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-map-cognito-to-roles]] `quarkus.lambda-http.map-cognito-to-roles`
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-cognito-role-claim]] `quarkus.lambda-http.cognito-role-claim`
...
a| [[quarkus-amazon-lambda-http_quarkus-lambda-http-cognito-claim-matcher]] `quarkus.lambda-http.cognito-claim-matcher`

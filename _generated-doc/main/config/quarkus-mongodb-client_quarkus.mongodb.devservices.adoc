:summaryTableId: quarkus-mongodb-client_quarkus-mongodb-devservices
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-enabled]] [.property-path]##`quarkus.mongodb.devservices.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-image-name]] [.property-path]##`quarkus.mongodb.devservices.image-name`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-port]] [.property-path]##`quarkus.mongodb.devservices.port`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-properties-property-key]] [.property-path]##`quarkus.mongodb.devservices.properties."property-key"`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-container-env-environment-variable-name]] [.property-path]##`quarkus.mongodb.devservices.container-env."environment-variable-name"`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-shared]] [.property-path]##`quarkus.mongodb.devservices.shared`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-mongodb-client_quarkus-mongodb-devservices_quarkus-mongodb-devservices-service-name]] [.property-path]##`quarkus.mongodb.devservices.service-name`##

...
a| [[quarkus-flyway_quarkus.flyway.run-and-exit]]`link:#quarkus-flyway_quarkus.flyway.run-and-exit[quarkus.flyway.run-and-exit]`
...
a| [[quarkus-flyway_quarkus.flyway.-named-data-sources-.run-and-exit]]`link:#quarkus-flyway_quarkus.flyway.-named-data-sources-.run-and-exit[quarkus.flyway."named-data-sources".run-and-exit]`

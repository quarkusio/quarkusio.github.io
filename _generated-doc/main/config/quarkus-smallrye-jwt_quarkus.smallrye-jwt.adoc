:summaryTableId: quarkus-smallrye-jwt_quarkus-smallrye-jwt
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-jwt_quarkus-smallrye-jwt-enabled]] `quarkus.smallrye-jwt.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-jwt_quarkus-smallrye-jwt-rsa-sig-provider]] `quarkus.smallrye-jwt.rsa-sig-provider`
...
a| [[quarkus-smallrye-jwt_quarkus-smallrye-jwt-blocking-authentication]] `quarkus.smallrye-jwt.blocking-authentication`
...
a| [[quarkus-smallrye-jwt_quarkus-smallrye-jwt-silent]] `quarkus.smallrye-jwt.silent`

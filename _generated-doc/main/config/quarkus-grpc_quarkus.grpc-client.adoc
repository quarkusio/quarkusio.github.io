:summaryTableId: quarkus-grpc_quarkus-grpc-client
...
a|icon:lock[title=Fixed at build time] [[quarkus-grpc_quarkus-grpc-client-stork-proactive-connections]] `quarkus.grpc-client.stork-proactive-connections`

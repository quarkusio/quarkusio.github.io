:summaryTableId: quarkus-resteasy_quarkus-resteasy-json
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy_quarkus-resteasy-json-json-default]] `quarkus.resteasy-json.json-default`

...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource-config-group-data-source-runtime-config_quarkus.datasource.devservices.reuse]]`link:#quarkus-datasource-config-group-data-source-runtime-config_quarkus.datasource.devservices.reuse[quarkus.datasource.devservices.reuse]`

`link:#quarkus-datasource-config-group-data-source-runtime-config_quarkus.datasource.devservices.reuse[quarkus.datasource."datasource-name".devservices.reuse]`

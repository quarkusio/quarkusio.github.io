...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-enabled]] `quarkus.live-reload.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-instrumentation]] `quarkus.live-reload.instrumentation`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-watched-resources]] `quarkus.live-reload.watched-resources`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-password]] `quarkus.live-reload.password`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-url]] `quarkus.live-reload.url`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-connect-timeout]] `quarkus.live-reload.connect-timeout`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-retry-interval]] `quarkus.live-reload.retry-interval`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-live-reload-retry-max-attempts]] `quarkus.live-reload.retry-max-attempts`

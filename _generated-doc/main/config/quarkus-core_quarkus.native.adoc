:summaryTableId: quarkus-core_quarkus-native
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enabled]] `quarkus.native.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-sources-only]] `quarkus.native.sources-only`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-additional-build-args]] `quarkus.native.additional-build-args`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-http-url-handler]] `quarkus.native.enable-http-url-handler`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-https-url-handler]] `quarkus.native.enable-https-url-handler`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-headless]] `quarkus.native.headless`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-file-encoding]] `quarkus.native.file-encoding`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-add-all-charsets]] `quarkus.native.add-all-charsets`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-graalvm-home]] `quarkus.native.graalvm-home`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-java-home]] `quarkus.native.java-home`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-native-image-xmx]] `quarkus.native.native-image-xmx`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-debug-build-process]] `quarkus.native.debug-build-process`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-publish-debug-build-process-port]] `quarkus.native.publish-debug-build-process-port`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-isolates]] `quarkus.native.enable-isolates`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-fallback-images]] `quarkus.native.enable-fallback-images`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-auto-service-loader-registration]] `quarkus.native.auto-service-loader-registration`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-dump-proxies]] `quarkus.native.dump-proxies`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-container-build]] `quarkus.native.container-build`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-pie]] `quarkus.native.pie`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-march]] `quarkus.native.march`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-remote-container-build]] `quarkus.native.remote-container-build`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-builder-image]] `quarkus.native.builder-image`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-builder-image-pull]] `quarkus.native.builder-image.pull`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-container-runtime]] `quarkus.native.container-runtime`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-container-runtime-options]] `quarkus.native.container-runtime-options`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-monitoring]] `quarkus.native.monitoring`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-reports]] `quarkus.native.enable-reports`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-report-exception-stack-traces]] `quarkus.native.report-exception-stack-traces`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-report-errors-at-runtime]] `quarkus.native.report-errors-at-runtime`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-reuse-existing]] `quarkus.native.reuse-existing`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-resources-includes]] `quarkus.native.resources.includes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-resources-excludes]] `quarkus.native.resources.excludes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-debug-enabled]] `quarkus.native.debug.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-enable-dashboard-dump]] `quarkus.native.enable-dashboard-dump`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-compression-level]] `quarkus.native.compression.level`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-compression-additional-args]] `quarkus.native.compression.additional-args`
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-native-agent-configuration-apply]] `quarkus.native.agent-configuration-apply`

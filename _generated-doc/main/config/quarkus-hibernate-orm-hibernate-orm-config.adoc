...
`link:#quarkus-hibernate-orm-hibernate-orm-config_quarkus-hibernate-orm-multitenant-schema-datasource[quarkus.hibernate-orm."persistence-unit-name".multitenant-schema-datasource]`

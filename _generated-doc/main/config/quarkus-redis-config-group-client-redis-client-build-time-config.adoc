...
:summaryTableId: quarkus-redis-config-group-client-redis-client-build-time-config
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference, cols="80,.^10,.^10"]
|===

h|[[quarkus-redis-config-group-client-redis-client-build-time-config_configuration]]link:#quarkus-redis-config-group-client-redis-client-build-time-config_configuration[Configuration property]

h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.load-script]]`link:#quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.load-script[quarkus.redis.load-script]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.flush-before-load]]`link:#quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.flush-before-load[quarkus.redis.flush-before-load]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.load-only-if-empty]]`link:#quarkus-redis-config-group-client-redis-client-build-time-config_quarkus.redis.load-only-if-empty[quarkus.redis.load-only-if-empty]`

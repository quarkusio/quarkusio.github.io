:summaryTableId: quarkus-jacoco_quarkus-jacoco
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-enabled]] `quarkus.jacoco.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-data-file]] `quarkus.jacoco.data-file`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-reuse-data-file]] `quarkus.jacoco.reuse-data-file`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-report]] `quarkus.jacoco.report`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-output-encoding]] `quarkus.jacoco.output-encoding`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-title]] `quarkus.jacoco.title`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-footer]] `quarkus.jacoco.footer`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-source-encoding]] `quarkus.jacoco.source-encoding`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-includes]] `quarkus.jacoco.includes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-excludes]] `quarkus.jacoco.excludes`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jacoco_quarkus-jacoco-report-location]] `quarkus.jacoco.report-location`

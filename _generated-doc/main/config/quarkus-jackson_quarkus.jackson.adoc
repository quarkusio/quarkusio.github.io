:summaryTableId: quarkus-jackson_quarkus-jackson
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-fail-on-unknown-properties]] `quarkus.jackson.fail-on-unknown-properties`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-fail-on-empty-beans]] `quarkus.jackson.fail-on-empty-beans`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-write-dates-as-timestamps]] `quarkus.jackson.write-dates-as-timestamps`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-write-durations-as-timestamps]] `quarkus.jackson.write-durations-as-timestamps`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-accept-case-insensitive-enums]] `quarkus.jackson.accept-case-insensitive-enums`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-timezone]] `quarkus.jackson.timezone`
...
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java/time/ZoneId.html[ZoneId]
|`UTC`

a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-serialization-inclusion]] `quarkus.jackson.serialization-inclusion`
...
a|icon:lock[title=Fixed at build time] [[quarkus-jackson_quarkus-jackson-property-naming-strategy]] `quarkus.jackson.property-naming-strategy`

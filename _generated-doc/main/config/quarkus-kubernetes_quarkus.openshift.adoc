...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openshift.init-tasks."init-tasks".enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openshift.init-tasks."init-tasks".wait-for-container.image+++[]
endif::add-copy-button-to-config-props[]

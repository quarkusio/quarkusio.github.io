:summaryTableId: quarkus-info_quarkus-info
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-enabled]] `quarkus.info.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-path]] `quarkus.info.path`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-git-enabled]] `quarkus.info.git.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-git-mode]] `quarkus.info.git.mode`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-build-enabled]] `quarkus.info.build.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-build-property-key]] `quarkus.info.build."property-key"`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-os-enabled]] `quarkus.info.os.enabled`
...
a|icon:lock[title=Fixed at build time] [[quarkus-info_quarkus-info-java-enabled]] `quarkus.info.java.enabled`

...
a|icon:lock[title=Fixed at build time] [[quarkus-class-loading-configuration-class-loading-config_quarkus-class-loading-removed-resources-group-id-artifact-id]]`link:#quarkus-class-loading-configuration-class-loading-config_quarkus-class-loading-removed-resources-group-id-artifact-id[quarkus.class-loading.removed-resources."group-id:artifact-id"]`

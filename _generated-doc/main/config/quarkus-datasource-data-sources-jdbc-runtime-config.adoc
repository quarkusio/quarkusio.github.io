...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource-data-sources-jdbc-runtime-config_quarkus.datasource.-datasource-name-.jdbc.telemetry]]`link:#quarkus-datasource-data-sources-jdbc-runtime-config_quarkus.datasource.-datasource-name-.jdbc.telemetry[quarkus.datasource."datasource-name".jdbc.telemetry]`

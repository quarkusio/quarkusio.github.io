...
:summaryTableId: quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference, cols="80,.^10,.^10"]
|===

h|[[quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_configuration]]link:#quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_configuration[Configuration property]

h|Type
h|Default

a| [[quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-key-cert-keys]]`link:#quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-key-cert-keys[quarkus.otel.exporter.otlp.key-cert.keys]`
...
a| [[quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-traces-key-cert-keys]]`link:#quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-traces-key-cert-keys[quarkus.otel.exporter.otlp.traces.key-cert.keys]`
...
a| [[quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-metrics-key-cert-keys]]`link:#quarkus-opentelemetry-config-group-config-runtime-exporter-otlp-exporter-config-key-cert_quarkus-otel-exporter-otlp-metrics-key-cert-keys[quarkus.otel.exporter.otlp.metrics.key-cert.keys]`

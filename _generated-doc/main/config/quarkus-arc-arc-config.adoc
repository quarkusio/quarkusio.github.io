...
a|icon:lock[title=Fixed at build time] [[quarkus-arc-arc-config_quarkus.arc.exclude-dependency-dependency-name]]`link:#quarkus-arc-arc-config_quarkus.arc.exclude-dependency-dependency-name[quarkus.arc.exclude-dependency]`

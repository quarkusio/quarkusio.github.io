...
a|icon:lock[title=Fixed at build time] [[quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.-datasource-name-.jdbc.telemetry]]`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.-datasource-name-.jdbc.telemetry[quarkus.datasource."datasource-name".jdbc.telemetry]`
...
a| [[quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.-datasource-name-.jdbc.telemetry.enabled]]`link:#quarkus-datasource-data-sources-jdbc-build-time-config_quarkus.datasource.-datasource-name-.jdbc.telemetry.enabled[quarkus.datasource."datasource-name".jdbc.telemetry.enabled]`

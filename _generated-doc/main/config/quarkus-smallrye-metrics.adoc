:summaryTableId: quarkus-smallrye-metrics_quarkus-smallrye-metrics
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-path]] [.property-path]##`quarkus.smallrye-metrics.path`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-extensions-enabled]] [.property-path]##`quarkus.smallrye-metrics.extensions.enabled`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-micrometer-compatibility]] [.property-path]##`quarkus.smallrye-metrics.micrometer.compatibility`##
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus-smallrye-metrics-jaxrs-enabled]] [.property-path]##`quarkus.smallrye-metrics.jaxrs.enabled`##

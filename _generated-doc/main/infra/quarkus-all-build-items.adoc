...
-- a|`org.jboss.jandex.ClassInfo configClass` 
...
-- a|`java.util.Map<String,Set<String>> configMappings` 
...
-- a|`java.util.Map<String,Set<String>> configProperties` 
...
`java.util.Map<Class<?>,ConfigClassImplementation> elements` 

_No Javadoc found_

`java.util.Set<DotName> interfaces` 

_No Javadoc found_

`java.util.Set<DotName> implementations` 
...
```
 `&#64;BuildStep void configureTracing(Optional<OpenTelemetrySdkBuildItem> otelSdk, ...)  if (otelSdk.isPresent() && otelSdk.get().isTracingBuildTimeEnabled())  // register tracing integration` } }
...
-- a|`java.util.function.Consumer<BeanGenerator.SuppressConditionGeneration> generator` 
...
--
_No Javadoc found_
-- a|`java.util.function.Consumer<JsonMapper.Builder> customizer` 
...
`java.util.Optional<String> explicitDialect` 
...
-- a|`java.lang.String methodId` 

_No Javadoc found_

`java.lang.String invokerClassName` 

_No Javadoc found_

`java.util.List<String> syntheticParameterTypes` 

_No Javadoc found_

`io.smallrye.reactive.messaging.Shape shape` 
...
`java.util.function.Function<SyntheticCreationalContext<Pool>,Pool> pool` 

_No Javadoc found_

`java.lang.String healthCheckSql` 
...
-- a|`java.util.Map<String,Map<OpenApiFilter.RunStage,List<String>>> filterNames` 
...
-- a|`io.smallrye.openapi.api.SmallRyeOpenAPI smallRyeOpenAPI` 
...
-- a|`java.util.function.Consumer<VertxBootstrap> consumer` 
...
-- a|`java.util.function.Consumer<VertxOptions> consumer` 

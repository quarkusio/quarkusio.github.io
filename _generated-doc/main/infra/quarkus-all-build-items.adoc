...
--
_No Javadoc found_
-- a|`java.util.function.Consumer<ObjectMapper> customizer` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/data/hibernate/deployment/src/main/java/io/quarkus/hibernate/panache/deployment/EntityToPersistenceUnitBuildItem.java[`io.quarkus.hibernate.panache.deployment.EntityToPersistenceUnitBuildItem`, window="_blank"]
[.description]
--
Used to record that a specific JPA entity is associated with a specific persistence unit
-- a|`java.lang.String entityClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/data/hibernate/deployment/src/main/java/io/quarkus/hibernate/panache/deployment/PanacheEntityClassBuildItem.java[`io.quarkus.hibernate.panache.deployment.PanacheEntityClassBuildItem`, window="_blank"]
[.description]
--
Represents a regular Panache entity class.
-- a|`org.jboss.jandex.ClassInfo entityClass` 
...
Consumers will be called in priority order (lowest to highest) after VertxOptions customizers have been applied. 
When multiple build items have the same priority, the order of execution is not guaranteed. 

...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Bt=/'/g,Wt=/"/g,Gt=/^(?:script|style|textarea|title)$/i,Yt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),_=Yt(1),Hr=Yt(2),E=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Ft=new WeakMap,T=q.createTreeWalker(q,129);function Qt(r,t){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Dt!==void 0?Dt.createHTML(t):t}var hi=(r,t)=>{let e=r.length-1,i=[],s,n=t===2?"<svg>":"",o=W;for(let l=0;l<e;l++){let a=r[l],d,g,c=-1,y=0;for(;y<a.length&&(o.lastIndex=y,g=o.exec(a),g!==null);)y=o.lastIndex,o===W?g[1]==="!--"?o=It:g[1]!==void 0?o=zt:g[2]!==void 0?(Gt.test(g[2])&&(s=RegExp("</"+g[2],"g")),o=H):g[3]!==void 0&&(o=H):o===H?g[0]===">"?(o=s??W,c=-1):g[1]===void 0?c=-2:(c=o.lastIndex-g[2].length,d=g[1],o=g[3]===void 0?H:g[3]==='"'?Wt:Bt):o===Wt||o===Bt?o=H:o===It||o===zt?o=W:(o=H,s=void 0);let x=o===H&&r[l+1].startsWith("/>")?" ":"";n+=o===W?a+li:c>=0?(i.push(d),a.slice(0,c)+Jt+a.slice(c)+C+x):a+C+(c===-2?l:x)}return[Qt(r,n+(r[e]||"<?>")+(t===2?"</svg>":"")),i]},K=class r{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0,l=t.length-1,a=this.parts,[d,g]=hi(t,e);if(this.el=r.createElement(d,i),T.currentNode=this.el.content,e===2){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(s=T.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(let c of s.getAttributeNames())if(c.endsWith(Jt)){let y=g[o++],x=s.getAttribute(c).split(C),P=/([.?@])?(.*)/.exec(y);a.push({type:1,index:n,name:P[2],strings:x,ctor:P[1]==="."?vt:P[1]==="?"?yt:P[1]==="@"?_t:U}),s.removeAttribute(c)}else c.startsWith(C)&&(a.push({type:6,index:n}),s.removeAttribute(c));if(Gt.test(s.tagName)){let c=s.textContent.split(C),y=c.length-1;if(y>0){s.textContent=at?at.emptyScript:"";for(let x=0;x<y;x++)s.append(c[x],F()),T.nextNode(),a.push({type:2,index:++n});s.append(c[y],F())}}}else if(s.nodeType===8)if(s.data===Kt)a.push({type:2,index:n});else{let c=-1;for(;(c=s.data.indexOf(C,c+1))!==-1;)a.push({type:7,index:n}),c+=C.length-1}n++}}static createElement(t,e){let i=q.createElement("template");return i.innerHTML=t,i}};function R(r,t,e=r,i){if(t===E)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,n=J(t)?void 0:t._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(r),s._$AT(r,e,i)),i!==void 0?(e._$Co??=[])[i]=s:e._$Cl=s),s!==void 0&&(t=R(r,s._$AS(r,t.values),s,i)),t}var ft=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??q).importNode(e,!0);T.currentNode=s;let n=T.nextNode(),o=0,l=0,a=i[0];for(;a!==void 0;){if(o===a.index){let d;a.type===2?d=new X(n,n.nextSibling,this,t):a.type===1?d=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(d=new bt(n,this,t)),this._$AV.push(d),a=i[++l]}o!==a?.index&&(n=T.nextNode(),o++)}return T.currentNode=q,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},X=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=R(this,t,e),J(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==E&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ci(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==p&&J(this._$AH)?this._$AA.nextSibling.data=t:this.T(q.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=K.createElement(Qt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let n=new ft(s,this),o=n.u(this.options);n.p(e),this.T(o),this._$AH=n}}_$AC(t){let e=Ft.get(t.strings);return e===void 0&&Ft.set(t.strings,e=new K(t)),e}k(t){Xt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let n of t)s===e.length?e.push(i=new r(this.S(F()),this.S(F()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let i=t.nextSibling;t.remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},U=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=p}_$AI(t,e=this,i,s){let n=this.strings,o=!1;if(n===void 0)t=R(this,t,e,0),o=!J(t)||t!==this._$AH&&t!==E,o&&(this._$AH=t);else{let l=t,a,d;for(t=n[0],a=0;a<n.length-1;a++)d=R(this,l[i+a],e,a),d===E&&(d=this._$AH[a]),o||=!J(d)||d!==this._$AH[a],d===p?t=p:t!==p&&(t+=(d??"")+n[a+1]),this._$AH[a]=d}o&&!s&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},vt=class extends U{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}},yt=class extends U{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}},_t=class extends U{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=R(this,t,e,0)??p)===E)return;let i=this._$AH,s=t===p&&i!==p||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==p&&(i===p||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},bt=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){R(this,t)}};var di=$t.litHtmlPolyfillSupport;di?.(K,X),($t.litHtmlVersions??=[]).push("3.1.4");var te=(r,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let n=e?.renderBefore??null;i._$litPart$=s=new X(t.insertBefore(F(),n),n,void 0,e??{})}return s._$AI(r),s};var b=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=te(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return E}};b._$litElement$=!0,b.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:b});var ui=globalThis.litElementPolyfillSupport;ui?.({LitElement:b});(globalThis.litElementVersions??=[]).push("4.0.6");var ee={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ie=r=>(...t)=>({_$litDirective$:r,values:t}),lt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var G=class extends lt{constructor(t){if(super(t),this.it=p,t.type!==ee.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===p||t==null)return this._t=void 0,this.it=t;if(t===E)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};G.directiveName="unsafeHTML",G.resultType=1;var xt=ie(G);var V=r=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(r,t)}):customElements.define(r,t)};var pi={attribute:!0,type:String,converter:B,reflect:!1,hasChanged:ot},gi=(r=pi,t,e)=>{let{kind:i,metadata:s}=e,n=globalThis.litPropertyMetadata.get(s);if(n===void 0&&globalThis.litPropertyMetadata.set(s,n=new Map),n.set(e.name,r),i==="accessor"){let{name:o}=e;return{set(l){let a=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,a,r)},init(l){return l!==void 0&&this.P(o,void 0,r),l}}}if(i==="setter"){let{name:o}=e;return function(l){let a=this[o];t.call(this,l),this.requestUpdate(o,a,r)}}throw Error("Unsupported decorator location: "+i)};function u(r){return(t,e)=>typeof e=="object"?gi(r,t,e):((i,s,n)=>{let o=s.hasOwnProperty(n);return s.constructor.createProperty(n,o?{...i,wrapped:!0}:i),o?Object.getOwnPropertyDescriptor(s,n):void 0})(r,t,e)}function Y(r){return u({...r,state:!0,attribute:!1})}var Z=(r,t,e)=>(e.configurable=!0,e.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(r,t,e),e);var mi;function re(r){return(t,e)=>Z(t,e,{get(){return(this.renderRoot??(mi??=document.createDocumentFragment())).querySelectorAll(r)}})}var v=class extends b{constructor(){super(...arguments);this.type="default";this.origin="quarkus";this.originsWithRelativeUrls=[]}connectedCallback(){if(this.data)for(let e in this.data)this.data.hasOwnProperty(e)&&(this[e]=this.data[e]);super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return _`
    ...
    `}relativizeUrl(){return this.originsWithRelativeUrls.includes(this.origin)?this.url.substring(new URL(this.url).origin.length):this.url}icon(){let e=O.docs[this.type];if(e){let i=e.match(/.*(<svg.*<\/svg>)/);if(i)return i[1]}return""}_renderHTML(e){return e&&(Array.isArray(e)?e.map(i=>_`<p>${this._renderHTML(i)}</p>`):xt(e))}};v.styles=M`
      ...
      .qs-guide .origin.quarkus {
          background-image: url('${L(O.origins.quarkus)}');
      }

      .qs-guide .origin.quarkiverse-hub {
          background-image: url('${L(O.origins.quarkiverse)}');
      }
  ...
  `,h([u({type:String})],$.prototype,"server",2),h([u({type:String,attribute:"min-chars"})],$.prototype,"minChars",2),h([u({type:String,attribute:"initial-timeout"})],$.prototype,"initialTimeout",2),h([u({type:String,attribute:"more-timeout"})],$.prototype,"moreTimeout",2),h([u({type:String})],$.prototype,"language",2),h([u({type:String,attribute:"quarkus-version"})],$.prototype,"quarkusversion",2),h([u({type:String,attribute:"local-search"})],$.prototype,"localSearch",2),h([Y({hasChanged(e,i){return JSON.stringify(e)!==JSON.stringify(i)}})],$.prototype,"_backendData",2),$=h([V("qs-form")],$);var Oe=qt(Ct());var A=class extends b{constructor(){super(...arguments);this.type="guide";this.originsWithRelativeUrls=[];this._loading=!0;this._handleScroll=e=>{if(this._loading||!this._result)return;if(!this._result.hasMoreHits){console.debug("no more hits");return}let i=this._hits.length==0?null:this._hits[this._hits.length-1];if(!i)return;let s=document.documentElement,n=s.scrollTop+s.clientHeight,o=i.offsetTop;n>=o&&(this._loading=!0,this._form.dispatchEvent(new CustomEvent(ct)))};this._handleScrollDebounced=(0,Oe.default)(this._handleScroll,100);this._handleResult=e=>{if(console.debug("Received results in qs-target: ",e.detail),this._loadingEnd(),!this._result||!e.detail||!e.detail.hits||e.detail.page===0){e.detail?.hits?document.body.classList.add("qs-has-results"):document.body.classList.remove("qs-has-results"),this._result=e.detail;return}this._result.hits=this._result.hits.concat(e.detail.hits),console.debug(`${this._result.hits.length} results in qs-target: `),this._result.hasMoreHits=e.detail.hasMoreHits};this._loadingStart=e=>{this._loading=!0,e.detail.page===0&&(this._result=void 0)};this._loadingEnd=()=>{this._loading=!1}}connectedCallback(){super.connectedCallback(),this._form=document.querySelector("qs-form"),this._form.addEventListener(k,this._handleResult),this._form.addEventListener(ht,this._loadingStart),document.addEventListener("scroll",this._handleScrollDebounced)}disconnectedCallback(){this._form.removeEventListener(k,this._handleResult),this._form.removeEventListener(ht,this._loadingStart),document.removeEventListener("scroll",this._handleScrollDebounced),super.disconnectedCallback()}render(){if(this._result?.hits){if(this._result.hits.length===0)return _`
    ...
    .loading {
      background-image: url('${L(O.loading)}');
      background-repeat: no-repeat;
  ...
  `,h([u({type:String})],A.prototype,"type",2),h([u({type:String,attribute:"origins-with-relative-urls"})],A.prototype,"originsWithRelativeUrls",2),h([Y()],A.prototype,"_result",2),h([Y()],A.prototype,"_loading",2),h([re(".qs-hit")],A.prototype,"_hits",2),A=h([V("qs-target")],A);export{D as LocalSearch,ct as QS_NEXT_PAGE_EVENT,k as QS_RESULT_EVENT,ht as QS_START_EVENT,$ as QsForm,v as QsGuide,A as QsTarget};

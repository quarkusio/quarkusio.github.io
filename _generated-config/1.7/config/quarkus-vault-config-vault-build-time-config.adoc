...
h|[[quarkus-vault-config-vault-build-time-config_quarkus.vault.health]]link:#quarkus-vault-config-vault-build-time-config_quarkus.vault.health[Health check configuration]

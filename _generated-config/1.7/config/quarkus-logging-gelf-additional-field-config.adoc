...
h|[[quarkus-logging-gelf-additional-field-config_quarkus.log.handler.gelf.additional-field]]link:#quarkus-logging-gelf-additional-field-config_quarkus.log.handler.gelf.additional-field[Post additional fields]

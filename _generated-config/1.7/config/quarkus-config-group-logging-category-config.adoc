...
h|[[quarkus-config-group-logging-category-config_quarkus.log.categories]]link:#quarkus-config-group-logging-category-config_quarkus.log.categories[Logging categories]

...
h|[[quarkus-hibernate-validator-general-config-items_quarkus.hibernate-validator.method-validation]]link:#quarkus-hibernate-validator-general-config-items_quarkus.hibernate-validator.method-validation[Method validation]

...
h|[[quarkus-vault-config-group-config-vault-authentication-config_quarkus.vault.authentication-authentication]]link:#quarkus-vault-config-group-config-vault-authentication-config_quarkus.vault.authentication-authentication[Authentication]
...
a| [[quarkus-vault-config-group-config-vault-authentication-config_quarkus.vault.authentication.kubernetes.auth-mount-path]]`link:#quarkus-vault-config-group-config-vault-authentication-config_quarkus.vault.authentication.kubernetes.auth-mount-path[quarkus.vault.authentication.kubernetes.auth-mount-path]`

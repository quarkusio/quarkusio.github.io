...
a| [[quarkus-redis-client-general-config-items_quarkus.redis.slaves]]`link:#quarkus-redis-client-general-config-items_quarkus.redis.slaves[quarkus.redis.slaves]`
...
a| [[quarkus-redis-client-general-config-items_quarkus.redis.-additional-redis-clients-.slaves]]`link:#quarkus-redis-client-general-config-items_quarkus.redis.-additional-redis-clients-.slaves[quarkus.redis."additional-redis-clients".slaves]`

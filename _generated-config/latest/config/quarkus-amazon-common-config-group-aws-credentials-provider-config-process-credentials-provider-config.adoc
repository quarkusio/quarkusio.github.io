...
a| [[quarkus-amazon-common-config-group-aws-credentials-provider-config-process-credentials-provider-config_quarkus.ssm.aws.credentials.process-provider.command]]`link:#quarkus-amazon-common-config-group-aws-credentials-provider-config-process-credentials-provider-config_quarkus.ssm.aws.credentials.process-provider.command[quarkus.ssm.aws.credentials.process-provider.command]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus.console.disable-color]]`link:#quarkus-core_quarkus.console.disable-color[quarkus.console.disable-color]`

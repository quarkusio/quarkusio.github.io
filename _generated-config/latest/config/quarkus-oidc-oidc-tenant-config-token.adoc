...
a| [[quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.token.auto-refresh-interval]]`link:#quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.token.auto-refresh-interval[quarkus.oidc.token.auto-refresh-interval]`
...
a| [[quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.-tenant-.token.auto-refresh-interval]]`link:#quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.-tenant-.token.auto-refresh-interval[quarkus.oidc."tenant".token.auto-refresh-interval]`

...
a| [[quarkus-redis-redis-config_quarkus.redis.slaves]]`link:#quarkus-redis-redis-config_quarkus.redis.slaves[quarkus.redis.slaves]`
...
a| [[quarkus-redis-redis-config_quarkus.redis.-additional-redis-clients-.slaves]]`link:#quarkus-redis-redis-config_quarkus.redis.-additional-redis-clients-.slaves[quarkus.redis."additional-redis-clients".slaves]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-reactive_quarkus.resteasy-reactive.deny-unannotated-endpoints]]`link:#quarkus-resteasy-reactive_quarkus.resteasy-reactive.deny-unannotated-endpoints[quarkus.resteasy-reactive.deny-unannotated-endpoints]`

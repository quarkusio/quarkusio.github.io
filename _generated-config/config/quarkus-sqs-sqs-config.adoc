...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.sdk]]link:#quarkus-sqs-sqs-config_quarkus.sqs.sdk[AWS SDK client configurations]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.aws]]link:#quarkus-sqs-sqs-config_quarkus.sqs.aws[AWS services configurations]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.default-provider]]link:#quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.default-provider[Default credentials provider configuration]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.static-provider]]link:#quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.static-provider[Static credentials provider configuration]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.profile-provider]]link:#quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.profile-provider[AWS Profile credentials provider configuration]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.process-provider]]link:#quarkus-sqs-sqs-config_quarkus.sqs.aws.credentials.process-provider[Process credentials provider configuration]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.sync-client]]link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client[Sync HTTP transport configurations]
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache]]link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache[Apache HTTP client specific configurations]
...
a| [[quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.type]]`link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.type[quarkus.sqs.sync-client.apache.tls-managers-provider.type]`
...
a| [[quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.path]]`link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.path[quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.path]`
...
a| [[quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.type]]`link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.type[quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.type]`
...
a| [[quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.password]]`link:#quarkus-sqs-sqs-config_quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.password[quarkus.sqs.sync-client.apache.tls-managers-provider.file-store.password]`
...
h|[[quarkus-sqs-sqs-config_quarkus.sqs.async-client]]link:#quarkus-sqs-sqs-config_quarkus.sqs.async-client[Netty HTTP transport configurations]

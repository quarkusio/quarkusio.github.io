...
a| `String httpRootPath` :: +++<i>No Javadoc found</i>+++
`String frameworkRootPath` :: +++<i>No Javadoc found</i>+++
`boolean separateRoot` :: +++<i>No Javadoc found</i>+++
...
`boolean frameworkRoute` :: +++<i>No Javadoc found</i>+++
...
a| https://github.com/quarkusio/quarkus/blob/master/extensions/vertx-http/deployment/src/main/java/io/quarkus/vertx/http/deployment/VertxNonApplicationRouterBuildItem.java[`io.quarkus.vertx.http.deployment.VertxNonApplicationRouterBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++

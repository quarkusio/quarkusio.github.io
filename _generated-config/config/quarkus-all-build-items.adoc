...
`boolean enversIsPresent` :: +++<i>No Javadoc found</i>+++
...
a| https://github.com/quarkusio/quarkus/blob/master/extensions/security/deployment/src/main/java/io/quarkus/security/deployment/BouncyCastleJCAProviderBuildItem.java[`io.quarkus.security.deployment.BouncyCastleJCAProviderBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| None

...
`Map additionalPaths` :: +++<i>No Javadoc found</i>+++
...
a| None
a| https://github.com/quarkusio/quarkus/blob/master/core/deployment/src/main/java/io/quarkus/deployment/builditem/nativeimage/RuntimeInitializedClassBuildItem.java[`io.quarkus.deployment.builditem.nativeimage.RuntimeInitializedClassBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String className` :: +++<i>No Javadoc found</i>+++
...
a| https://github.com/quarkusio/quarkus/blob/master/extensions/amazon-services/common/deployment/src/main/java/io/quarkus/amazon/common/deployment/AmazonClientTransportsBuildItem.java[`io.quarkus.amazon.common.deployment.AmazonClientTransportsBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `Optional syncClassName` :: +++<i>No Javadoc found</i>+++
`Optional asyncClassName` :: +++<i>No Javadoc found</i>+++
...
`List additionalBeans` :: +++<i>No Javadoc found</i>+++
...
a| `Function fun` :: +++<i>No Javadoc found</i>+++
...
a| `ClassType blockingStubClass` :: +++<i>No Javadoc found</i>+++
`ClassType mutinyStubClass` :: +++<i>No Javadoc found</i>+++
`String name` :: +++<i>No Javadoc found</i>+++
...
a| None
a| https://github.com/quarkusio/quarkus/blob/master/extensions/hibernate-orm/deployment/src/main/java/io/quarkus/hibernate/orm/deployment/integration/HibernateOrmIntegrationBuildItem.java[`io.quarkus.hibernate.orm.deployment.integration.HibernateOrmIntegrationBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String name` :: +++<i>No Javadoc found</i>+++
...
a| `Set entityClassNames` :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/master/extensions/kubernetes/spi/src/main/java/io/quarkus/kubernetes/spi/DecoratorBuildItem.java[`io.quarkus.kubernetes.spi.DecoratorBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/master/extensions/mongodb-client/deployment/src/main/java/io/quarkus/mongodb/deployment/BsonDiscriminatorBuildItem.java[`io.quarkus.mongodb.deployment.BsonDiscriminatorBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `List bsonDiscriminatorClassNames` :: +++<i>No Javadoc found</i>+++

a| https://github.com/quarkusio/quarkus/blob/master/extensions/mongodb-client/deployment/src/main/java/io/quarkus/mongodb/deployment/CodecProviderBuildItem.java[`io.quarkus.mongodb.deployment.CodecProviderBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `List codecProviderClassNames` :: +++<i>No Javadoc found</i>+++

a| https://github.com/quarkusio/quarkus/blob/master/extensions/mongodb-client/deployment/src/main/java/io/quarkus/mongodb/deployment/MongoClientBuildItem.java[`io.quarkus.mongodb.deployment.MongoClientBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
...
a| https://github.com/quarkusio/quarkus/blob/master/extensions/mongodb-client/deployment/src/main/java/io/quarkus/mongodb/deployment/MongoConnectionPoolListenerBuildItem.java[`io.quarkus.mongodb.deployment.MongoConnectionPoolListenerBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
...
a| `RuntimeValue db2Pool` :: +++<i>No Javadoc found</i>+++
...
a| `RuntimeValue mysqlPool` :: +++<i>No Javadoc found</i>+++
...
a| `RuntimeValue pgPool` :: +++<i>No Javadoc found</i>+++
...
a| `RestDataResourceInfo resourceInfo` :: +++<i>No Javadoc found</i>+++
...
a| `RuntimeValue router` :: +++<i>No Javadoc found</i>+++

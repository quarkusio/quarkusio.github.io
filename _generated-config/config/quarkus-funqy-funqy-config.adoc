...
a|icon:lock[title=Fixed at build time] [[quarkus-funqy-funqy-config_quarkus.funqy.export]]`link:#quarkus-funqy-funqy-config_quarkus.funqy.export[quarkus.funqy.export]`

...
h|[[quarkus-config-group-logging-file-config_quarkus.log.file-handlers]]link:#quarkus-config-group-logging-file-config_quarkus.log.file-handlers[File handlers]

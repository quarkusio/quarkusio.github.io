...
a| [[quarkus-datasource-config-group-data-source-runtime-config_quarkus.datasource.credentials-provider-type]]`link:#quarkus-datasource-config-group-data-source-runtime-config_quarkus.datasource.credentials-provider-type[quarkus.datasource.credentials-provider-type]`

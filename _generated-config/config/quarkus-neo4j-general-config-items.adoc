...
h|[[quarkus-neo4j-general-config-items_quarkus.neo4j.trust-settings]]link:#quarkus-neo4j-general-config-items_quarkus.neo4j.trust-settings[Configure trust settings for encrypted traffic]

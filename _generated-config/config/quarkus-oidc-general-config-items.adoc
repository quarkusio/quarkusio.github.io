...
a| [[quarkus-oidc-general-config-items_quarkus.oidc.token.expiration-grace]]`link:#quarkus-oidc-general-config-items_quarkus.oidc.token.expiration-grace[quarkus.oidc.token.expiration-grace]`
...
a| [[quarkus-oidc-general-config-items_quarkus.oidc.-tenant-.token.expiration-grace]]`link:#quarkus-oidc-general-config-items_quarkus.oidc.-tenant-.token.expiration-grace[quarkus.oidc."tenant".token.expiration-grace]`

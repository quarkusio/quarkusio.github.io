...
h|[[quarkus-smallrye-health-general-config-items_quarkus.smallrye-health.ui-ui-configuration]]link:#quarkus-smallrye-health-general-config-items_quarkus.smallrye-health.ui-ui-configuration[UI configuration]
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-health-general-config-items_quarkus.smallrye-health.ui.enable]]`link:#quarkus-smallrye-health-general-config-items_quarkus.smallrye-health.ui.enable[quarkus.smallrye-health.ui.enable]`

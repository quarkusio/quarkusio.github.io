...
h|[[quarkus-hibernate-validator-config-group-hibernate-validator-build-time-config-hibernate-validator-method-build-time-config_configuration]]link:#quarkus-hibernate-validator-config-group-hibernate-validator-build-time-config-hibernate-validator-method-build-time-config_configuration[Configuration property]

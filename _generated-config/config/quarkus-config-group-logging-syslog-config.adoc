...
h|[[quarkus-config-group-logging-syslog-config_quarkus.log.syslog-handlers]]link:#quarkus-config-group-logging-syslog-config_quarkus.log.syslog-handlers[Syslog handlers]

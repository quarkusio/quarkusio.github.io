...
a|icon:lock[title=Fixed at build time] [[quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.group-id]]`link:#quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.group-id[quarkus.arc.exclude-dependency."exclude-dependency".group-id]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.artifact-id]]`link:#quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.artifact-id[quarkus.arc.exclude-dependency."exclude-dependency".artifact-id]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.classifier]]`link:#quarkus-arc-arc-config_quarkus.arc.exclude-dependency.-exclude-dependency-.classifier[quarkus.arc.exclude-dependency."exclude-dependency".classifier]`

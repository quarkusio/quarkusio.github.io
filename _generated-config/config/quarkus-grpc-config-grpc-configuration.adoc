...
h|[[quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients]]link:#quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients[Configures the gRPC clients]
...
h|[[quarkus-grpc-config-grpc-configuration_quarkus.grpc.server]]link:#quarkus-grpc-config-grpc-configuration_quarkus.grpc.server[Configure the gRPC server]

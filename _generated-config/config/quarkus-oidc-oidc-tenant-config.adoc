...
a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.token.auto-refresh-interval]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.token.auto-refresh-interval[quarkus.oidc.token.auto-refresh-interval]`
...
a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.authentication.xhr-auto-redirect]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.authentication.xhr-auto-redirect[quarkus.oidc.authentication.xhr-auto-redirect]`
...
a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.token.auto-refresh-interval]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.token.auto-refresh-interval[quarkus.oidc."tenant".token.auto-refresh-interval]`
...
a| [[quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.authentication.xhr-auto-redirect]]`link:#quarkus-oidc-oidc-tenant-config_quarkus.oidc.-tenant-.authentication.xhr-auto-redirect[quarkus.oidc."tenant".authentication.xhr-auto-redirect]`

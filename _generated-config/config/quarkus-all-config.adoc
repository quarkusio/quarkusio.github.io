...
h|[[quarkus-amazon-lambda_quarkus-amazon-lambda-aws-lambda]]link:#quarkus-amazon-lambda_quarkus-amazon-lambda-aws-lambda[AWS Lambda]
...
h|[[quarkus-amazon-lambda-common_quarkus-amazon-lambda-common-aws-lambda-common]]link:#quarkus-amazon-lambda-common_quarkus-amazon-lambda-common-aws-lambda-common[AWS Lambda Common]
...
h|[[quarkus-agroal_quarkus-agroal-agroal-database-connection-pool]]link:#quarkus-agroal_quarkus-agroal-agroal-database-connection-pool[Agroal - Database connection pool]
...
h|[[quarkus-amazon-dynamodb_quarkus-amazon-dynamodb-amazon-dynamodb]]link:#quarkus-amazon-dynamodb_quarkus-amazon-dynamodb-amazon-dynamodb[Amazon DynamoDB]
...
h|[[quarkus-amazon-iam_quarkus-amazon-iam-amazon-iam]]link:#quarkus-amazon-iam_quarkus-amazon-iam-amazon-iam[Amazon IAM]
...
h|[[quarkus-amazon-kms_quarkus-amazon-kms-amazon-kms]]link:#quarkus-amazon-kms_quarkus-amazon-kms-amazon-kms[Amazon KMS]
...
h|[[quarkus-amazon-s3_quarkus-amazon-s3-amazon-s3]]link:#quarkus-amazon-s3_quarkus-amazon-s3-amazon-s3[Amazon S3]
...
h|[[quarkus-amazon-ses_quarkus-amazon-ses-amazon-ses]]link:#quarkus-amazon-ses_quarkus-amazon-ses-amazon-ses[Amazon SES]
...
h|[[quarkus-amazon-sns_quarkus-amazon-sns-amazon-sns]]link:#quarkus-amazon-sns_quarkus-amazon-sns-amazon-sns[Amazon SNS]
...
h|[[quarkus-amazon-sqs_quarkus-amazon-sqs-amazon-sqs]]link:#quarkus-amazon-sqs_quarkus-amazon-sqs-amazon-sqs[Amazon SQS]
...
h|[[quarkus-kafka-client_quarkus-kafka-client-apache-kafka-client]]link:#quarkus-kafka-client_quarkus-kafka-client-apache-kafka-client[Apache Kafka Client]
...
h|[[quarkus-kafka-streams_quarkus-kafka-streams-apache-kafka-streams]]link:#quarkus-kafka-streams_quarkus-kafka-streams-apache-kafka-streams[Apache Kafka Streams]
...
h|[[quarkus-tika_quarkus-tika-apache-tika]]link:#quarkus-tika_quarkus-tika-apache-tika[Apache Tika]
...
h|[[quarkus-arc_quarkus-arc-arc]]link:#quarkus-arc_quarkus-arc-arc[ArC]
...
h|[[quarkus-artemis-core_quarkus-artemis-core-artemis-core]]link:#quarkus-artemis-core_quarkus-artemis-core-artemis-core[Artemis Core]
...
h|[[quarkus-cache_quarkus-cache-cache]]link:#quarkus-cache_quarkus-cache-cache[Cache]
...
h|[[quarkus-consul-config_quarkus-consul-config-consul-config]]link:#quarkus-consul-config_quarkus-consul-config-consul-config[Consul Config]
...
h|[[quarkus-container-image_quarkus-container-image-container-image]]link:#quarkus-container-image_quarkus-container-image-container-image[Container Image]
...
h|[[quarkus-container-image-docker_quarkus-container-image-docker-container-image-docker]]link:#quarkus-container-image-docker_quarkus-container-image-docker-container-image-docker[Container Image Docker]
...
h|[[quarkus-container-image-jib_quarkus-container-image-jib-container-image-jib]]link:#quarkus-container-image-jib_quarkus-container-image-jib-container-image-jib[Container Image Jib]
...
h|[[quarkus-container-image-openshift_quarkus-container-image-openshift-container-image-openshift]]link:#quarkus-container-image-openshift_quarkus-container-image-openshift-container-image-openshift[Container Image OpenShift]
...
h|[[quarkus-container-image-s2i_quarkus-container-image-s2i-container-image-s2i]]link:#quarkus-container-image-s2i_quarkus-container-image-s2i-container-image-s2i[Container Image S2I]
...
h|[[quarkus-datasource_quarkus-datasource-datasource-configuration]]link:#quarkus-datasource_quarkus-datasource-datasource-configuration[Datasource configuration]
...
h|[[quarkus-vertx-core_quarkus-vertx-core-eclipse-vert.x-core]]link:#quarkus-vertx-core_quarkus-vertx-core-eclipse-vert.x-core[Eclipse Vert.x - Core]
...
h|[[quarkus-vertx-http_quarkus-vertx-http-eclipse-vert.x-http]]link:#quarkus-vertx-http_quarkus-vertx-http-eclipse-vert.x-http[Eclipse Vert.x - HTTP]
...
h|[[quarkus-vertx-graphql_quarkus-vertx-graphql-eclipse-vert.x-graphql]]link:#quarkus-vertx-graphql_quarkus-vertx-graphql-eclipse-vert.x-graphql[Eclipse Vert.x GraphQL]
...
h|[[quarkus-elasticsearch-rest-client_quarkus-elasticsearch-rest-client-elasticsearch-rest-client]]link:#quarkus-elasticsearch-rest-client_quarkus-elasticsearch-rest-client-elasticsearch-rest-client[Elasticsearch REST client]
...
h|[[quarkus-elytron-security-jdbc_quarkus-elytron-security-jdbc-elytron-security-jdbc]]link:#quarkus-elytron-security-jdbc_quarkus-elytron-security-jdbc-elytron-security-jdbc[Elytron Security JDBC]
...
h|[[quarkus-elytron-security-ldap_quarkus-elytron-security-ldap-elytron-security-ldap-realm]]link:#quarkus-elytron-security-ldap_quarkus-elytron-security-ldap-elytron-security-ldap-realm[Elytron Security LDAP Realm]
...
h|[[quarkus-elytron-security-oauth2_quarkus-elytron-security-oauth2-elytron-security-oauth-2.0]]link:#quarkus-elytron-security-oauth2_quarkus-elytron-security-oauth2-elytron-security-oauth-2.0[Elytron Security OAuth 2.0]
...
h|[[quarkus-elytron-security-properties-file_quarkus-elytron-security-properties-file-elytron-security-properties-file]]link:#quarkus-elytron-security-properties-file_quarkus-elytron-security-properties-file-elytron-security-properties-file[Elytron Security Properties File]
...
a| [[quarkus-elytron-security-properties-file_quarkus.security.users.embedded.algorithm]]`link:#quarkus-elytron-security-properties-file_quarkus.security.users.embedded.algorithm[quarkus.security.users.embedded.algorithm]`
...
h|[[quarkus-elytron-security-properties-file_quarkus.security.users.file-property-files-realm-configuration]]link:#quarkus-elytron-security-properties-file_quarkus.security.users.file-property-files-realm-configuration[Property Files Realm Configuration]
...
h|[[quarkus-elytron-security-properties-file_quarkus.security.users.embedded-embedded-realm-configuration]]link:#quarkus-elytron-security-properties-file_quarkus.security.users.embedded-embedded-realm-configuration[Embedded Realm Configuration]
...
h|[[quarkus-flyway_quarkus-flyway-flyway]]link:#quarkus-flyway_quarkus-flyway-flyway[Flyway]
...
h|[[quarkus-funqy-knative-events_quarkus-funqy-knative-events-funqy-knative-events-binding]]link:#quarkus-funqy-knative-events_quarkus-funqy-knative-events-funqy-knative-events-binding[Funqy Knative Events Binding]
...
h|[[quarkus-funqy-server-common_quarkus-funqy-server-common-funqy-server-common]]link:#quarkus-funqy-server-common_quarkus-funqy-server-common-funqy-server-common[Funqy Server Common]
...
h|[[quarkus-google-cloud-functions_quarkus-google-cloud-functions-google-cloud-functions]]link:#quarkus-google-cloud-functions_quarkus-google-cloud-functions-google-cloud-functions[Google Cloud Functions]
...
h|[[quarkus-hibernate-envers_quarkus-hibernate-envers-hibernate-envers]]link:#quarkus-hibernate-envers_quarkus-hibernate-envers-hibernate-envers[Hibernate Envers]
...
h|[[quarkus-hibernate-orm_quarkus-hibernate-orm-hibernate-orm]]link:#quarkus-hibernate-orm_quarkus-hibernate-orm-hibernate-orm[Hibernate ORM]
...
h|[[quarkus-hibernate-search-orm-elasticsearch_quarkus-hibernate-search-orm-elasticsearch-hibernate-search-elasticsearch]]link:#quarkus-hibernate-search-orm-elasticsearch_quarkus-hibernate-search-orm-elasticsearch-hibernate-search-elasticsearch[Hibernate Search + Elasticsearch]
...
h|[[quarkus-hibernate-validator_quarkus-hibernate-validator-hibernate-validator]]link:#quarkus-hibernate-validator_quarkus-hibernate-validator-hibernate-validator[Hibernate Validator]
...
h|[[quarkus-infinispan-client_quarkus-infinispan-client-infinispan-client]]link:#quarkus-infinispan-client_quarkus-infinispan-client-infinispan-client[Infinispan Client]
...
h|[[quarkus-jaeger_quarkus-jaeger-jaeger]]link:#quarkus-jaeger_quarkus-jaeger-jaeger[Jaeger]
...
h|[[quarkus-keycloak-authorization_quarkus-keycloak-authorization-keycloak-authorization]]link:#quarkus-keycloak-authorization_quarkus-keycloak-authorization-keycloak-authorization[Keycloak Authorization]
...
h|[[quarkus-kubernetes_quarkus-kubernetes-kubernetes]]link:#quarkus-kubernetes_quarkus-kubernetes-kubernetes[Kubernetes]
...
h|[[quarkus-kubernetes_quarkus.knative.init-containers.-init-containers-.liveness-probe-the-liveness-probe]]link:#quarkus-kubernetes_quarkus.knative.init-containers.-init-containers-.liveness-probe-the-liveness-probe[The liveness probe]
...
h|[[quarkus-kubernetes_quarkus.knative.init-containers.-init-containers-.readiness-probe-the-readiness-probe]]link:#quarkus-kubernetes_quarkus.knative.init-containers.-init-containers-.readiness-probe-the-readiness-probe[The readiness probe]
This configuration section is optional
h|Type
h|Default
...
h|[[quarkus-kubernetes-config_quarkus-kubernetes-config-kubernetes-config]]link:#quarkus-kubernetes-config_quarkus-kubernetes-config-kubernetes-config[Kubernetes Config]
...
h|[[quarkus-liquibase_quarkus-liquibase-liquibase]]link:#quarkus-liquibase_quarkus-liquibase-liquibase[Liquibase]
...
h|[[quarkus-logging-gelf_quarkus-logging-gelf-logging-gelf]]link:#quarkus-logging-gelf_quarkus-logging-gelf-logging-gelf[Logging GELF]
...
h|[[quarkus-logging-json_quarkus-logging-json-logging-json]]link:#quarkus-logging-json_quarkus-logging-json-logging-json[Logging JSON]
...
h|[[quarkus-logging-sentry_quarkus-logging-sentry-logging-sentry]]link:#quarkus-logging-sentry_quarkus-logging-sentry-logging-sentry[Logging Sentry]
...
h|[[quarkus-mailer_quarkus-mailer-mailer]]link:#quarkus-mailer_quarkus-mailer-mailer[Mailer]
...
h|[[quarkus-micrometer_quarkus-micrometer-micrometer-metrics]]link:#quarkus-micrometer_quarkus-micrometer-micrometer-metrics[Micrometer metrics]
...
h|[[quarkus-mongodb-client_quarkus-mongodb-client-mongodb-client]]link:#quarkus-mongodb-client_quarkus-mongodb-client-mongodb-client[MongoDB client]
...
h|[[quarkus-mongodb-client_quarkus.mongodb.write-concern-write-concern]]link:#quarkus-mongodb-client_quarkus.mongodb.write-concern-write-concern[Write concern]
...
h|[[quarkus-mongodb-client_quarkus.mongodb.credentials-credentials-and-authentication-mechanism]]link:#quarkus-mongodb-client_quarkus.mongodb.credentials-credentials-and-authentication-mechanism[Credentials and authentication mechanism]
...
h|[[quarkus-narayana-jta_quarkus-narayana-jta-narayana-jta-transaction-manager]]link:#quarkus-narayana-jta_quarkus-narayana-jta-narayana-jta-transaction-manager[Narayana JTA - Transaction manager]
...
h|[[quarkus-neo4j_quarkus-neo4j-neo4j-client]]link:#quarkus-neo4j_quarkus-neo4j-neo4j-client[Neo4j client]
...
h|[[quarkus-oidc_quarkus-oidc-openid-connect]]link:#quarkus-oidc_quarkus-oidc-openid-connect[OpenID Connect]
...
a| [[quarkus-oidc_quarkus.oidc.token.auto-refresh-interval]]`link:#quarkus-oidc_quarkus.oidc.token.auto-refresh-interval[quarkus.oidc.token.auto-refresh-interval]`
...
a| [[quarkus-oidc_quarkus.oidc.-tenant-.token.auto-refresh-interval]]`link:#quarkus-oidc_quarkus.oidc.-tenant-.token.auto-refresh-interval[quarkus.oidc."tenant".token.auto-refresh-interval]`
...
h|[[quarkus-picocli_quarkus-picocli-picocli]]link:#quarkus-picocli_quarkus-picocli-picocli[Picocli]
...
h|[[quarkus-core_quarkus-core-quarkus-core]]link:#quarkus-core_quarkus-core-quarkus-core[Quarkus - Core]
...
h|[[quarkus-spring-cloud-config-client_quarkus-spring-cloud-config-client-quarkus-extension-for-spring-cloud-config-client]]link:#quarkus-spring-cloud-config-client_quarkus-spring-cloud-config-client-quarkus-extension-for-spring-cloud-config-client[Quarkus Extension for Spring Cloud Config Client]
...
h|[[quarkus-quartz_quarkus-quartz-quartz]]link:#quarkus-quartz_quarkus-quartz-quartz[Quartz]
...
h|[[quarkus-qute_quarkus-qute-qute-templating]]link:#quarkus-qute_quarkus-qute-qute-templating[Qute Templating]
...
h|[[quarkus-resteasy_quarkus-resteasy-resteasy-jax-rs]]link:#quarkus-resteasy_quarkus-resteasy-resteasy-jax-rs[RESTEasy JAX-RS]
...
h|[[quarkus-resteasy-common_quarkus-resteasy-common-resteasy-jax-rs-common]]link:#quarkus-resteasy-common_quarkus-resteasy-common-resteasy-jax-rs-common[RESTEasy JAX-RS Common]
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-common_quarkus.resteasy-json.json-default]]`link:#quarkus-resteasy-common_quarkus.resteasy-json.json-default[quarkus.resteasy-json.json-default]`
...
h|[[quarkus-resteasy-multipart_quarkus-resteasy-multipart-resteasy-multipart]]link:#quarkus-resteasy-multipart_quarkus-resteasy-multipart-resteasy-multipart[RESTEasy Multipart]
...
h|[[quarkus-resteasy-server-common_quarkus-resteasy-server-common-resteasy-server-common]]link:#quarkus-resteasy-server-common_quarkus-resteasy-server-common-resteasy-server-common[RESTEasy Server Common]
...
a|icon:lock[title=Fixed at build time] [[quarkus-resteasy-server-common_quarkus.resteasy.ignore-application-classes]]`link:#quarkus-resteasy-server-common_quarkus.resteasy.ignore-application-classes[quarkus.resteasy.ignore-application-classes]`
...
h|[[quarkus-reactive-mysql-client_quarkus-reactive-mysql-client-reactive-mysql-client]]link:#quarkus-reactive-mysql-client_quarkus-reactive-mysql-client-reactive-mysql-client[Reactive MySQL client]
...
h|[[quarkus-reactive-pg-client_quarkus-reactive-pg-client-reactive-postgresql-client]]link:#quarkus-reactive-pg-client_quarkus-reactive-pg-client-reactive-postgresql-client[Reactive PostgreSQL client]
...
h|[[quarkus-reactive-datasource_quarkus-reactive-datasource-reactive-datasource-configuration]]link:#quarkus-reactive-datasource_quarkus-reactive-datasource-reactive-datasource-configuration[Reactive datasource configuration]
...
a| [[quarkus-reactive-datasource_quarkus.datasource.-datasource-name-.reactive.thread-local]]`link:#quarkus-reactive-datasource_quarkus.datasource.-datasource-name-.reactive.thread-local[quarkus.datasource."datasource-name".reactive.thread-local]`
...
h|[[quarkus-redis-client_quarkus-redis-client-redis-client]]link:#quarkus-redis-client_quarkus-redis-client-redis-client[Redis Client]
...
a| [[quarkus-redis-client_quarkus.redis.slaves]]`link:#quarkus-redis-client_quarkus.redis.slaves[quarkus.redis.slaves]`
...
a| [[quarkus-redis-client_quarkus.redis.-additional-redis-clients-.slaves]]`link:#quarkus-redis-client_quarkus.redis.-additional-redis-clients-.slaves[quarkus.redis."additional-redis-clients".slaves]`
...
h|[[quarkus-scheduler_quarkus-scheduler-scheduler-tasks]]link:#quarkus-scheduler_quarkus-scheduler-scheduler-tasks[Scheduler - tasks]
...
h|[[quarkus-security_quarkus-security-security]]link:#quarkus-security_quarkus-security-security[Security]
...
h|[[quarkus-smallrye-graphql_quarkus-smallrye-graphql-smallrye-graphql]]link:#quarkus-smallrye-graphql_quarkus-smallrye-graphql-smallrye-graphql[SmallRye GraphQL]
...
h|[[quarkus-smallrye-health_quarkus-smallrye-health-smallrye-health]]link:#quarkus-smallrye-health_quarkus-smallrye-health-smallrye-health[SmallRye Health]
...
h|[[quarkus-smallrye-jwt_quarkus-smallrye-jwt-smallrye-jwt]]link:#quarkus-smallrye-jwt_quarkus-smallrye-jwt-smallrye-jwt[SmallRye JWT]
...
h|[[quarkus-smallrye-metrics_quarkus-smallrye-metrics-smallrye-metrics]]link:#quarkus-smallrye-metrics_quarkus-smallrye-metrics-smallrye-metrics[SmallRye Metrics]
...
a|icon:lock[title=Fixed at build time] [[quarkus-smallrye-metrics_quarkus.smallrye-metrics.jaxrs.enabled]]`link:#quarkus-smallrye-metrics_quarkus.smallrye-metrics.jaxrs.enabled[quarkus.smallrye-metrics.jaxrs.enabled]`

[.description]
--
Whether or not detailed JAX-RS metrics should be enabled. See link:https://github.com/eclipse/microprofile-metrics/blob/2.3.x/spec/src/main/asciidoc/required-metrics.adoc#optional-rest[MicroProfile Metrics: Optional REST metrics].
--|boolean 
|`false`


h|[[quarkus-smallrye-openapi_quarkus-smallrye-openapi-smallrye-openapi]]link:#quarkus-smallrye-openapi_quarkus-smallrye-openapi-smallrye-openapi[SmallRye OpenAPI]
...
h|[[quarkus-smallrye-reactive-messaging_quarkus-smallrye-reactive-messaging-smallrye-reactive-messaging]]link:#quarkus-smallrye-reactive-messaging_quarkus-smallrye-reactive-messaging-smallrye-reactive-messaging[SmallRye Reactive Messaging]
...
h|[[quarkus-swagger-ui_quarkus-swagger-ui-swagger-ui]]link:#quarkus-swagger-ui_quarkus-swagger-ui-swagger-ui[Swagger UI]
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.urls-primary-name]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.urls-primary-name[quarkus.swagger-ui.urls-primary-name]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.title]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.title[quarkus.swagger-ui.title]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.theme]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.theme[quarkus.swagger-ui.theme]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.footer]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.footer[quarkus.swagger-ui.footer]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.deep-linking]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.deep-linking[quarkus.swagger-ui.deep-linking]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.display-operation-id]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.display-operation-id[quarkus.swagger-ui.display-operation-id]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.default-models-expand-depth]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.default-models-expand-depth[quarkus.swagger-ui.default-models-expand-depth]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.default-model-expand-depth]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.default-model-expand-depth[quarkus.swagger-ui.default-model-expand-depth]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.default-model-rendering]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.default-model-rendering[quarkus.swagger-ui.default-model-rendering]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.display-request-duration]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.display-request-duration[quarkus.swagger-ui.display-request-duration]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.doc-expansion]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.doc-expansion[quarkus.swagger-ui.doc-expansion]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.filter]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.filter[quarkus.swagger-ui.filter]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.max-displayed-tags]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.max-displayed-tags[quarkus.swagger-ui.max-displayed-tags]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.operations-sorter]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.operations-sorter[quarkus.swagger-ui.operations-sorter]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.show-extensions]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.show-extensions[quarkus.swagger-ui.show-extensions]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.show-common-extensions]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.show-common-extensions[quarkus.swagger-ui.show-common-extensions]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.tags-sorter]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.tags-sorter[quarkus.swagger-ui.tags-sorter]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.on-complete]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.on-complete[quarkus.swagger-ui.on-complete]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.syntax-highlight]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.syntax-highlight[quarkus.swagger-ui.syntax-highlight]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.oauth2-redirect-url]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.oauth2-redirect-url[quarkus.swagger-ui.oauth2-redirect-url]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.request-interceptor]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.request-interceptor[quarkus.swagger-ui.request-interceptor]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.request-curl-options]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.request-curl-options[quarkus.swagger-ui.request-curl-options]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.response-interceptor]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.response-interceptor[quarkus.swagger-ui.response-interceptor]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.show-mutated-request]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.show-mutated-request[quarkus.swagger-ui.show-mutated-request]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.supported-submit-methods]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.supported-submit-methods[quarkus.swagger-ui.supported-submit-methods]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.validator-url]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.validator-url[quarkus.swagger-ui.validator-url]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.with-credentials]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.with-credentials[quarkus.swagger-ui.with-credentials]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.model-property-macro]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.model-property-macro[quarkus.swagger-ui.model-property-macro]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.parameter-macro]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.parameter-macro[quarkus.swagger-ui.parameter-macro]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.persist-authorization]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.persist-authorization[quarkus.swagger-ui.persist-authorization]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.layout]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.layout[quarkus.swagger-ui.layout]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.plugins]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.plugins[quarkus.swagger-ui.plugins]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.presets]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.presets[quarkus.swagger-ui.presets]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-swagger-ui_quarkus.swagger-ui.urls-urls]]`link:#quarkus-swagger-ui_quarkus.swagger-ui.urls-urls[quarkus.swagger-ui.urls]`
...
h|[[quarkus-undertow_quarkus-undertow-undertow-servlet]]link:#quarkus-undertow_quarkus-undertow-undertow-servlet[Undertow Servlet]
...
h|[[quarkus-undertow-websockets_quarkus-undertow-websockets-undertow-websockets]]link:#quarkus-undertow-websockets_quarkus-undertow-websockets-undertow-websockets[Undertow WebSockets]
...
h|[[quarkus-vault_quarkus-vault-vault]]link:#quarkus-vault_quarkus-vault-vault[Vault]

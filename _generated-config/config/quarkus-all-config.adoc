...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus.hibernate-orm.max-fetch-depth]]`link:#quarkus-hibernate-orm_quarkus.hibernate-orm.max-fetch-depth[quarkus.hibernate-orm.max-fetch-depth]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus.hibernate-orm.-persistence-unit-name-.batch-fetch-size]]`link:#quarkus-hibernate-orm_quarkus.hibernate-orm.-persistence-unit-name-.batch-fetch-size[quarkus.hibernate-orm."persistence-unit-name".batch-fetch-size]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-hibernate-orm_quarkus.hibernate-orm.-persistence-unit-name-.max-fetch-depth]]`link:#quarkus-hibernate-orm_quarkus.hibernate-orm.-persistence-unit-name-.max-fetch-depth[quarkus.hibernate-orm."persistence-unit-name".max-fetch-depth]`

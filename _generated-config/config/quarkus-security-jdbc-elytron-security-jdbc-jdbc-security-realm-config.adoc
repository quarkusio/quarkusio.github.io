...
a|icon:lock[title=Fixed at build time] [[quarkus-security-jdbc-elytron-security-jdbc-jdbc-security-realm-config_quarkus.security.jdbc.realm-name]]`link:#quarkus-security-jdbc-elytron-security-jdbc-jdbc-security-realm-config_quarkus.security.jdbc.realm-name[quarkus.security.jdbc.realm-name]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-security-jdbc-elytron-security-jdbc-jdbc-security-realm-config_quarkus.security.jdbc.enabled]]`link:#quarkus-security-jdbc-elytron-security-jdbc-jdbc-security-realm-config_quarkus.security.jdbc.enabled[quarkus.security.jdbc.enabled]`

...
h|[[quarkus-amazon-common-config-group-netty-http-client-config_quarkus.kms.async-client]]link:#quarkus-amazon-common-config-group-netty-http-client-config_quarkus.kms.async-client[Netty HTTP transport configurations]

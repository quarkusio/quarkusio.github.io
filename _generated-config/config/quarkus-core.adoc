...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus.dev.instrumentation]]`link:#quarkus-core_quarkus.dev.instrumentation[quarkus.dev.instrumentation]`

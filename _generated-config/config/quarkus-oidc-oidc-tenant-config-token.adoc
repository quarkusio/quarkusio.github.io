...
a| [[quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.token.expiration-grace]]`link:#quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.token.expiration-grace[quarkus.oidc.token.expiration-grace]`
...
a| [[quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.-tenant-.token.expiration-grace]]`link:#quarkus-oidc-oidc-tenant-config-token_quarkus.oidc.-tenant-.token.expiration-grace[quarkus.oidc."tenant".token.expiration-grace]`

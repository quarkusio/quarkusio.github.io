...
a| [[quarkus-security-webauthn-web-authn-run-time-config-relying-party-config_quarkus.webauthn.relying-party.icon]]`link:#quarkus-security-webauthn-web-authn-run-time-config-relying-party-config_quarkus.webauthn.relying-party.icon[quarkus.webauthn.relying-party.icon]`

...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc_quarkus.keycloak.devservices.grant.type]]`link:#quarkus-oidc_quarkus.keycloak.devservices.grant.type[quarkus.keycloak.devservices.grant.type]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc_quarkus.keycloak.devservices.web-clien-timeout]]`link:#quarkus-oidc_quarkus.keycloak.devservices.web-clien-timeout[quarkus.keycloak.devservices.web-clien-timeout]`

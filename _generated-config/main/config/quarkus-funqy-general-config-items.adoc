...
:summaryTableId: quarkus-funqy-general-config-items
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference, cols="80,.^10,.^10"]
|===

h|[[quarkus-funqy-general-config-items_configuration]]link:#quarkus-funqy-general-config-items_configuration[Configuration property]

h|Type
h|Default

a| [[quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.trigger]]`link:#quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.trigger[quarkus.funqy.knative-events.mapping."mapping".trigger]`
...
a| [[quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.response-type]]`link:#quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.response-type[quarkus.funqy.knative-events.mapping."mapping".response-type]`
...
a| [[quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.response-source]]`link:#quarkus-funqy-general-config-items_quarkus.funqy.knative-events.mapping.-mapping-.response-source[quarkus.funqy.knative-events.mapping."mapping".response-source]`

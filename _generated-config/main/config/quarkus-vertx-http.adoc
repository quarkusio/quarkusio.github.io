...
a| [[quarkus-vertx-http_quarkus.http.enable-decompression]]`link:#quarkus-vertx-http_quarkus.http.enable-decompression[quarkus.http.enable-decompression]`
...
a| [[quarkus-vertx-http_quarkus.http.compress-media-types]]`link:#quarkus-vertx-http_quarkus.http.compress-media-types[quarkus.http.compress-media-types]`
...
a| [[quarkus-vertx-http_quarkus.http.compression-level]]`link:#quarkus-vertx-http_quarkus.http.compression-level[quarkus.http.compression-level]`

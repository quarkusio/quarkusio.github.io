...
a| [[quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.load-balancing-policy]]`link:#quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.load-balancing-policy[quarkus.grpc.clients."service-name".load-balancing-policy]`
...
a| [[quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.compression]]`link:#quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.compression[quarkus.grpc.clients."service-name".compression]`
...
a| [[quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.deadline]]`link:#quarkus-grpc-config-grpc-configuration_quarkus.grpc.clients.-service-name-.deadline[quarkus.grpc.clients."service-name".deadline]`

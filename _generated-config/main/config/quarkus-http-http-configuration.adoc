...
a| [[quarkus-http-http-configuration_quarkus.http.compress-media-types]]`link:#quarkus-http-http-configuration_quarkus.http.compress-media-types[quarkus.http.compress-media-types]`
...
a| [[quarkus-http-http-configuration_quarkus.http.compression-level]]`link:#quarkus-http-http-configuration_quarkus.http.compression-level[quarkus.http.compression-level]`

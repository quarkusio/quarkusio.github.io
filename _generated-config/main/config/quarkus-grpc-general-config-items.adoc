...
a| [[quarkus-grpc-general-config-items_quarkus.grpc.clients.-service-name-.deadline]]`link:#quarkus-grpc-general-config-items_quarkus.grpc.clients.-service-name-.deadline[quarkus.grpc.clients."service-name".deadline]`

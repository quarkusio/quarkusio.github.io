...
a| `GACT artifact` :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vertx/deployment/src/main/java/io/quarkus/vertx/deployment/CopyVertxContextDataBuildItem.java[`io.quarkus.vertx.deployment.CopyVertxContextDataBuildItem`, window="_blank"] :: +++Build item which indicates that the current Vertx request context data needs to be copied into the connection context+++
a| `String property` :: +++<i>No Javadoc found</i>+++

...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/AdditionalStaticInitConfigSourceProviderBuildItem.java[`io.quarkus.deployment.builditem.AdditionalStaticInitConfigSourceProviderBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String providerClassName` :: +++<i>No Javadoc found</i>+++
...
a| `String serviceName` :: +++<i>No Javadoc found</i>+++
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mongodb-client/deployment/src/main/java/io/quarkus/mongodb/deployment/DevServicesMongoClientResultBuildItem.java[`io.quarkus.mongodb.deployment.DevServicesMongoClientResultBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `Result defaultDatasource` :: +++<i>No Javadoc found</i>+++
`Map namedDatasources` :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mongodb-client/deployment-spi/src/main/java/io/quarkus/mongodb/deployment/devservices/DevServicesMongoResultBuildItem.java[`io.quarkus.mongodb.deployment.devservices.DevServicesMongoResultBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `Result defaultConnection` :: +++<i>No Javadoc found</i>+++
`Map namedConnections` :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/redis-client/deployment-spi/src/main/java/io/quarkus/redis/client/deployment/devservices/DevServicesRedisResultBuildItem.java[`io.quarkus.redis.client.deployment.devservices.DevServicesRedisResultBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `Result defaultConnection` :: +++<i>No Javadoc found</i>+++
`Map namedConnections` :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vault/deployment-spi/src/main/java/io/quarkus/vault/deployment/devservices/DevServicesVaultResultBuildItem.java[`io.quarkus.vault.deployment.devservices.DevServicesVaultResultBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/websockets/deployment/src/main/java/io/quarkus/undertow/websockets/deployment/AnnotatedWebsocketEndpointBuildItem.java[`io.quarkus.undertow.websockets.deployment.AnnotatedWebsocketEndpointBuildItem`, window="_blank"] :: +++A server websocket endpoint+++
a| `String className` :: +++<i>No Javadoc found</i>+++

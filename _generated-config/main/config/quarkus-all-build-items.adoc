...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/opentelemetry/deployment/src/main/java/io/quarkus/opentelemetry/tracing/TracerProviderBuildItem.java[`io.quarkus.opentelemetry.tracing.TracerProviderBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++

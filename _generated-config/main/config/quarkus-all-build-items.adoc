...
|===
|Class Name |Attributes 
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io.quarkus.hibernate.orm.deployment.spi/DatasourceDbKindHibernateOrmMetadataBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.DatasourceDbKindHibernateOrmMetadataBuildItem`, window="_blank"] :: +++<i>No Javadoc found</i>+++
a| `String dbKind` :: +++<i>No Javadoc found</i>+++

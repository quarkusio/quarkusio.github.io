...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc-general-config-items_quarkus.keycloak.devservices.grant.type]]`link:#quarkus-oidc-general-config-items_quarkus.keycloak.devservices.grant.type[quarkus.keycloak.devservices.grant.type]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-oidc-general-config-items_quarkus.keycloak.devservices.web-clien-timeout]]`link:#quarkus-oidc-general-config-items_quarkus.keycloak.devservices.web-clien-timeout[quarkus.keycloak.devservices.web-clien-timeout]`
...
[.description]
--
Requires that ID token is available when the authorization code flow completes. In most case this property should be enabled. Disable this property only when you need to use the authorization code flow with OAuth2 providers.
--|boolean 
|`true`

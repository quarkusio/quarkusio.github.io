---
layout: post
title: 'Quarkus 3.10.2 released - Maintenance release'
date: 2024-05-22
tags: release
synopsis: 'We released Quarkus 3.10.2, our second maintenance release for the 3.10 release train.'
author: gsmet
---

Today, we released Quarkus 3.10.2, our second maintenance release for the 3.10 release train.

This release contains bugfixes and documentation improvements.
It should be a safe upgrade for anyone already using 3.10.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.10.2[the full changelog of 3.10.2 on GitHub].

...
image::cryostat-recording-report.webp[alt=Automated Analysis Report in the Cryostat web-client UI]

.Cryostat Grafana Dashboard
image::cryostat-grafana-dashboard.webp[alt=Grafana dashboard displaying metrics from Cryostat]
...
image::cryostat-operatorhub.webp[alt=Cryostat Operator in the OpenShift OperatorHub]
...
.Cryostat Creation
image::cryostat-operator-resource.webp[alt=A created Cryostat CR in the OpenShift Console]

...
image::quarkus-asynchronous-validation.webp[alt="Asynchronous annotation validation support"]
...
image::quarkus-applicationpath-annotation.webp[alt="ApplicationPath annotation on a type declaration"]
...
image::quarkus-applicationpath-codelens.webp[alt="Code lens on method declaration respects the value of ApplicationPath"]
...
image::quarkus-retry-delay-exceeds-duration.webp[alt="Retry annotation validation support"]
...
image::quarkus-configproperty-defaultvalue-validation.webp[alt="Validation for ConfigProperty defaultValue"]

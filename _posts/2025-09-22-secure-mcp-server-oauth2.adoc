...
image::typical_spa_oauth2_flow.webp[Typical SPA OAuth2 Flow,align="center"]
...
image::keycloak_admin.webp[Keycloak Admin,align="center"]
...
image::keycloak_public_client_capability.webp[Public Keycloak Client,align="center"]
...
image::keycloak_alpha_client_general_settings.webp[Keycloak Alpha Client settings,align="center"]
...
image::keycloak_quarkus_mcp_alpha_scope.webp[Keycloak Client quarkus-mcp-alpha scope,align="center"]

Next, we create an audience mapping for this scope:

image::keycloak_quarkus_mcp_alpha_scope_mapping.webp[Keycloak Client quarkus-mcp-alpha scope mapping,align="center"]

Finally, we assign this client scope as an optional scope to the `alpha-client` client:

image::keycloak_alpha_client_scope.webp[Keycloak alpha-client scope assignment,align="center"]
...
image::mcp_inspector_alpha_connect.webp[MCP Inspector Alpha Connect,align="center"]
...
image::alpha_realm_login.webp[Alpha Realm Login,align="center"]
...
image::alpha_client_jwt.webp[Alpha Client JWT,align="center"]
...
image::alpha_tool_run.webp[Alpha Tool Run,align="center"]
...
image::bravo_realm_login.webp[Bravo Realm Login,align="center"]
...
image::bravo_tool_run.webp[Bravo Tool Run,align="center"]

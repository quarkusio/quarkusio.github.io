...
On every push, merge requests will:
...
The most empowering feature of this approach is that from a merge request, services can be deployed and interacted with in their own isolated preview environments.

...
synopsis: "Embracing Quarkus has changed how our developers work and existing processes, especially CI/CD, have been re-architected to provide a more integrated experience. Using GitLab, pipelines play a key role in every step of our process. From inception, to development through deployment, and finally monitoring, everything is accessible centrally."
author: kjq
---

...
This blog article will, at a high-level, provide a blueprint of how we leverage https://quarkus.io/[Quarkus^], especially the extensions, with https://about.gitlab.com/[GitLab^] and tie everything together into one cohesive ecosystem that accessible by all of our teams.

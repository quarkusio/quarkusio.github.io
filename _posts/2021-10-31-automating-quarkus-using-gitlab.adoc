...
It is configured as a GitLab https://docs.gitlab.com/ee/user/clusters/management_project_template.html[cluster-managed^] project so that we can manage other cluster applications, such as any Helm charts, in addition to our own Quarkus services.

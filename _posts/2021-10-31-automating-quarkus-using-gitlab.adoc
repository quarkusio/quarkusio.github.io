...
Being able to deploy _preview_ services lets developers go beyond automated testing. They can spot-test only what they are working on or even run a full suite of services if needed (this is especially useful during a combined UX and service feature).

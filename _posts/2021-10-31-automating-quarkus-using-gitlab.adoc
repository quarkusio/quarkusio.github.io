...
TIP: Done right, a MonoRepository style can still be used for _per-service_ repositories.  This helps future-proof having to make major changes later when you decide to add more related services to a project which in our experience happens more often than not. 

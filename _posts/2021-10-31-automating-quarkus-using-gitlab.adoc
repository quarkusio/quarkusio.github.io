...
Because of the natural fit Quarkus has with cloud technologies, and the functionality provided through extensions, we have been able to create a full DevOps ecosystem that normally would be challenging to configure and orchestrate.
...
Most of the functionality we need, at least initially, is accessible from one place - this lets us iterate, collaborate, and respond quicker.

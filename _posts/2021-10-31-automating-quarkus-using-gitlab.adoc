...
Being able to deploy _preview_ services lets developers go beyond just automated testing. They can spot-test individual services or even run a full suite of services if needed (this is especially useful during a combined UX and Service feature).

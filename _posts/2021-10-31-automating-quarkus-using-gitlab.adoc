...
It is configured as a GitLab https://docs.gitlab.com/ee/user/clusters/management_project_template.html[cluster-managed^] project so that we additionally control other cluster applications, such as Helm charts, in addition to our Quarkus services.

...
Once the requested services have finished building the deployment will start automatically.

image::gitlab/deployment.png[Single Deployment,align="center"]

The cluster is notified to grab the Kubernetes manifests, perform any last minute configurations, and finally deploy the services.

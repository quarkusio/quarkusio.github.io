...
Deploying _preview_ services lets us go beyond automated testing. We can spot-test what is being worked on only or even run the full suite of services if needed (this is especially useful during a combined UX and multiple service feature).

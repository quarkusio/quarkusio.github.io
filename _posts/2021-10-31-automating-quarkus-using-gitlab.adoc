...
Being able to deploy _preview_ services lets developers go beyond automated testing. They can spot-test only the services they are working with or even run a full suite of services if needed (this is especially useful during a combined UX and service feature).
...
- Parallizing builds has decreased the time to deliver changes
- Deployments are completely automated
- Common tools are available from within GitLab

...
synopsis: "Embracing Quarkus has changed how our developers work and existing processes, especially CI/CD, had to be re-architected to provide a more integrated experience. Every step, from inception, to development through deployment, and finally monitoring, is now orchestrated through GitLab."
author: kjq
---
...
At the end of the day, we do not have to train staff in different tools, grant access any further than GitLab, or expose any infrastructure directly. 

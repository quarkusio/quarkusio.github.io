...
It would very nice to have a distribution of Mandrel for aarch64. Mandrel (the Red Hat distribution of GraalVM) is optimized for Quarkus and makes it even more fast and reliable. Looking forward to testing it ;-)

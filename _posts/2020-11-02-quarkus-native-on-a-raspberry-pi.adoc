...
image:/assets/images/posts/quarkus-native-on-a-raspberry-pi/vm-cpu-config.webp[width=100%]
...
image:/assets/images/posts/quarkus-native-on-a-raspberry-pi/sd-card-partitions.webp[width=100%]
...
image::/assets/images/posts/quarkus-native-on-a-raspberry-pi/native-quarkus-getting-started-on-arm8-memory-footprint.webp[width=100%]
...
image::/assets/images/posts/quarkus-native-on-a-raspberry-pi/native-quarkus-getting-started-on-arm8-web-page.webp[width=100%]

...
thumbnailimage: /assets/images/posts/quarkus-user-stories/talkdesk/td_logo_2019_cmyk_darkblue.webp
---
...
[.customer-logo]
image::td_logo_2019_cmyk_darkblue.webp[Talkdesk logo,300]

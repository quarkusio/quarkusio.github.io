...
[NOTE]
====
The `io.github.a2a-sdk` `groupId` is temporary and will likely change for future releases. Keep an eye on the `a2a-java` https://github.com/a2aproject/a2a-java/blob/main/README.md[README] for up-to-date documentation.
====

[source,xml]
----
<dependency>
    <groupId>io.github.a2a-sdk</groupId>

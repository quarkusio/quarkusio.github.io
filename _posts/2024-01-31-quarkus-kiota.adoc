...
HTTP calls are easy to be performed in any programming language and environment, still, when your API complexity starts to increase and the number of available endpoints becomes uncountable on the tip of your fingers you feel the urge of having better tools.

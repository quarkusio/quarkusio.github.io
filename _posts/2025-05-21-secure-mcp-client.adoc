...
image::poem_service_architecture.webp[Poem Service Architecture,align="center"]
...
image::typical_oauth2_authorization.webp[Typical OAuth2 Authorization,align="center"]
...
image::login_to_poem_service.webp[Login to Poem Service,align="center"]

You should get a response with your name and a link to the `Poem Service` endpoint:

image::poem_service_welcome_page.webp[Poem Service Welcome Page,align="center"]
...
image::poem_service_response.webp[Poem Service Response,align="center"]

...
image::sentry-email.webp[Sentry Email Notification, 900]
...
image::sentry-issues.webp[Sentry Issue List, 900]
...
image::sentry-issue.webp[Sentry issue details, 900]

If you want to go a bit further you can start cooking some custom rules to dispatch alerts with your own taste.

image::sentry-alerts-config.webp[Sentry Alerts Configuration, 900]

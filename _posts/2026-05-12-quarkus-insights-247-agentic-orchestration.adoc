...
In episode 247 of Quarkus Insights, https://www.linkedin.com/in/javajon/[Jonathan Johnson], an independent software architect and adjunct professor at Trinity College (Connecticut), shared his innovative work on distributed agentic AI systems running on Kubernetes with Quarkus and LangChain4j.
...
- Present workshops at the dev2next conference (October 2026)

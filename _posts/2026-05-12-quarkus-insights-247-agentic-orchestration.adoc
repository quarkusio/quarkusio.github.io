...
date: 2026-05-12
tags: quarkus langchain4j kubernetes ai agents distributed-systems
...
:imagesdir: /assets/images/posts/quarkus-insights
...
In episode 247 of Quarkus Insights, Jonathan Johnson, an independent software architect and adjunct professor at Trinity College, shared his innovative work on distributed agentic AI systems running on Kubernetes with Quarkus and LangChain4j.
...
- **GPU resources**: NVIDIA 4090 (32GB) and 5090 (32GB) for local model inference

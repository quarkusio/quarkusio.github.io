...
In episode 247 of Quarkus Insights, https://www.linkedin.com/in/javajon/[Jonathan Johnson], an independent software architect and adjunct professor at Trinity College, shared his innovative work on distributed agentic AI systems running on Kubernetes with Quarkus and LangChain4j.
...
3. **MCP Tools**: Agents have access to Model Context Protocol tools
4. **Prompts as ConfigMaps**: Stored as Kubernetes YAML manifests, not compiled code
5. **CubeMoot Operator**: Custom Kubernetes operator managing the agentic system
...
- **Upcoming talks**: DevToNext conference, Longmont, Colorado (October 2026)
...
4. **Infrastructure as Code** is essential when working with AI-assisted development

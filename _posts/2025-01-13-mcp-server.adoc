...
image::claude-example.webp[Claude MCP Integration Example]
...
image::claude-tools.webp[Claude Tools Integration]
...
image::mcp-inspector.webp[MCP Inspector Interface]
...
* https://api.weather.gov[Weather API Documentation]

...
image::chaining-pattern.webp[width=80%, align="center", alt="Prompt chaining pattern"]
...
image::chaining-trace.webp[align=center, alt="Tracing sequential execution of the prompt chaining pattern"]
...
image::parallel-pattern.webp[width=50%, align="center", alt="The parallelization pattern"]
...
image::parallel-trace.webp[align=center, alt="Tracing parallel LLMs invocation"]
...
[.text-center]
.Routing pattern
image::routing-pattern.webp[width=70%, align="center", alt="Routing pattern"]

...
This is great because you don't need to rely on Java installed; or beeing installed in a wrong version.
...
It will be interesting to see where people are taking command-mode. Maybe we will be seeing Electron-style Desktop applications beeing developed based on Quarkus?

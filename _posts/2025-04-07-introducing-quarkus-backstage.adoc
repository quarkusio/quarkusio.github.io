...
It builds developer portals that act as software component registries, allowing teams too easily:
...
And check that the file is properly generated:
...
A video walkthrough on the basics of the extension is available at https://www.youtube.com/watch?v=XAiF-opDtpw[here].

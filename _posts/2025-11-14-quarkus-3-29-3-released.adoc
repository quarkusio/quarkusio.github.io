---
layout: post
title: 'Quarkus 3.29.3 - Maintenance release'
date: 2025-11-14
tags: release
synopsis: 'We released Quarkus 3.29.3, a regular maintenance release.'
author: gsmet
---

Today, we released Quarkus 3.29.3, a new maintenance release for our 3.29 stream.

Among other issues, this release fixes a compatibility issue of Testcontainers with recent Docker versions.
...
You can get the full changelog of https://github.com/quarkusio/quarkus/releases/tag/3.29.3[3.29.3] on GitHub.

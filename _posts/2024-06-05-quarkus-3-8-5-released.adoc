---
layout: post
title: 'Quarkus 3.8.5 released - Maintenance release'
date: 2024-06-05
tags: release
synopsis: 'We released Quarkus 3.8.5, our fourth maintenance release for the 3.8 release train.'
author: gsmet
---

Today, we released Quarkus 3.8.5, our fourth (we skipped 3.8.0) maintenance release for our 3.8 LTS release train.
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.8.5[the full changelog of 3.8.5 on GitHub].

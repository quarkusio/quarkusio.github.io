---
layout: post
title: 'Quarkus 3.6.4 released - Maintenance release'
date: 2023-12-20
tags: release
synopsis: 'We released Quarkus 3.6.4, our fourth maintenance release for the 3.6 release train.'
author: gsmet
---

Today, we released Quarkus 3.6.4, our fourth maintenance release for the 3.6 release train.
...
To update to Quarkus 3.6.4, we recommend updating to the latest version of the Quarkus CLI and run:
...
You can get https://github.com/quarkusio/quarkus/releases/tag/3.6.4[the full changelog of 3.6.4 on GitHub].

---
layout: post
title: 'Quarkus 3.35 - @Transactional for Hibernate Reactive, PGO for native, JAR tree-shaking, and more'
date: 2026-05-01
tags: release
synopsis: 'We released Quarkus 3.35, which comes with @Transactional support for Hibernate Reactive, Profile-Guided Optimization for native builds, JAR tree-shaking, Semeru AOT support, and several other improvements.'
author: gsmet
---

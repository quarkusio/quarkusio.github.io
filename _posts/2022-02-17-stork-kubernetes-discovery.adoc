...
image::kubernetes-service-discovery.webp[alt=Kubernetes service discovery, width=60%, align=center]
...
image::service-instances-location.webp[alt=Service instances location, width=60%, align=center]

...
image:/assets/images/posts/mutiny-retry/subscription.webp[]


An interesting consequence of this is that if you subscribe twice, you emit two requests, and so get two responses:

image:/assets/images/posts/mutiny-retry/double-subscription.webp[]
...
image:/assets/images/posts/mutiny-retry/retry.webp[]
...
image:/assets/images/posts/mutiny-retry/retry-failed.webp[]

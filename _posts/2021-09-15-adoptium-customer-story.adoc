...
image::download-trends.png[Download trends,title="Recent download statistics for Adoptium distributions, from https://dash.adoptium.net/trends[dash.adoptium.net]"]

...
| *Native executable with Mandrel*
>m| 17 ms
>m| -95%
>m| 155 MB
>m| -66%
...
++++
<canvas id="startup-time-graph" style="max-width: 800px; margin: 0 auto;"></canvas>
<script>
...
However, the results are still not comparable to those obtained with a native executable.

=== Container image size

++++
<canvas id="container-image-size-graph" style="max-width: 800px; margin: 0 auto;"></canvas>
<script>

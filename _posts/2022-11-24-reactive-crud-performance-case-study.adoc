...
== Initial Results image:emoji-unhappy.webp[Unhappy, 35, 35]
...
== Quarkus Application Fixed image:emoji-happy.webp[Happy, 35, 35]
...
== Same results image:emoji-unhappy.webp[Unhappy, 35, 35]
...
== Move to a faster Disk image:emoji-happy.webp[Happy, 35, 35]
...
== System bottleneck still exists image:emoji-unhappy.webp[Unhappy, 35, 35]
...
== Constrain application image:emoji-happy.webp[Happy, 35, 35]
...
== All network traffic is not equal! image:emoji-unhappy.webp[Unhappy, 35, 35]
...
image::apples-to-oranges.webp[]


== Results image:emoji-happy.webp[Happy, 35, 35]

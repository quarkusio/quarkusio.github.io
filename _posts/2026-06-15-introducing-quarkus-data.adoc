...
image::extension-search-jpa.webp[Searching for JPA returns 16 extensions]
...
image::extension-search-database.webp[Searching for database returns even more extensions]

...
We released Quarkus 3.23.2, a maintenance release for our 3.23 release train.
...
You can get the full changelog of https://github.com/quarkusio/quarkus/releases/tag/3.23.2[3.23.2] on GitHub.

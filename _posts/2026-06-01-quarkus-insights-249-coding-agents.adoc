...
The team shared their diverse approaches to AI-assisted development:
...
**Better sandboxing**: The team mentioned https://get-inca.com/en/[Inca Sandbox] for safer agent execution.

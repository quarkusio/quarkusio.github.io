...
We use https://claude.ai/download[Claude Code] as our agent in this walkthrough, but you can use any agent that supports Skills (https://bob.ibm.com/[IBM Bob], Claude, Cursor, Windsurf, OpenCode and https://agentskills.io/clients[many others]).

...
image::voting-topology.png[width=80%, align="center", alt="The topology of the voting-based
...
image::voting-execution.png[width=100%, align="center", alt="A sample execution of the
voting-based story evaluation system"]

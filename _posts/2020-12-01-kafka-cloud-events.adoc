...
Many more options are http://smallrye.io/smallrye-reactive-messaging/smallrye-reactive-messaging/2.5/kafka/kafka.html[available], and Kafka is not the only part of Quarkus with Cloud Events support.

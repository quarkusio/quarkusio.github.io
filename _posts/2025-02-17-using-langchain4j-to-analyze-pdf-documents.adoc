...
author: melloware
thumbnailimage: /assets/images/posts/quarkus-user-stories/melloware/ksm-logo.webp
---
...
image::lease-analyzer.webp[Lease Analyzer Results,title="Lease Analyzer Results"]
